...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AheHrQgmgeAAg5QAAg1AmggQAmggA4AAQA5AAAmAgQAmAgAAA1QAAA5gmAeQgmAfg5AAQg4AAgmgfgAh1CwIAAq4IDrAAIAAK4g");
	this.shape.setTransform(275.025,-75.75);
	...
	this.shape_1.setTransform(223.675,-76.725);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgCICIhBqKIAAKKIjsAAIAAwDIE1AAIA/J8IAAp8IDrAAIAAQDg");
	this.shape_2.setTransform(162.575,-76.45);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ah1ICIAAwDIDrAAIAAQDg");
	this.shape_3.setTransform(112.8,-76.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAtICIgtpqIgsJqIkwAAIhMwDID6AAIAMMVIBEsVIC9AAIBFMVIALsVID6AAIhMQDg");
	this.shape_4.setTransform(52.125,-76.45);
	...
	this.shape_5.setTransform(-38.225,-76.575);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ah1ICIAAwDIDrAAIAAQDg");
	this.shape_6.setTransform(-84.9,-76.45);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AkSICIAAwDIECAAQCBgBBLA/QBMA+AACAIAAAaQAABPgZAxQgaAxg6AZQB4ArAACpIAAA/QAACEhIBGQhJBGh9AAgAgmEjIAOAAQAcAAAKgNQAMgNAAgeIAAhlQAAgfgLgOQgKgOgdAAIgOAAgAgmhyIARAAQAdAAALgNQAKgOAAgdIAAg+QAAgegKgOQgKgNgeAAIgRAAg");
	this.shape_7.setTransform(-131.225,-76.45);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90).to({_off:false},0).wait(1).to({regX:71,regY:-156,x:157.05,y:28,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.95,alpha:0.0435},0).wait(1).to({y:27.85,alpha:0.0919},0).wait(1).to({y:27.65,alpha:0.1816},0).wait(1).to({y:27.35,alpha:0.3248},0).wait(1).to({y:27,alpha:0.4878},0).wait(1).to({y:26.7,alpha:0.6345},0).wait(1).to({y:26.45,alpha:0.7499},0).wait(1).to({y:26.25,alpha:0.8388},0).wait(1).to({y:26.1,alpha:0.9088},0).wait(1).to({y:26,alpha:0.9564},0).wait(1).to({y:25.95,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(53).to({regX:71,regY:-156,x:157.05,y:25.95,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:26,alpha:0.9565},0).wait(1).to({y:26.1,alpha:0.9081},0).wait(1).to({y:26.3,alpha:0.8184},0).wait(1).to({y:26.6,alpha:0.6752},0).wait(1).to({y:26.95,alpha:0.5122},0).wait(1).to({y:27.25,alpha:0.3655},0).wait(1).to({y:27.5,alpha:0.2501},0).wait(1).to({y:27.7,alpha:0.1612},0).wait(1).to({y:27.85,alpha:0.0912},0).wait(1).to({y:27.95,alpha:0.0436},0).wait(1).to({y:28,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).wait(111));
