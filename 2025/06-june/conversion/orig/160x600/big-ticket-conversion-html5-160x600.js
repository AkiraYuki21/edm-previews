...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgtAqQgTgOAAgcQAAgZATgPQASgQAbAAQAbAAATAQQASAPAAAZQAAAcgSAOQgTAPgbAAQgbAAgSgPg");
	this.shape.setTransform(139.65,-232.95);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAQD5IgsjlIAADlIhzAAIAAnxIBzAAIAADjIAsjjIB3AAIg9DrIBFEGg");
	this.shape_1.setTransform(115.8,-252.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_2.setTransform(87.375,-252.85);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_3.setTransform(62.825,-252.85);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAWD5IgWkrIgUErIiUAAIglnxIB5AAIAGF+IAhl+IBbAAIAhF+IAGl+IB4AAIgkHxg");
	this.shape_4.setTransform(28.15,-252.85);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ag4D5IAAiNIhflkIB2AAIAiCnIAiinIB1AAIhfFkIAACNg");
	this.shape_5.setTransform(-17.525,-252.85);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAUD5Igmi+IgIAAIAAC+IhzAAIAAnxIB7AAQBOAAAfAjQAfAkAABDIAAAkQAABIglAgIA4DbgAgaggIAFAAQAPAAAGgHQAFgGAAgRIAAgwQAAgRgFgGQgGgHgPAAIgFAAg");
	this.shape_6.setTransform(-49.3,-252.85);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_7.setTransform(-76.975,-252.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhMD5IhOnxIB4AAIAiFdIAildIB5AAIhOHxg");
	this.shape_8.setTransform(-106.575,-252.85);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_9.setTransform(-135.025,-252.85);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgtAqQgSgOAAgcQAAgYASgQQASgQAbAAQAbAAATAQQATAQAAAYQAAAcgTAOQgTAPgbAAQgbAAgSgPg");
	this.shape_10.setTransform(103.8,-305.35);
	...
	this.shape_11.setTransform(82.475,-325.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAVD5Igoi+IgIAAIAAC+IhxAAIAAnxIB5AAQBPAAAfAkQAfAiAABEIAAAkQAABIglAgIA4DbgAgbggIAGAAQAPAAAGgHQAFgHAAgQIAAgwQAAgQgFgHQgGgHgPAAIgGAAg");
	this.shape_12.setTransform(53.55,-325.25);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_13.setTransform(25.875,-325.25);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgBD5Igfk7IAAE7IhyAAIAAnxICVAAIAeEzIAAkzIByAAIAAHxg");
	this.shape_14.setTransform(-3.575,-325.25);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgBD5Igfk7IAAE7IhyAAIAAnxICVAAIAeEzIAAkzIByAAIAAHxg");
	this.shape_15.setTransform(-36.725,-325.25);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("Ag4D5IAAnxIBxAAIAAHxg");
	this.shape_16.setTransform(-60.9,-325.25);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAVD5IgVkrIgVErIiTAAIgknxIB4AAIAGF9IAhl9IBbAAIAhF9IAGl9IB5AAIglHxg");
	this.shape_17.setTransform(-90.25,-325.25);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_18.setTransform(56.425,-397.7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_19.setTransform(31.875,-397.7);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AAVD5Igoi+IgIAAIAAC+IhxAAIAAnxIB5AAQBPAAAfAkQAfAiAABEIAAAkQAABIglAgIA4DbgAgbggIAGAAQAPAAAGgHQAFgHAAgQIAAgwQAAgQgFgHQgGgHgPAAIgGAAg");
	this.shape_20.setTransform(3.05,-397.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AAPD5IAAjFIgeAAIAADFIhyAAIAAnxIByAAIAAC8IAeAAIAAi8IBzAAIAAHxg");
	this.shape_21.setTransform(-27.775,-397.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("Ag4D5IAAmBIhGAAIAAhwID9AAIAABwIhGAAIAAGBg");
	this.shape_22.setTransform(-55.025,-397.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-149.8,-436.8,299.70000000000005,237.10000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(173).to({_off:false},0).wait(1).to({regY:-324.9,y:410.3,alpha:0.0032},0).wait(1).to({y:410.2,alpha:0.0145},0).wait(1).to({y:409.95,alpha:0.0371},0).wait(1).to({y:409.55,alpha:0.077},0).wait(1).to({y:408.85,alpha:0.1467},0).wait(1).to({y:407.65,alpha:0.2672},0).wait(1).to({y:406.15,alpha:0.4164},0).wait(1).to({y:404.7,alpha:0.5648},0).wait(1).to({y:403.45,alpha:0.6887},0).wait(1).to({y:402.45,alpha:0.7859},0).wait(1).to({y:401.7,alpha:0.8625},0).wait(1).to({y:401.1,alpha:0.9229},0).wait(1).to({y:400.7,alpha:0.9628},0).wait(1).to({y:400.45,alpha:0.9857},0).wait(1).to({y:400.35,alpha:0.9969},0).wait(1).to({regY:0.1,y:562.85,alpha:1},0).wait(74).to({regY:-324.9,x:79.1,y:400.35},0).wait(1).to({x:80.95},0).wait(1).to({x:84.6},0).wait(1).to({x:91.1},0).wait(1).to({x:102.5},0).wait(1).to({x:122.1},0).wait(1).to({x:146.45},0).wait(1).to({x:170.6},0).wait(1).to({x:190.8},0).wait(1).to({x:206.65},0).wait(1).to({x:219.1},0).wait(1).to({x:228.95},0).wait(1).to({x:235.45},0).wait(1).to({x:239.2},0).wait(1).to({x:241},0).wait(1).to({regY:0.1,x:241.55,y:562.85},0).to({_off:true},17).wait(75));
