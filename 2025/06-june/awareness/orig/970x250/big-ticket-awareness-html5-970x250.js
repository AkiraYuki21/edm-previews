...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhEA/QgcgWAAgpQAAglAcgYQAbgXApAAQApAAAcAXQAbAYABAlQgBApgbAWQgcAWgpAAQgpAAgbgWg");
	this.shape.setTransform(755.25,-137.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhUF0IAAo/IhpAAIAAioIF7AAIAACoIhoAAIAAI/g");
	this.shape_1.setTransform(723.4,-167.675);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AA3F0IgNiRIhTAAIgNCRIinAAIBirnID3AAIBiLngAgDiDIgVDHIAxAAIgVjHIgEg9g");
	this.shape_2.setTransform(679.9,-167.675);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AikF0IAArnIFHAAIAACeIidAAIAAB/ICAAAIAACfIiAAAIAACNICfAAIAACeg");
	this.shape_3.setTransform(638.5,-167.675);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AjDF0IAArnIC1AAQB1AAAvA1QAuA0AABlIAAA/QAABwg3AsQg3AshkAAIgKAAIAAESgAgYgnIAHAAQAUAAAJgKQAKgKgBgZIAAhRQABgYgKgLQgJgKgUAAIgHAAg");
	this.shape_4.setTransform(596.9,-167.675);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AikF0IAArnIFHAAIAACeIidAAIAAB/ICAAAIAACfIiAAAIAACNICfAAIAACeg");
	this.shape_5.setTransform(557.15,-167.675);
	...
	this.shape_6.setTransform(514.025,-167.675);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgCF0IgvnXIAAHXIiqAAIAArnIDgAAIAtHLIAAnLICqAAIAALng");
	this.shape_7.setTransform(453.325,-167.675);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AABF/QhhAAgzg1Qgyg1AAhjIAAliQAAhmA0g0QAzg0BeAAIACAAQBhAAAyA1QAxA1AABkIAAFiQAABngzAzQgzAzheAAgAgWi+IAAF9QAAAgAWAAIABAAQAXAAAAggIAAl9QAAgfgYAAIAAAAQgWAAAAAfg");
	this.shape_8.setTransform(406.025,-167.875);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("Ai4FcIAsiaQBJAdAfAAQA8AAgBgvIAAgFQAAgVgOgXQgOgXglgkIghggQg0gzgXgtQgXgsAAhGIAAgCQAAhhAyg3QAxg2BXAAQBJAABVAiIgsCPQg2gQgaAAQg6AAAAAvIAAADQAAAHACAGIAFAMIAJANIAMAOIAQAQIAQASIAjAkQA2A1AYAsQAXArAABMIAAABQAABkg1A6Qg0A5hXAAQhZAAhYgjg");
	this.shape_9.setTransform(352.1,-167.875);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgCF0IgvnXIAAHXIiqAAIAArnIDgAAIAtHLIAAnLICqAAIAALng");
	this.shape_10.setTransform(307.875,-167.675);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhUF0IAArnICpAAIAALng");
	this.shape_11.setTransform(271.775,-167.675);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAgF0Iggm/IgfG/IjdAAIg3rnIC1AAIAII7IAyo7ICJAAIAxI7IAJo7IC0AAIg3Lng");
	this.shape_12.setTransform(227.95,-167.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_sub_caption_mc, new cjs.Rectangle(193.9,-224.7,575.3000000000001,135.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:481,regY:-167.8,x:733.8,y:134.2,alpha:0.0037},0).wait(1).to({y:134.05,alpha:0.0167},0).wait(1).to({y:133.75,alpha:0.0435},0).wait(1).to({y:133.25,alpha:0.0919},0).wait(1).to({x:733.75,y:132.3,alpha:0.1816},0).wait(1).to({x:733.7,y:130.75,alpha:0.3248},0).wait(1).to({x:733.65,y:129.05,alpha:0.4878},0).wait(1).to({x:733.6,y:127.45,alpha:0.6345},0).wait(1).to({x:733.55,y:126.25,alpha:0.7499},0).wait(1).to({y:125.3,alpha:0.8388},0).wait(1).to({x:733.5,y:124.55,alpha:0.9088},0).wait(1).to({y:124.05,alpha:0.9564},0).wait(1).to({y:123.75,alpha:0.9834},0).wait(1).to({y:123.6,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0.1,x:483.05,y:211.05,alpha:1},0).wait(60).to({x:483.4,y:211.25},0).wait(1).to({regX:481,regY:-167.8,x:733.85,y:123.8,alpha:0.9968},0).wait(1).to({y:123.95,alpha:0.9855},0).wait(1).to({y:124.15,alpha:0.9629},0).wait(1).to({y:124.6,alpha:0.923},0).wait(1).to({y:125.3,alpha:0.8533},0).wait(1).to({y:126.55,alpha:0.7328},0).wait(1).to({y:128.15,alpha:0.5836},0).wait(1).to({y:129.7,alpha:0.4352},0).wait(1).to({y:130.95,alpha:0.3113},0).wait(1).to({y:132,alpha:0.2141},0).wait(1).to({y:132.8,alpha:0.1375},0).wait(1).to({y:133.4,alpha:0.0771},0).wait(1).to({y:133.85,alpha:0.0372},0).wait(1).to({y:134.1,alpha:0.0143},0).wait(1).to({y:134.2,alpha:0.0031},0).wait(1).to({regX:0.1,regY:0.1,x:483.4,y:221.7,alpha:0},0).to({_off:true},1).wait(94));
