...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(667.775,-27.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiaKlIAAwXIi/AAIAAkyIKzAAIAAEyIi+AAIAAQXg");
	this.shape_1.setTransform(609.875,-81.775);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ABkKlIgZkIIiVAAIgZEIIkwAAICz1JIHBAAICzVJgAgGjuIgmFqIBZAAIgmlqIgHhxg");
	this.shape_2.setTransform(530.775,-81.775);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AkrKlIAA1JIJUAAIAAEhIkfAAIAADmIDpAAIAAEhIjpAAIAAEAIEiAAIAAEhg");
	this.shape_3.setTransform(455.35,-81.775);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AlkKlIAA1JIFKAAQDWAABVBgQBUBgAAC4IAABxQAADMhkBQQhjBRi4AAIgTAAIAAHzgAgthIIAMAAQAnAAAQgSQASgTAAgtIAAiSQAAgtgSgTQgQgSgnAAIgMAAg");
	this.shape_4.setTransform(379.725,-81.775);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AkrKlIAA1JIJUAAIAAEhIkfAAIAADmIDpAAIAAEhIjpAAIAAEAIEiAAIAAEhg");
	this.shape_5.setTransform(307.4,-81.775);
	...
	this.shape_6.setTransform(228.925,-81.775);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgDKlIhWtZIAANZIk3AAIAA1JIGZAAIBSNFIAAtFIE2AAIAAVJg");
	this.shape_7.setTransform(118.625,-81.775);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AACK5QiyAAhbhhQhchhAAizIAAqEQAAi7BeheQBehfCrAAIADAAQCxAABaBhQBaBhAAC2IAAKEQAAC6hdBeQhcBdirAAgAgplaIAAK2QAAA5ApAAIACAAQApAAAAg5IAAq2QAAg5grAAIgBAAQgoAAAAA5g");
	this.shape_8.setTransform(32.6,-82.15);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AlQJ4IBRkXQCEA0A4AAQBtAAAAhUIAAgJQAAgngbgpQgbgqhChDIg7g5QhfhegqhRQgqhQAAiAIAAgDQAAixBbhjQBahkCfAAQCDAACaA+IhQEFQhigegvgBQhpABAABWIAAAFQAAAMAEAMQAEALAGAKQAFAKAMAPIAVAZIAcAdIAfAiQApAsAWAUQBiBiArBPQArBPgBCJIAAACQAAC3hgBpQhgBoieAAQihAAihhBg");
	this.shape_9.setTransform(465.85,-249.25);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgDKlIhWtZIAANZIk3AAIAA1JIGZAAIBSNFIAAtFIE2AAIAAVJg");
	this.shape_10.setTransform(385.425,-248.875);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AiaKlIAA1JIE1AAIAAVJg");
	this.shape_11.setTransform(319.825,-248.875);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AA7KlIg7stIg5MtImRAAIhk1JIFJAAIAPQPIBZwPID6AAIBaQPIAQwPIFIAAIhkVJg");
	this.shape_12.setTransform(240.1,-248.875);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-24.2,-352.6,730.5,413), null);
...
p.nominalBounds = new cjs.Rectangle(113.7,-12.1,69.89999999999999,15.399999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(181).to({_off:false},0).wait(1).to({regX:341,regY:-165.6,x:195.15,y:27,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:26.95,alpha:0.0435},0).wait(1).to({y:26.85,alpha:0.0919},0).wait(1).to({y:26.65,alpha:0.1816},0).wait(1).to({y:26.35,alpha:0.3248},0).wait(1).to({y:26,alpha:0.4878},0).wait(1).to({y:25.7,alpha:0.6345},0).wait(1).to({y:25.45,alpha:0.7499},0).wait(1).to({y:25.25,alpha:0.8388},0).wait(1).to({y:25.1,alpha:0.9088},0).wait(1).to({y:25,alpha:0.9564},0).wait(1).to({y:24.95,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(62).to({regX:341,regY:-165.6,x:195.15,y:24.95,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25,alpha:0.9565},0).wait(1).to({y:25.1,alpha:0.9081},0).wait(1).to({y:25.3,alpha:0.8184},0).wait(1).to({y:25.6,alpha:0.6752},0).wait(1).to({y:25.95,alpha:0.5122},0).wait(1).to({y:26.25,alpha:0.3655},0).wait(1).to({y:26.5,alpha:0.2501},0).wait(1).to({y:26.7,alpha:0.1612},0).wait(1).to({y:26.85,alpha:0.0912},0).wait(1).to({y:26.95,alpha:0.0436},0).wait(1).to({y:27,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).wait(94));
