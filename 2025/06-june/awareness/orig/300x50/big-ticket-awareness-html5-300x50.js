...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AiBB3Qg1gpAAhPQAAhHA1grQA0gtBNABQBPgBAzAtQA1ArAABHQAABPg1ApQgzAphPAAQhNAAg0gpg");
	this.shape.setTransform(677.325,-16.55);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AigLAIAAxBIjGAAIAAk+ILNAAIAAE+IjFAAIAARBg");
	this.shape_1.setTransform(617.125,-72.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ABoLAIgakSIibAAIgaESIk8AAIC61/IHTAAIC6V/gAgGj4IgoF5IBdAAIgol5IgHh1g");
	this.shape_2.setTransform(534.875,-72.85);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ak3LAIAA1/IJsAAIAAEsIkqAAIAADwIDyAAIAAEtIjyAAIAAEKIEtAAIAAEsg");
	this.shape_3.setTransform(456.5,-72.85);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AlyLAIAA1/IFWAAQDfAABZBkQBXBkAAC/IAAB1QAADVhoBTQhnBVjAAAIgTAAIAAIGgAgvhLIANAAQApAAARgSQARgUAAgvIAAiYQAAgvgRgTQgRgTgpAAIgNAAg");
	this.shape_4.setTransform(377.9,-72.85);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ak3LAIAA1/IJsAAIAAEsIkqAAIAADwIDxAAIAAEtIjxAAIAAEKIEtAAIAAEsg");
	this.shape_5.setTransform(302.75,-72.85);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA6LAIhvoYIgYAAIAAIYIlDAAIAA1/IFbAAQDeAABYBkQBYBkAAC/IAABkQgBDPhoBZICgJsgAhNhbIARAAQAqAAAQgUQARgTAAgvIAAiHQAAgvgRgTQgQgTgqAAIgRAAg");
	this.shape_6.setTransform(221.15,-72.85);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgELAIhZt8IAAN8IlDAAIAA1/IGpAAIBWNnIAAtnIFCAAIAAV/g");
	this.shape_7.setTransform(106.475,-72.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AABLVQi4AAhfhkQhfhlAAi8IAAqdQAAjCBhhiQBihjCyAAIADAAQC4AABeBlQBdBlAAC9IAAKdQAADDhgBhQhgBhixAAgAgqlnIAALRQAAA7AqAAIABAAQAsAAAAg7IAArRQAAg8gtAAIgBAAQgpAAAAA8g");
	this.shape_8.setTransform(16.925,-73.225);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AldKSIBUkiQCJA1A7AAQBxAAAAhYIAAgJQAAgogcgrQgcgshFhFIg9g7QhkhigrhUQgrhUAAiFIAAgDQAAi4BehnQBdhoCnAAQCHAAChBBIhTEPQhngfgwAAQhuAAAABZIAAAGQAAAMAFAMQADAMAHALQAGAKALAPIAWAaIAeAfIAfAiQAsAvAXAVQBlBlAtBTQAsBSAACOIAAACQAAC/hkBsQhkBtilAAQinAAinhDg");
	this.shape_9.setTransform(467.4,-257.925);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgELAIhZt7IAAN7IlDAAIAA1/IGpAAIBWNmIAAtmIFCAAIAAV/g");
	this.shape_10.setTransform(383.775,-257.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AigLAIAA1/IFCAAIAAV/g");
	this.shape_11.setTransform(315.55,-257.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AA9LAIg9tOIg8NOImgAAIho1/IFVAAIAQQ5IBdw5IEEAAIBeQ5IAQw5IFVAAIhoV/g");
	this.shape_12.setTransform(232.625,-257.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-64.5,-365.3,804.2,440.20000000000005), null);
...
p.nominalBounds = new cjs.Rectangle(111.5,-12.2,70.4,17.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(165).to({_off:false},0).wait(1).to({regX:337.6,regY:-165.4,x:184.8,y:27.05,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27,alpha:0.0435},0).wait(1).to({y:26.9,alpha:0.0919},0).wait(1).to({y:26.7,alpha:0.1816},0).wait(1).to({y:26.4,alpha:0.3248},0).wait(1).to({y:26.05,alpha:0.4878},0).wait(1).to({y:25.75,alpha:0.6345},0).wait(1).to({y:25.5,alpha:0.7499},0).wait(1).to({y:25.3,alpha:0.8388},0).wait(1).to({y:25.15,alpha:0.9088},0).wait(1).to({y:25.05,alpha:0.9564},0).wait(1).to({y:25,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(53).to({regX:337.6,regY:-165.4,x:184.8,y:25,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25.05,alpha:0.9565},0).wait(1).to({y:25.15,alpha:0.9081},0).wait(1).to({y:25.35,alpha:0.8184},0).wait(1).to({y:25.65,alpha:0.6752},0).wait(1).to({y:26,alpha:0.5122},0).wait(1).to({y:26.3,alpha:0.3655},0).wait(1).to({y:26.55,alpha:0.2501},0).wait(1).to({y:26.75,alpha:0.1612},0).wait(1).to({y:26.9,alpha:0.0912},0).wait(1).to({y:27,alpha:0.0436},0).wait(1).to({y:27.05,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).wait(96));
