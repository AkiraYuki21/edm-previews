...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AiBKgQg0goAAhQQAAhHA0gsQA0gsBNAAQBOAAA1AsQAzAsAABHQAABQgzAoQg1AqhOAAQhNAAg0gqgAigDxIAAu6IFCAAIAAO6g");
	this.shape.setTransform(466.575,-54.525);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AldKSIBUkiQCJA1A6AAQByAAAAhYIAAgJQAAgogcgrQgcgshFhFIg9g7QhkhigrhUQgrhUAAiFIAAgDQAAi4BehnQBdhoCnAAQCHAAChBBIhTEPQhngfgwAAQhuAAAABZIAAAGQAAAMAFAMQAEAMAFALQAGAKAMAPIAWAaIAeAfIAfAiQArAvAYAVQBlBlAtBTQAsBSAACOIAAACQAAC/hkBsQhkBtilAAQinAAinhDg");
	this.shape_1.setTransform(396.4,-55.875);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgELAIhZt7IAAN7IlDAAIAA1/IGpAAIBWNmIAAtmIFCAAIAAV/g");
	this.shape_2.setTransform(312.775,-55.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AihLAIAA1/IFCAAIAAV/g");
	this.shape_3.setTransform(244.5,-55.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AA9LAIg9tOIg8NOImgAAIho1/IFVAAIAQQ5IBdw5IEEAAIBeQ5IAQw5IFVAAIhoV/g");
	this.shape_4.setTransform(161.575,-55.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Al0LAIAA1/IFaAAQCtAABxBxQBwBxABC+IAAI3QgBDAhwB0QhxB0irAAgAgwGPIAMAAQAwAAANgVQAPgWAAg7IAApgQAAg2gSgQQgRgQgpAAIgMAAg");
	this.shape_5.setTransform(806.3,-257.55);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ak3LAIAA1/IJrAAIAAEsIkpAAIAADwIDyAAIAAEtIjyAAIAAEKIEtAAIAAEsg");
	this.shape_6.setTransform(731,-257.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ak3LAIAA1/IJsAAIAAEsIkqAAIAADwIDxAAIAAEtIjxAAIAAEKIEtAAIAAEsg");
	this.shape_7.setTransform(661.75,-257.55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AigLAIAAxBIjGAAIAAk+ILNAAIAAE+IjFAAIAARBg");
	this.shape_8.setTransform(588.625,-257.55);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgELAIhZt7IAAN7IlDAAIAA1/IGpAAIBWNmIAAtmIFCAAIAAV/g");
	this.shape_9.setTransform(504.925,-257.55);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("ABoLAIgakSIibAAIgaESIk8AAIC61/IHTAAIC6V/gAgGj4IgoF5IBdAAIgol5IgHh1g");
	this.shape_10.setTransform(412.625,-257.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AA7LAIhxoZIgWAAIAAIZIlDAAIAA1/IFZAAQDfAABZBkQBWBkAAC/IAABkQABDPhoBZICgJsgAhMhbIAPAAQAqgBARgTQARgTAAgvIAAiHQAAgugRgUQgRgTgqAAIgPAAg");
	this.shape_11.setTransform(321.9,-257.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("ABoLAIgakSIibAAIgaESIk8AAIC61/IHTAAIC6V/gAgGj4IgoF5IBdAAIgol5IgHh1g");
	this.shape_12.setTransform(231.225,-257.55);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AkPJrQhmheAAi4IAAwdIFJAAIAAQlQAAA8AsAAQAsAAAAg8IAAwlIFKAAIAAQdQAACshfBkQhfBki2gBQiqAAhnhdg");
	this.shape_13.setTransform(141.475,-256.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("Al1FOIAAqbQAAi1B1hqQB0hqC3AAQCsAACfBZIh0EWQhRgshgAAQh9AAACCNIAAJpQAABCAxAAQAWAAAOgJIAAn7IExAAIAALPQhhA3hIAYQhIAYhfAAQmBAAAAmJg");
	this.shape_14.setTransform(57.525,-257.725);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AigLAIAAxBIjGAAIAAk+ILNAAIAAE+IjFAAIAARBg");
	this.shape_15.setTransform(-44.375,-257.55);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AABLVQi4AAhfhkQhfhlAAi8IAAqdQAAjCBhhiQBihjCyAAIADAAQC4AABeBlQBdBlAAC9IAAKdQAADDhgBhQhgBhixAAgAgqlnIAALRQAAA7AqAAIABAAQAsAAAAg7IAArRQAAg8gtAAIgBAAQgpAAAAA8g");
	this.shape_16.setTransform(-123.875,-257.925);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAsLAIAAorIhXAAIAAIrIlDAAIAA1/IFDAAIAAIUIBXAAIAAoUIFDAAIAAV/g");
	this.shape_17.setTransform(-208.35,-257.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-331.2,-365.3,1262.7,457.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(165).to({_off:false},0).wait(1).to({regX:299.2,regY:-156.8,x:180.8,y:27.9,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.85,alpha:0.0435},0).wait(1).to({y:27.75,alpha:0.0919},0).wait(1).to({y:27.55,alpha:0.1816},0).wait(1).to({y:27.25,alpha:0.3248},0).wait(1).to({y:26.9,alpha:0.4878},0).wait(1).to({y:26.6,alpha:0.6345},0).wait(1).to({y:26.35,alpha:0.7499},0).wait(1).to({y:26.15,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.9,alpha:0.9564},0).wait(1).to({y:25.85,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(53).to({regX:299.2,regY:-156.8,x:180.8,y:25.85,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25.9,alpha:0.9565},0).wait(1).to({y:26,alpha:0.9081},0).wait(1).to({y:26.2,alpha:0.8184},0).wait(1).to({y:26.5,alpha:0.6752},0).wait(1).to({y:26.85,alpha:0.5122},0).wait(1).to({y:27.15,alpha:0.3655},0).wait(1).to({y:27.4,alpha:0.2501},0).wait(1).to({y:27.6,alpha:0.1612},0).wait(1).to({y:27.75,alpha:0.0912},0).wait(1).to({y:27.85,alpha:0.0436},0).wait(1).to({y:27.9,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).wait(96));
