...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgeCiQgNgKAAgTQAAgRANgLQAMgKASAAQATAAANAKQAMALAAARQAAATgMAKQgNAKgTAAQgSAAgMgKgAglA6IAAjlIBMAAIAADlg");
	this.shape.setTransform(40.1,-3.825);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhTCeIAUhGQAhAOAOAAQAbAAAAgWIAAgCQAAgKgHgKQgGgKgRgRIgOgPQgYgWgLgVQgKgTAAggIAAgBQAAgsAXgZQAWgaAnAAQAhAAAnAQIgUBBQgZgHgMAAQgZAAAAAWIAAABIABAFIACAGIAEAHIAFAFIAHAIIAIAIIAPARQAZAXALAUQAKAUAAAiIAAABQAAAtgYAbQgYAagnAAQgogBgogQg");
	this.shape_1.setTransform(23.175,-4.15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAACpIgWjWIAADWIhNAAIAAlRIBlAAIAVDRIAAjRIBNAAIAAFRg");
	this.shape_2.setTransform(3.025,-4.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgmCpIAAlRIBNAAIAAFRg");
	this.shape_3.setTransform(-13.375,-4.05);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAOCpIgOjKIgODKIhkAAIgZlRIBSAAIAEEDIAWkDIA+AAIAWEDIAFkDIBSAAIgaFRg");
	this.shape_4.setTransform(-33.3,-4.05);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhZCqIAAlSIBTAAQApAAAbAbQAcAbAAAtIAACIQAAAvgcAbQgbAdgoAAgAgLBgIADAAQALAAADgFQADgFAAgOIAAiSQAAgNgEgEQgEgDgJgBIgDAAg");
	this.shape_5.setTransform(121.875,-56.95);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhKCqIAAlSICVAAIAABIIhIAAIAAA5IA6AAIAABIIg6AAIAABBIBIAAIAABIg");
	this.shape_6.setTransform(103.75,-56.95);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhKCqIAAlSICVAAIAABIIhJAAIAAA5IA7AAIAABIIg7AAIAABBIBJAAIAABIg");
	this.shape_7.setTransform(87.05,-56.95);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AglCqIAAkGIgwAAIAAhMICsAAIAABMIgwAAIAAEGg");
	this.shape_8.setTransform(69.45,-56.95);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAACqIgWjWIAADWIhNAAIAAlSIBlAAIAVDQIAAjQIBNAAIAAFSg");
	this.shape_9.setTransform(49.275,-56.95);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAZCqIgGhDIglAAIgGBDIhMAAIAtlSIBvAAIAtFSgAgBg7IgJBaIAVAAIgKhaIgBgcg");
	this.shape_10.setTransform(27.05,-56.95);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAOCqIgaiCIgGAAIAACCIhNAAIAAlSIBTAAQA1AAAVAYQAVAYAAAtIAAAZQAAAxgZAVIAmCWgAgSgWIAEAAQAKABAEgFQAEgEAAgMIAAghQAAgKgEgFQgEgEgKgBIgEAAg");
	this.shape_11.setTransform(5.225,-56.95);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAZCqIgGhDIglAAIgGBDIhMAAIAtlSIBvAAIAtFSgAgBg7IgJBaIAVAAIgKhaIgBgcg");
	this.shape_12.setTransform(-16.6,-56.95);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhACVQgZgXAAgsIAAj8IBPAAIAAD+QAAAOAKABQALgBAAgOIAAj+IBPAAIAAD8QAAAqgXAXQgXAYgrAAQgpABgYgXg");
	this.shape_13.setTransform(-38.225,-56.75);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhZBQIAAigQAAgrAcgZQAcgaAsAAQAoAAAnAVIgcBEQgUgLgWAAQgeAAAAAiIAACUQAAAPAMAAQAFAAAEgCIAAh5IBJAAIAACtQgXANgSAFQgRAGgXAAQhcAAAAhfg");
	this.shape_14.setTransform(-58.4,-57);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AglCqIAAkGIgxAAIAAhMICsAAIAABMIgvAAIAAEGg");
	this.shape_15.setTransform(-82.95,-56.95);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAACuQgrAAgXgYQgXgYAAgtIAAigQAAgvAYgXQAXgZAqAAIAAAAQAtABAXAYQAWAZAAAtIAACgQAAAvgXAXQgXAXgrAAgAgJhWIAACtQAAAOAJABIAAAAQALgBgBgOIAAitQAAgOgKAAIAAAAQgKAAABAOg");
	this.shape_16.setTransform(-102.1,-57.05);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AALCqIAAiGIgVAAIAACGIhNAAIAAlSIBNAAIAAB/IAVAAIAAh/IBNAAIAAFSg");
	this.shape_17.setTransform(-122.425,-56.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-133.8,-83.8,267.6,116.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:-0.2,regY:-30.6,x:147.15,y:520.2,alpha:0.0037},0).wait(1).to({y:519.95,alpha:0.0167},0).wait(1).to({y:519.45,alpha:0.0435},0).wait(1).to({y:518.55,alpha:0.0919},0).wait(1).to({y:516.85,alpha:0.1816},0).wait(1).to({y:514.2,alpha:0.3248},0).wait(1).to({y:511.15,alpha:0.4878},0).wait(1).to({y:508.4,alpha:0.6345},0).wait(1).to({y:506.2,alpha:0.7499},0).wait(1).to({y:504.55,alpha:0.8388},0).wait(1).to({y:503.25,alpha:0.9088},0).wait(1).to({y:502.35,alpha:0.9564},0).wait(1).to({y:501.85,alpha:0.9834},0).wait(1).to({y:501.6,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:147.35,y:530.25,alpha:1},0).wait(61).to({regX:-0.2,regY:-30.6,x:147.15,y:501.6,alpha:0.9963},0).wait(1).to({y:501.85,alpha:0.9833},0).wait(1).to({y:502.35,alpha:0.9565},0).wait(1).to({y:503.25,alpha:0.9081},0).wait(1).to({y:504.95,alpha:0.8184},0).wait(1).to({y:507.6,alpha:0.6752},0).wait(1).to({y:510.65,alpha:0.5122},0).wait(1).to({y:513.4,alpha:0.3655},0).wait(1).to({y:515.6,alpha:0.2501},0).wait(1).to({y:517.25,alpha:0.1612},0).wait(1).to({y:518.55,alpha:0.0912},0).wait(1).to({y:519.45,alpha:0.0436},0).wait(1).to({y:519.95,alpha:0.0166},0).wait(1).to({y:520.2,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:147.35,y:549,alpha:0},0).wait(80));
