...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgpDcQgRgOAAgaQAAgXARgOQAQgPAZAAQAaAAAQAPQASAOgBAXQABAagSAOQgQANgaAAQgZAAgQgNgAg0BPIAAk3IBoAAIAAE3g");
	this.shape.setTransform(143.2,-267.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ag0DmIAAljIhAAAIAAhoIDpAAIAABoIhAAAIAAFjg");
	this.shape_1.setTransform(120.225,-267.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ag0DmIAAnLIBpAAIAAHLg");
	this.shape_2.setTransform(101.225,-267.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhxDXIAbhfQAtASATAAQAkAAAAgdIAAgDQAAgNgJgOQgIgOgXgXIgUgTQgggggOgbQgOgcAAgrIAAgBQAAg8AegiQAfgiA1AAQAtAAA0AWIgbBYQghgKgQAAQgjAAAAAdIAAACIABAIIADAHIAFAJIAIAIIAJAKIALALIAVAWQAhAhAPAbQAOAbAAAuIAAABQAAA+ggAjQghAkg1AAQg3AAg2gWg");
	this.shape_3.setTransform(74.875,-267.525);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhxDXIAbhfQAtASATAAQAkAAAAgdIAAgDQAAgNgJgOQgIgOgXgXIgUgTQgggggOgbQgOgcAAgrIAAgBQAAg8AegiQAfgiA1AAQAtAAA0AWIgbBYQghgKgQAAQgjAAAAAdIAAACIABAIIADAHIAFAJIAIAIIAJAKIALALIAVAWQAhAhAPAbQAOAbAAAuIAAABQAAA+ggAjQghAkg1AAQg3AAg2gWg");
	this.shape_4.setTransform(50.875,-267.525);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ag0DmIAAnLIBpAAIAAHLg");
	this.shape_5.setTransform(31.925,-267.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("ABLDmIAAlXIgFA0IgfEjIhOAAIgfkjIgFg0IAAFXIhmAAIAAnLICgAAIAPDaIACAiIADgiIAQjaICfAAIAAHLg");
	this.shape_6.setTransform(5.525,-267.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ag0DmIAAljIhAAAIAAhoIDpAAIAABoIhAAAIAAFjg");
	this.shape_7.setTransform(-33.375,-267.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgeBjIgTjFIBjAAIgSDFg");
	this.shape_8.setTransform(-52.675,-280.525);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgBDmIgdkiIAAEiIhpAAIAAnLICKAAIAcEcIAAkcIBpAAIAAHLg");
	this.shape_9.setTransform(-75.25,-267.4);
	...
	this.shape_10.setTransform(-104.425,-267.525);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("Ah4DmIAAnLIBwAAQA4AAAlAlQAlAlAAA+IAAC5QAAA+glAmQglAmg3AAgAgPCDIAEAAQAPAAAEgIQAFgGAAgUIAAjGQAAgRgGgFQgFgGgNAAIgEAAg");
	this.shape_11.setTransform(-132.25,-267.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("Ah5BtIAAjZQAAg7AmgjQAmgiA7gBQA4AAA0AeIgmBbQgagPggAAQgoAAABAuIAADJQAAAWAPgBQAHAAAFgCIAAimIBjAAIAADrQgfASgYAHQgXAIgfAAQh9AAAAiAg");
	this.shape_12.setTransform(71.425,-334.05);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("Ag0DmIAAnLIBpAAIAAHLg");
	this.shape_13.setTransform(50.525,-334);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("Ah6DmIAAnLIBzAAQA6AAAhAcQAiAcAAA5IAAAMQAAAjgMAWQgLAVgZAMQA1ATAABLIAAAcQAAA7ghAfQggAgg4AAgAgRCDIAHAAQAMAAAFgHQAEgFAAgOIAAgtQAAgOgEgGQgEgGgNAAIgHAAgAgRgyIAIAAQANAAAEgGQAFgGAAgNIAAgcQAAgOgFgFQgEgHgNAAIgIAAg");
	this.shape_14.setTransform(29.85,-334);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgBDmIgdkiIAAEiIhpAAIAAnLICKAAIAcEcIAAkcIBpAAIAAHLg");
	this.shape_15.setTransform(-6.85,-334);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("Ag0DmIAAnLIBpAAIAAHLg");
	this.shape_16.setTransform(-29.125,-334);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAUDmIgUkUIgTEUIiIAAIginLIBwAAIAFFgIAelgIBVAAIAeFgIAFlgIBwAAIgiHLg");
	this.shape_17.setTransform(-56.225,-334);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAADtQg7AAgfghQgfghAAg9IAAjaQAAg/AfggQAgghA6AAIABAAQA8AAAfAhQAeAhAAA+IAADaQAAA/ggAgQgfAgg6AAgAgNh1IAADrQAAAUANAAIAAAAQAOAAAAgUIAAjrQAAgTgOAAIAAAAQgNAAAAATg");
	this.shape_18.setTransform(111.425,-400.675);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("Ag0DmIAAljIhAAAIAAhoIDpAAIAABoIhAAAIAAFjg");
	this.shape_19.setTransform(85.475,-400.55);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AhlDmIAAnLIDKAAIAABiIhhAAIAABOIBOAAIAABiIhOAAIAABXIBiAAIAABig");
	this.shape_20.setTransform(55.325,-400.55);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("ABLDmIAAlYIgFA1IgfEjIhOAAIgfkjIgFg1IAAFYIhmAAIAAnLICgAAIAPDaIACAiIADgiIAQjaICfAAIAAHLg");
	this.shape_21.setTransform(24.025,-400.55);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("Ag0DmIAAnLIBpAAIAAHLg");
	this.shape_22.setTransform(-2.425,-400.55);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("Ag0DmIAAljIhAAAIAAhoIDpAAIAABoIhAAAIAAFjg");
	this.shape_23.setTransform(-21.425,-400.55);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AhxDXIAbhfQAtASATAAQAkAAAAgdIAAgDQAAgNgJgOQgIgOgXgXIgUgTQgggggOgbQgOgcAAgrIAAgBQAAg8AegiQAfgiA1AAQAtAAA0AWIgbBYQghgKgQAAQgjAAAAAdIAAACIABAIIADAHIAFAJIAIAIIAJAKIALALIAVAWQAhAhAPAbQAOAbAAAuIAAABQAAA+ggAjQghAkg1AAQg3AAg2gWg");
	this.shape_24.setTransform(-52.825,-400.675);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AgeBjIgTjFIBjAAIgSDFg");
	this.shape_25.setTransform(-72.075,-413.675);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("Ag0DmIAAljIhAAAIAAhoIDpAAIAABoIhAAAIAAFjg");
	this.shape_26.setTransform(-91.375,-400.55);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("Ag0DmIAAnLIBpAAIAAHLg");
	this.shape_27.setTransform(-110.375,-400.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-148,-436.8,304.1,218.60000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(173).to({_off:false},0).wait(1).to({regX:2.4,regY:-334.1,x:79.8,y:405.7,alpha:0.0032},0).wait(1).to({y:405.6,alpha:0.0145},0).wait(1).to({y:405.35,alpha:0.0371},0).wait(1).to({y:404.95,alpha:0.077},0).wait(1).to({y:404.25,alpha:0.1467},0).wait(1).to({y:403.05,alpha:0.2672},0).wait(1).to({y:401.55,alpha:0.4164},0).wait(1).to({y:400.1,alpha:0.5648},0).wait(1).to({y:398.85,alpha:0.6887},0).wait(1).to({y:397.85,alpha:0.7859},0).wait(1).to({y:397.1,alpha:0.8625},0).wait(1).to({y:396.5,alpha:0.9229},0).wait(1).to({y:396.1,alpha:0.9628},0).wait(1).to({y:395.85,alpha:0.9857},0).wait(1).to({y:395.75,alpha:0.9969},0).wait(1).to({regX:0,regY:0.1,x:78.6,y:562.85,alpha:1},0).wait(74).to({regX:2.4,regY:-334.1,x:80.3,y:395.75},0).wait(1).to({x:82.15},0).wait(1).to({x:85.8},0).wait(1).to({x:92.3},0).wait(1).to({x:103.7},0).wait(1).to({x:123.3},0).wait(1).to({x:147.65},0).wait(1).to({x:171.8},0).wait(1).to({x:192},0).wait(1).to({x:207.85},0).wait(1).to({x:220.3},0).wait(1).to({x:230.15},0).wait(1).to({x:236.65},0).wait(1).to({x:240.4},0).wait(1).to({x:242.2},0).wait(1).to({regX:0,regY:0.1,x:241.55,y:562.85},0).to({_off:true},17).wait(75));
