...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgdCcQgMgKAAgSQAAgRAMgKQAMgKARAAQASAAAMAKQAMAKAAARQAAASgMAKQgMAJgSAAQgRAAgMgJgAglA4IAAjcIBLAAIAADcg");
	this.shape.setTransform(98.65,-7.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgkCjIAAj8IguAAIAAhJIClAAIAABJIguAAIAAD8g");
	this.shape_1.setTransform(82.375,-7.25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgkCjIAAlFIBJAAIAAFFg");
	this.shape_2.setTransform(68.875,-7.25);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhQCYIAThDQAgAMANAAQAaAAAAgUIAAgCQAAgJgHgKQgFgKgQgQIgOgOQgXgWgKgUQgKgTAAgfIAAAAQAAgrAWgYQAVgYAmAAQAfAAAlAPIgTA/QgYgHgLAAQgZAAAAAUIAAACIABAFIADAGIADAFIAGAGIAGAIIAHAHIAQAQQAXAXALATQAKATAAAhIAAAAQAAAsgXAaQgXAZgmAAQgnAAgmgQg");
	this.shape_3.setTransform(50.25,-7.325);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhQCYIAThDQAgAMANAAQAaAAAAgUIAAgCQAAgJgHgKQgFgKgQgQIgOgOQgXgWgKgUQgKgTAAgfIAAAAQAAgrAWgYQAVgYAmAAQAfAAAlAPIgTA/QgYgHgLAAQgZAAAAAUIAAACIABAFIADAGIADAFIAGAGIAHAIIAGAHIAQAQQAYAXAKATQAKATAAAhIAAAAQAAAsgXAaQgYAZglAAQgnAAgmgQg");
	this.shape_4.setTransform(33.25,-7.325);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgkCjIAAlFIBJAAIAAFFg");
	this.shape_5.setTransform(19.775,-7.25);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA1CjIAAjzIgDAlIgWDOIg4AAIgVjOIgEglIAADzIhIAAIAAlFIByAAIAKCaIABAZIACgZIAMiaIBwAAIAAFFg");
	this.shape_6.setTransform(1.05,-7.25);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgkCjIAAj8IguAAIAAhJIClAAIAABJIguAAIAAD8g");
	this.shape_7.setTransform(-26.475,-7.25);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgVBGIgOiLIBGAAIgMCLg");
	this.shape_8.setTransform(-40.15,-16.55);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAACjIgVjOIAADOIhKAAIAAlFIBhAAIAUDJIAAjJIBKAAIAAFFg");
	this.shape_9.setTransform(-56.15,-7.25);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAACoQgpAAgWgXQgXgYAAgrIAAiaQABgtAWgXQAWgXApAAIABAAQAqAAAWAYQAVAXABAsIAACaQAAAtgXAWQgWAXgpAAgAgJhSIAACmQAAANAJAAIAAAAQALAAgBgNIAAimQAAgOgKAAIAAAAQgJAAAAAOg");
	this.shape_10.setTransform(-76.9,-7.325);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhVCjIAAlFIBQAAQAnAAAaAaQAaAaAAAtIAACCQAAAsgaAbQgaAbgnAAgAgLBcIADAAQALAAADgEQADgGAAgNIAAiMQAAgMgEgFQgEgDgJAAIgDAAg");
	this.shape_11.setTransform(-96.575,-7.25);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhWBNIAAiZQAAgqAbgZQAcgYApAAQAoAAAlAUIgbBBQgTgLgWAAQgdAAABAhIAACOQAAAPAKAAQAGAAADgCIAAh0IBGAAIAAClQgWANgQAGQgRAFgXAAQhXAAgBhbg");
	this.shape_12.setTransform(136.4,-57.925);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgkCjIAAlFIBJAAIAAFFg");
	this.shape_13.setTransform(121.575,-57.9);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhWCjIAAlFIBSAAQAoAAAYAUQAYATAAApIAAAIQAAAagIAPQgIAPgTAIQAmANAAA2IAAAUQAAApgXAXQgXAWgnAAgAgMBcIAFAAQAIABAEgFQADgEAAgKIAAgfQAAgKgDgFQgDgEgJAAIgFAAgAgMgkIAGAAQAIAAAEgDQADgFAAgJIAAgUQAAgJgDgFQgDgEgJAAIgGAAg");
	this.shape_14.setTransform(106.925,-57.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AAACjIgVjOIAADOIhLAAIAAlFIBiAAIAUDJIAAjJIBLAAIAAFFg");
	this.shape_15.setTransform(80.95,-57.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgkCjIAAlFIBJAAIAAFFg");
	this.shape_16.setTransform(65.125,-57.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAOCjIgOjDIgNDDIhhAAIgXlFIBOAAIAFD6IAVj6IA8AAIAVD6IAEj6IBOAAIgXFFg");
	this.shape_17.setTransform(45.9,-57.9);
	...
	this.shape_18.setTransform(16.55,-57.975);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgkCjIAAj8IguAAIAAhJIClAAIAABJIguAAIAAD8g");
	this.shape_19.setTransform(-1.775,-57.9);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AhHCjIAAlFICOAAIAABGIhFAAIAAA3IA4AAIAABFIg4AAIAAA+IBGAAIAABFg");
	this.shape_20.setTransform(-23.125,-57.9);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AA1CjIAAjzIgDAlIgWDOIg3AAIgXjOIgDglIAADzIhIAAIAAlFIByAAIAKCaIABAYIACgYIAMiaIBwAAIAAFFg");
	this.shape_21.setTransform(-45.4,-57.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgkCjIAAlFIBJAAIAAFFg");
	this.shape_22.setTransform(-64.125,-57.9);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgkCjIAAj8IguAAIAAhJIClAAIAABJIguAAIAAD8g");
	this.shape_23.setTransform(-77.575,-57.9);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AhQCYIAUhDQAfAMAOAAQAZAAAAgUIAAgCQAAgJgHgKQgFgKgQgQIgOgOQgXgWgKgUQgKgTAAgfIAAAAQAAgrAWgYQAVgYAmAAQAfAAAmAPIgTA/QgYgHgLAAQgaAAAAAUIAAACIABAFIADAGIAEAFIAEAGIAHAIIAHAHIAQAQQAXAXALATQAKATAAAhIAAAAQAAAsgXAaQgXAZgmAAQgmAAgngQg");
	this.shape_24.setTransform(-99.8,-57.975);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AgVBGIgOiLIBGAAIgMCLg");
	this.shape_25.setTransform(-113.5,-67.2);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AgkCjIAAj8IguAAIAAhJIClAAIAABJIguAAIAAD8g");
	this.shape_26.setTransform(-127.175,-57.9);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AgkCjIAAlFIBJAAIAAFFg");
	this.shape_27.setTransform(-140.625,-57.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-147.2,-83.8,294.4,111.69999999999999), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.consolation();
	this.instance.setTransform(3.4,-20.25,0.6417,0.6417);

	this.instance_1 = new lib.bigwin();
	this.instance_1.setTransform(-144.6,-20.25,0.6636,0.6636);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.another_prizes_mc, new cjs.Rectangle(-144.6,-20.2,289.2,40.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_38.setTransform(48.975,586.775);
	...
	this.instance_4.setTransform(146.3,441.25);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(256).to({_off:false},0).wait(1).to({y:441.2436,alpha:0.0032},0).wait(1).to({y:441.2211,alpha:0.0145},0).wait(1).to({y:441.1758,alpha:0.0371},0).wait(1).to({y:441.096,alpha:0.077},0).wait(1).to({y:440.9566,alpha:0.1467},0).wait(1).to({y:440.7157,alpha:0.2672},0).wait(1).to({y:440.4171,alpha:0.4164},0).wait(1).to({y:440.1204,alpha:0.5648},0).wait(1).to({y:439.8726,alpha:0.6887},0).wait(1).to({y:439.6781,alpha:0.7859},0).wait(1).to({y:439.525,alpha:0.8625},0).wait(1).to({y:439.4042,alpha:0.9229},0).wait(1).to({y:439.3243,alpha:0.9628},0).wait(1).to({y:439.2786,alpha:0.9857},0).wait(1).to({y:439.2563,alpha:0.9969},0).wait(1).to({y:439.25,alpha:1},0).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(15).to({_off:false},0).wait(1).to({regX:0.3,regY:-8.5,x:150,y:498.95,alpha:0.0037},0).wait(1).to({y:498.8,alpha:0.0167},0).wait(1).to({y:498.55,alpha:0.0435},0).wait(1).to({y:498.05,alpha:0.0919},0).wait(1).to({y:497.15,alpha:0.1816},0).wait(1).to({y:495.75,alpha:0.3248},0).wait(1).to({y:494.1,alpha:0.4878},0).wait(1).to({y:492.65,alpha:0.6345},0).wait(1).to({y:491.5,alpha:0.7499},0).wait(1).to({y:490.6,alpha:0.8388},0).wait(1).to({y:489.9,alpha:0.9088},0).wait(1).to({y:489.4,alpha:0.9564},0).wait(1).to({y:489.15,alpha:0.9834},0).wait(1).to({y:489,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:149.7,y:497.5,alpha:1},0).wait(69).to({regX:0.3,regY:-8.5,x:150,y:488.95,alpha:0.9963},0).wait(1).to({y:488.8,alpha:0.9833},0).wait(1).to({y:488.55,alpha:0.9565},0).wait(1).to({y:488.05,alpha:0.9081},0).wait(1).to({y:487.15,alpha:0.8184},0).wait(1).to({y:485.75,alpha:0.6752},0).wait(1).to({y:484.1,alpha:0.5122},0).wait(1).to({y:482.65,alpha:0.3655},0).wait(1).to({y:481.5,alpha:0.2501},0).wait(1).to({y:480.6,alpha:0.1612},0).wait(1).to({y:479.9,alpha:0.0912},0).wait(1).to({y:479.4,alpha:0.0436},0).wait(1).to({y:479.15,alpha:0.0166},0).wait(1).to({y:479,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:149.7,y:487.5,alpha:0},0).to({_off:true},1).wait(237));

	// bonus_prizes_copy
	this.instance_6 = new lib.big_win_mc();
	this.instance_6.setTransform(149.7,507.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).wait(1).to({regY:-8,y:499.45,alpha:0.0037},0).wait(1).to({y:499.3,alpha:0.0167},0).wait(1).to({y:499.05,alpha:0.0435},0).wait(1).to({y:498.55,alpha:0.0919},0).wait(1).to({y:497.65,alpha:0.1816},0).wait(1).to({y:496.25,alpha:0.3248},0).wait(1).to({y:494.6,alpha:0.4878},0).wait(1).to({y:493.15,alpha:0.6345},0).wait(1).to({y:492,alpha:0.7499},0).wait(1).to({y:491.1,alpha:0.8388},0).wait(1).to({y:490.4,alpha:0.9088},0).wait(1).to({y:489.9,alpha:0.9564},0).wait(1).to({y:489.65,alpha:0.9834},0).wait(1).to({y:489.5,alpha:0.9964},0).wait(1).to({regY:0,y:497.5,alpha:1},0).wait(69).to({regY:-8,y:489.45,alpha:0.9963},0).wait(1).to({y:489.3,alpha:0.9833},0).wait(1).to({y:489.05,alpha:0.9565},0).wait(1).to({y:488.55,alpha:0.9081},0).wait(1).to({y:487.65,alpha:0.8184},0).wait(1).to({y:486.25,alpha:0.6752},0).wait(1).to({y:484.6,alpha:0.5122},0).wait(1).to({y:483.15,alpha:0.3655},0).wait(1).to({y:482,alpha:0.2501},0).wait(1).to({y:481.1,alpha:0.1612},0).wait(1).to({y:480.4,alpha:0.0912},0).wait(1).to({y:479.9,alpha:0.0436},0).wait(1).to({y:479.65,alpha:0.0166},0).wait(1).to({y:479.5,alpha:0.0036},0).wait(1).to({regY:0,y:487.5,alpha:0},0).to({_off:true},1).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:0.4,regY:-32.6,x:147.75,y:518.35,alpha:0.0037},0).wait(1).to({y:518.1,alpha:0.0167},0).wait(1).to({y:517.6,alpha:0.0435},0).wait(1).to({y:516.7,alpha:0.0919},0).wait(1).to({y:515,alpha:0.1816},0).wait(1).to({y:512.35,alpha:0.3248},0).wait(1).to({y:509.3,alpha:0.4878},0).wait(1).to({y:506.55,alpha:0.6345},0).wait(1).to({y:504.35,alpha:0.7499},0).wait(1).to({y:502.7,alpha:0.8388},0).wait(1).to({y:501.4,alpha:0.9088},0).wait(1).to({y:500.5,alpha:0.9564},0).wait(1).to({y:500,alpha:0.9834},0).wait(1).to({y:499.75,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:147.35,y:530.25,alpha:1},0).wait(61).to({regX:0.4,regY:-32.6,x:147.75,y:499.75,alpha:0.9963},0).wait(1).to({y:500,alpha:0.9833},0).wait(1).to({y:500.5,alpha:0.9565},0).wait(1).to({y:501.4,alpha:0.9081},0).wait(1).to({y:503.1,alpha:0.8184},0).wait(1).to({y:505.75,alpha:0.6752},0).wait(1).to({y:508.8,alpha:0.5122},0).wait(1).to({y:511.55,alpha:0.3655},0).wait(1).to({y:513.75,alpha:0.2501},0).wait(1).to({y:515.4,alpha:0.1612},0).wait(1).to({y:516.7,alpha:0.0912},0).wait(1).to({y:517.6,alpha:0.0436},0).wait(1).to({y:518.1,alpha:0.0166},0).wait(1).to({y:518.35,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:147.35,y:549,alpha:0},0).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:-0.3,regY:-119.5,x:411.2,y:266.7,alpha:0.0037},0).wait(1).to({x:407.8,alpha:0.0167},0).wait(1).to({x:400.75,alpha:0.0435},0).wait(1).to({x:388.05,alpha:0.0919},0).wait(1).to({x:364.5,alpha:0.1816},0).wait(1).to({x:326.95,alpha:0.3248},0).wait(1).to({x:284.15,alpha:0.4878},0).wait(1).to({x:245.65,alpha:0.6345},0).wait(1).to({x:215.35,alpha:0.7499},0).wait(1).to({x:192.05,alpha:0.8388},0).wait(1).to({x:173.65,alpha:0.9088},0).wait(1).to({x:161.15,alpha:0.9564},0).wait(1).to({x:154.05,alpha:0.9834},0).wait(1).to({x:150.65,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:150,y:360,alpha:1},0).wait(242).to({regX:-0.3,regY:-119.5,scaleX:0.7799,scaleY:0.7799,x:149.75,y:266.75},0).wait(1).to({scaleX:0.7769,scaleY:0.7769,y:267.1},0).wait(1).to({scaleX:0.7707,scaleY:0.7707,y:267.85},0).wait(1).to({scaleX:0.7596,scaleY:0.7596,y:269.15},0).wait(1).to({scaleX:0.739,scaleY:0.739,x:149.8,y:271.5},0).wait(1).to({scaleX:0.706,scaleY:0.706,y:275.3},0).wait(1).to({scaleX:0.6685,scaleY:0.6685,y:279.6},0).wait(1).to({scaleX:0.6348,scaleY:0.6348,y:283.5},0).wait(1).to({scaleX:0.6083,scaleY:0.6083,y:286.55},0).wait(1).to({scaleX:0.5878,scaleY:0.5878,y:288.9},0).wait(1).to({scaleX:0.5717,scaleY:0.5717,x:149.85,y:290.75},0).wait(1).to({scaleX:0.5608,scaleY:0.5608,y:292},0).wait(1).to({scaleX:0.5546,scaleY:0.5546,y:292.75},0).wait(1).to({scaleX:0.5516,scaleY:0.5516,y:293.1},0).wait(1).to({regX:0.1,regY:0,scaleX:0.5508,scaleY:0.5508,x:150.05,y:359},0).wait(80));

	// background
	this.instance_9 = new lib.background_mc();
	this.instance_9.setTransform(150,300,1.05,1.05);
...
p.nominalBounds = new cjs.Rectangle(-138.5,285,690.2,330);
// library properties:
lib.properties = {
