...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AgRA2IAAglIgkAAIAAgiIAkAAIAAgkIAjAAIAAAkIAkAAIAAAiIgkAAIAAAlg");
	this.shape.setTransform(38.075,-0.825);

	this.instance = new lib._2ndprize();
	this.instance.setTransform(53,-24,0.1959,0.1959);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(29.3,-24,78.2,48.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("AlnMsIAA5XILLAAIAAFaIlXAAIAAEVIEXAAIAAFbIkXAAIAAEzIFbAAIAAFag");
	this.shape.setTransform(135.8,-62.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("AlnMsIAA5XILLAAIAAFaIlXAAIAAEVIEWAAIAAFbIkWAAIAAEzIFbAAIAAFag");
	this.shape_1.setTransform(55.9,-62.725);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("ABDMsIiBprIgaAAIAAJrIl1AAIAA5XIGPAAQEBAABmBzQBlB0AADcIAAB0QAADuh5BnIC5LLgAhYhqIASAAQAwAAAUgXQATgVAAg2IAAicQAAg2gTgXQgUgVgwAAIgSAAg");
	this.shape_2.setTransform(-38.225,-62.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("AlwMsIAA5XILhAAIAAFaIltAAIAAEVIEtAAIAAFbIktAAIAAKNg");
	this.shape_3.setTransform(-129.325,-62.725);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("AhmM4IAAy/IipAmIAAlaIIfh8IAAZvg");
	this.shape_4.setTransform(-236.35,-63.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFE400").s().p("Ai5MsIAAzoIjlAAIAAlvIM8AAIAAFvIjjAAIAATog");
	this.shape_5.setTransform(-336,-62.725);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("AlnMsIAA5XILLAAIAAFaIlXAAIAAEVIEWAAIAAFbIkWAAIAAEzIFbAAIAAFag");
	this.shape_6.setTransform(-416.4,-62.725);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("AmvGCIAAsDQAAjQCHh6QCGh7DUAAQDGAAC4BnIiGFBQhegzhuAAQiRAAACCiIAALIQAABNA5AAQAaAAAQgKIAApKIFgAAIAAM+QhwBAhTAbQhTAchvAAQm8AAAAnFg");
	this.shape_7.setTransform(-503.975,-62.925);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("Ak6FUIDaqnIGbAAIk5Kng");
	this.shape_8.setTransform(315.475,-188.075);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AmTL3IBhlOQCfA9BDAAQCDAAAAhmIAAgKQAAgugggyQghgyhQhQIhHhFQhxhwgyhiQgzhhAAiYIAAgEQAAjUBth4QBrh3DBAAQCcAAC6BKIhgE5Qh2gkg4AAQiAAAABBoIAAAGQAAAOAEAOQAFAOAHAMQAHAMAOASIAZAdIAiAkIAkAnQAyA2AbAZQB1B1A0BfQAzBfAACkIAAACQAADchzB9Qh0B9i/AAQjBAAjAhNg");
	this.shape_9.setTransform(247.5,-268.975);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Ai5MsIAAzoIjlAAIAAlvIM8AAIAAFvIjjAAIAATog");
	this.shape_10.setTransform(162.7,-268.525);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AlnMsIAA5XILLAAIAAFaIlXAAIAAEVIEXAAIAAFbIkXAAIAAEzIFbAAIAAFag");
	this.shape_11.setTransform(82.25,-268.525);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AA1MsIiTrpIAALpIl0AAIAA5XIF0AAIAALlICRrlIGHAAIjIL/IDiNYg");
	this.shape_12.setTransform(-10.5,-268.525);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AA4NGQjmAAh2h8Qh3h9AAjyIAAq1QAAjyB3h8QB2h9DmAAIACAAQCwAACUBDIiGEsQg6gRhHAAIgBAAQiTAAAACyIAAJsQAABUAtAvQAuAvBMAAIACAAQBCAABKgfICEEsQiiBQjAAAg");
	this.shape_13.setTransform(-104.425,-268.825);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("Ai6MsIAA5XIF1AAIAAZXg");
	this.shape_14.setTransform(-176.25,-268.525);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("Ai5MsIAAzoIjlAAIAAlvIM8AAIAAFvIjjAAIAATog");
	this.shape_15.setTransform(-243.3,-268.525);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AmUM7IAAlJQHQoKAAkPIAAgNQAAhYgtgkQgsgkhAAAQg7AAiVAsIh1k0QCshdDtgBQDIABBwCPQByCPACDSIAAAJQAABygkBxQgjBxhIBuQhKBvgyBEQg0BDhaBoIFuAAIAAFbg");
	this.shape_16.setTransform(-357.675,-269.95);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("Ai5MsIAAnMIk3yLIGCAAIBwIfIBvofIGAAAIk2SLIAAHMg");
	this.shape_17.setTransform(-481.225,-268.525);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("Ak5LKQh2hsAAjVIAAy+IF8AAIAATJQAABEAzAAQAzAAAAhEIAAzJIF9AAIAAS+QAADHhuBzQhuBzjSAAQjEAAh3hsg");
	this.shape_18.setTransform(-583.95,-267.55);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AmyMsIAA5XIGZAAQDMAAB3BiQB3BiAADLIAAAoQAAB+goBMQgoBOhcAoQC+BDAAEMIAABjQAADQhzBvQhzBvjFAAgAg9HMIAXAAQAsAAARgVQASgVAAgvIAAifQAAgxgRgWQgQgWguAAIgXAAgAg9i0IAcAAQAtAAASgVQARgVAAguIAAhiQAAgwgQgXQgRgVgvAAIgcAAg");
	this.shape_19.setTransform(-683.675,-268.525);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-883.4,-392.5,1387.6,499.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(315).to({_off:false},0).to({y:24.4,alpha:1},16).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(232).to({_off:false},0).wait(1).to({regX:-190.1,regY:-165.8,x:129.85,y:27,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:26.95,alpha:0.0435},0).wait(1).to({y:26.85,alpha:0.0919},0).wait(1).to({y:26.65,alpha:0.1816},0).wait(1).to({y:26.35,alpha:0.3248},0).wait(1).to({y:26,alpha:0.4878},0).wait(1).to({y:25.7,alpha:0.6345},0).wait(1).to({y:25.45,alpha:0.7499},0).wait(1).to({y:25.25,alpha:0.8388},0).wait(1).to({y:25.1,alpha:0.9088},0).wait(1).to({y:25,alpha:0.9564},0).wait(1).to({y:24.95,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(53).to({regX:-190.1,regY:-165.8,x:129.85,y:24.95,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25,alpha:0.9565},0).wait(1).to({y:25.1,alpha:0.9081},0).wait(1).to({y:25.3,alpha:0.8184},0).wait(1).to({y:25.6,alpha:0.6752},0).wait(1).to({y:25.95,alpha:0.5122},0).wait(1).to({y:26.25,alpha:0.3655},0).wait(1).to({y:26.5,alpha:0.2501},0).wait(1).to({y:26.7,alpha:0.1612},0).wait(1).to({y:26.85,alpha:0.0912},0).wait(1).to({y:26.95,alpha:0.0436},0).wait(1).to({y:27,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(165).to({_off:false},0).wait(1).to({regX:70.1,regY:0.2,x:163.05,y:32.35,alpha:0.0037},0).wait(1).to({y:32.25,alpha:0.0167},0).wait(1).to({y:32.05,alpha:0.0435},0).wait(1).to({y:31.75,alpha:0.0919},0).wait(1).to({y:31.1,alpha:0.1816},0).wait(1).to({x:163.1,y:30.1,alpha:0.3248},0).wait(1).to({x:163.15,y:28.95,alpha:0.4878},0).wait(1).to({x:163.2,y:27.95,alpha:0.6345},0).wait(1).to({y:27.15,alpha:0.7499},0).wait(1).to({x:163.25,y:26.5,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.7,alpha:0.9564},0).wait(1).to({y:25.5,alpha:0.9834},0).wait(1).to({y:25.4,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:93.2,y:25.2,alpha:1},0).wait(53).to({regX:70.1,regY:0.2,x:163.2,y:25.4,alpha:0.9963},0).wait(1).to({x:162.95,alpha:0.9833},0).wait(1).to({x:162.4,alpha:0.9565},0).wait(1).to({x:161.45,alpha:0.9081},0).wait(1).to({x:159.65,alpha:0.8184},0).wait(1).to({x:156.8,alpha:0.6752},0).wait(1).to({x:153.5,alpha:0.5122},0).wait(1).to({x:150.6,alpha:0.3655},0).wait(1).to({x:148.3,alpha:0.2501},0).wait(1).to({x:146.5,alpha:0.1612},0).wait(1).to({x:145.1,alpha:0.0912},0).wait(1).to({x:144.15,alpha:0.0436},0).wait(1).to({x:143.6,alpha:0.0166},0).wait(1).to({x:143.35,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:73.2,y:25.2,alpha:0},0).to({_off:true},1).wait(162));
