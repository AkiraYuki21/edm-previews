...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AhWEAIAAisIipAAIAAinICpAAIAAisICtAAIAACsICpAAIAACnIipAAIAACsg");
	this.shape.setTransform(189.35,13.5);

	this.instance = new lib._2ndprize();
	this.instance.setTransform(261,-124);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(155.3,-124,383.7,247), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("Am5PlIAA/JINuAAIAAGpImlAAIAAFUIFWAAIAAGqIlWAAIAAF5IGqAAIAAGpg");
	this.shape.setTransform(1347.325,-174.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("Am5PlIAA/JINuAAIAAGpImlAAIAAFUIFWAAIAAGqIlWAAIAAF5IGqAAIAAGpg");
	this.shape_1.setTransform(1249.175,-174.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("ABSPlIier3IghAAIAAL3InJAAIAA/JIHqAAQE8AAB8CNQB8COAAEOIAACPQAAEkiUCAIDjNtgAhtiCIAXAAQA7gBAYgbQAYgbAAhCIAAjAQAAhCgYgbQgYgbg7AAIgXAAg");
	this.shape_2.setTransform(1133.575,-174.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("AnEPlIAA/JIOJAAIAAGpInAAAIAAFUIFxAAIAAGqIlxAAIAAMig");
	this.shape_3.setTransform(1021.825,-174.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("Ah+P0IAA3UIjPAvIAAmrIKaiXIAAfng");
	this.shape_4.setTransform(890.35,-176.125);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFE400").s().p("AjjPlIAA4HIkZAAIAAnCIP5AAIAAHCIkYAAIAAYHg");
	this.shape_5.setTransform(767.975,-174.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("Am5PlIAA/JINuAAIAAGpImlAAIAAFUIFWAAIAAGqIlWAAIAAF5IGqAAIAAGpg");
	this.shape_6.setTransform(669.225,-174.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("AoRHaIAAuzQAAkACmiWQCkiWEEAAQD0AADhB+IikGKQh0g+iHAAQiyAAACDHIAANrQAABdBGAAQAgAAAUgMIAArPIGwAAIAAP7QiJBPhmAhQhmAiiIAAQohAAAAosg");
	this.shape_7.setTransform(561.75,-174.925);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AmCGiIEMtDIH6AAImBNDg");
	this.shape_8.setTransform(422.4,-75.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AnvOkIB3mbQDCBMBUAAQChAAAAh9IAAgNQAAg5gog9Qgog9hihjIhXhUQiNiKg8h4Qg+h3AAi7IAAgFQAAkFCGiSQCDiTDsAAQDAAADkBbIh2GBQiRgthEAAQidAAAACAIAAAHQAAASAHARQAFAQAJAQQAIAOARAWIAgAkIApAsIAtAxQA9BCAhAeQCQCQBAB0QA+B1AADKIAAACQAAEOiOCaQiOCajqAAQjsAAjthfg");
	this.shape_9.setTransform(338.95,-175.225);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AjjPlIAA4HIkZAAIAAnCIP5AAIAAHCIkYAAIAAYHg");
	this.shape_10.setTransform(234.825,-174.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("Am5PlIAA/JINuAAIAAGpImlAAIAAFUIFWAAIAAGqIlWAAIAAF5IGqAAIAAGpg");
	this.shape_11.setTransform(136.125,-174.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("ABBPlIi0uSIAAOSInKAAIAA/JIHKAAIAAOOICyuOIHgAAIj2OtIEVQcg");
	this.shape_12.setTransform(22.15,-174.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("ABFQFQkbAAiRiZQiSiYABkqIAAtTQgBkpCSiZQCRiZEbAAIACAAQDYAAC1BSIikFwQhHgVhXAAIgCAAQi0AAAADaIAAL7QgBBnA4A5QA4A6BeAAIACAAQBRAABbgmICiFwQjHBjjrAAg");
	this.shape_13.setTransform(-93.2,-175.05);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AjkPlIAA/JIHJAAIAAfJg");
	this.shape_14.setTransform(-181.425,-174.7);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AjjPlIAA4HIkZAAIAAnCIP5AAIAAHCIkYAAIAAYHg");
	this.shape_15.setTransform(-263.775,-174.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AnwP3IAAmUQI5qAAAlNIAAgRQAAhsg3gsQg2gthOAAQhIAAi4A2IiPl6QDThyEjAAQD1AACKCxQCMCvACECIAAALQAACLgrCMQgrCKhZCIQhaCJg/BSQg/BShvCBIHCAAIAAGpg");
	this.shape_16.setTransform(-404.175,-176.425);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AjjPlIAAo1Il+2UIHZAAICKKaICIqaIHYAAIl9WUIAAI1g");
	this.shape_17.setTransform(-556,-174.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AmANtQiRiFAAkFIAA3TIHTAAIAAXgQAABTA/AAQA9AAAAhTIAA3gIHUAAIAAXTQAAD1iGCNQiHCMkCABQjyAAiRiFg");
	this.shape_18.setTransform(-682.225,-173.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AoVPlIAA/JIH2AAQD6AACTB4QCSB5AAD4IAAAyQAACbgxBdQgxBfhxAxQDpBTAAFKIAAB5QAAEAiNCHQiOCJjxAAgAhLI1IAbAAQA4AAAUgbQAWgZAAg5IAAjEQAAg8gVgaQgTgcg6AAIgbAAgAhLjdIAiAAQA4AAAVgaQAVgbAAg4IAAh4QAAg7gTgbQgVgbg6AAIgiAAg");
	this.shape_19.setTransform(-804.625,-174.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-936.9,-327.1,2402.3,361.40000000000003), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(333).to({_off:false},0).wait(1).to({regX:-952.1,regY:-34.8,x:4.45,y:44.6,alpha:0.0032},0).wait(1).to({x:5.35,alpha:0.0145},0).wait(1).to({x:7.05,alpha:0.0371},0).wait(1).to({x:10.1,alpha:0.077},0).wait(1).to({x:15.45,y:44.65,alpha:0.1467},0).wait(1).to({x:24.7,y:44.7,alpha:0.2672},0).wait(1).to({x:36.1,y:44.75,alpha:0.4164},0).wait(1).to({x:47.5,y:44.8,alpha:0.5648},0).wait(1).to({x:57,y:44.85,alpha:0.6887},0).wait(1).to({x:64.45,y:44.9,alpha:0.7859},0).wait(1).to({x:70.3,alpha:0.8625},0).wait(1).to({x:74.9,y:44.95,alpha:0.9229},0).wait(1).to({x:78,alpha:0.9628},0).wait(1).to({x:79.75,alpha:0.9857},0).wait(1).to({x:80.6,alpha:0.9969},0).wait(1).to({regX:0,regY:0,x:159.95,y:47.9,alpha:1},0).wait(78));

	// logo
	this.instance_2 = new lib.bt_logo();
	this.instance_2.setTransform(159.95,28.8,0.0852,0.0852,0,0,0,0,0.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(333).to({alpha:0},16).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(257).to({_off:false},0).wait(1).to({regX:266.8,regY:-156,x:187.45,y:53,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:52.95,alpha:0.0435},0).wait(1).to({y:52.85,alpha:0.0919},0).wait(1).to({y:52.65,alpha:0.1816},0).wait(1).to({y:52.35,alpha:0.3248},0).wait(1).to({y:52,alpha:0.4878},0).wait(1).to({y:51.7,alpha:0.6345},0).wait(1).to({y:51.45,alpha:0.7499},0).wait(1).to({y:51.25,alpha:0.8388},0).wait(1).to({y:51.1,alpha:0.9088},0).wait(1).to({y:51,alpha:0.9564},0).wait(1).to({y:50.95,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:67.25,alpha:1},0).wait(62).to({regX:266.8,regY:-156,x:187.45,y:50.95,alpha:0.9968},0).wait(1).to({alpha:0.9855},0).wait(1).to({y:51,alpha:0.9629},0).wait(1).to({y:51.1,alpha:0.923},0).wait(1).to({y:51.25,alpha:0.8533},0).wait(1).to({y:51.5,alpha:0.7328},0).wait(1).to({y:51.8,alpha:0.5836},0).wait(1).to({y:52.1,alpha:0.4352},0).wait(1).to({y:52.35,alpha:0.3113},0).wait(1).to({y:52.6,alpha:0.2141},0).wait(1).to({y:52.75,alpha:0.1375},0).wait(1).to({y:52.85,alpha:0.0771},0).wait(1).to({y:52.95,alpha:0.0372},0).wait(1).to({y:53,alpha:0.0143},0).wait(1).to({alpha:0.0031},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:69.35,alpha:0},0).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:351.4,regY:-0.5,x:222.8,y:50.65,alpha:0.0037},0).wait(1).to({y:50.55,alpha:0.0167},0).wait(1).to({y:50.35,alpha:0.0435},0).wait(1).to({y:50.05,alpha:0.0919},0).wait(1).to({y:49.4,alpha:0.1816},0).wait(1).to({y:48.4,alpha:0.3248},0).wait(1).to({y:47.25,alpha:0.4878},0).wait(1).to({y:46.25,alpha:0.6345},0).wait(1).to({y:45.45,alpha:0.7499},0).wait(1).to({y:44.8,alpha:0.8388},0).wait(1).to({y:44.3,alpha:0.9088},0).wait(1).to({y:44,alpha:0.9564},0).wait(1).to({y:43.8,alpha:0.9834},0).wait(1).to({y:43.7,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0,x:113.05,y:43.85,alpha:1},0).wait(62).to({regX:351.4,regY:-0.5,x:222.8,y:43.75,alpha:0.9963},0).wait(1).to({y:44,alpha:0.9833},0).wait(1).to({y:44.55,alpha:0.9565},0).wait(1).to({y:45.5,alpha:0.9081},0).wait(1).to({y:47.3,alpha:0.8184},0).wait(1).to({y:50.15,alpha:0.6752},0).wait(1).to({y:53.45,alpha:0.5122},0).wait(1).to({y:56.35,alpha:0.3655},0).wait(1).to({y:58.65,alpha:0.2501},0).wait(1).to({y:60.45,alpha:0.1612},0).wait(1).to({y:61.85,alpha:0.0912},0).wait(1).to({y:62.8,alpha:0.0436},0).wait(1).to({y:63.35,alpha:0.0166},0).wait(1).to({y:63.6,alpha:0.0036},0).wait(1).to({regX:0.1,regY:0,x:113.05,y:63.85,alpha:0},0).to({_off:true},1).wait(154));
