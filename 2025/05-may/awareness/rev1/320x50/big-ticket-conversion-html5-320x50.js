...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(192.7,-4.5);

	this.instance = new lib._2ndprize();
	this.instance.setTransform(252,-124);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(158.6,-124,371.4,247), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("Ak3LAIAA1/IJrAAIAAEsIkpAAIAADwIDxAAIAAEtIjxAAIAAEKIEtAAIAAEsg");
	this.shape.setTransform(45.85,-51.55);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("Ak3LAIAA1/IJrAAIAAEsIkpAAIAADwIDxAAIAAEtIjxAAIAAEKIEtAAIAAEsg");
	this.shape_1.setTransform(-23.35,-51.55);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("AA6LAIhvoZIgYAAIAAIZIlDAAIAA1/IFbAAQDeAABYBkQBYBkgBC/IAABkQAADOhnBaICfJsgAhNhcIAQAAQArAAAQgTQARgTAAgvIAAiHQAAgugRgUQgQgTgrAAIgQAAg");
	this.shape_2.setTransform(-105,-51.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("Ak/LAIAA1/IJ/AAIAAEsIk9AAIAADwIEFAAIAAEtIkFAAIAAI2g");
	this.shape_3.setTransform(-183.875,-51.55);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("AhZLKIAAwcIiRAhIAAkuIHVhqIAAWTg");
	this.shape_4.setTransform(-276.7,-52.55);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFE400").s().p("AigLAIAAxBIjGAAIAAk+ILNAAIAAE+IjFAAIAARBg");
	this.shape_5.setTransform(-363.025,-51.55);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("Ak3LAIAA1/IJrAAIAAEsIkpAAIAADwIDyAAIAAEtIjyAAIAAEKIEtAAIAAEsg");
	this.shape_6.setTransform(-432.7,-51.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("Al1FOIAAqbQAAi1B1hqQB0hqC3AAQCsAACfBZIh0EWQhRgshgAAQh9AAACCNIAAJpQAABCAxAAQAWAAAOgJIAAn7IExAAIAALPQhhA3hIAYQhIAYhfAAQmBAAAAmJg");
	this.shape_7.setTransform(-508.625,-51.725);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AkQEnIC9pNIFkAAIkPJNg");
	this.shape_8.setTransform(201.625,-191.875);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AldKSIBUkiQCJA1A6AAQByAAAAhYIAAgJQAAgogcgrQgbgshGhFIg9g7QhjhigshUQgrhUAAiFIAAgDQAAi4BehnQBehoCmAAQCHAAChBBIhTEPQhmgfgxAAQhuAAAABZIAAAGQAAAMAEAMQAFAMAFALQAHAKALAPIAWAaIAeAfIAfAiQArAvAYAVQBlBlAtBTQAsBSAACOIAAACQAAC/hkBsQhkBtilAAQinAAinhDg");
	this.shape_9.setTransform(142.7,-261.975);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AigLAIAAxBIjGAAIAAk+ILNAAIAAE+IjFAAIAARBg");
	this.shape_10.setTransform(69.175,-261.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("Ak3LAIAA1/IJsAAIAAEsIkqAAIAADwIDyAAIAAEtIjyAAIAAEKIEtAAIAAEsg");
	this.shape_11.setTransform(-0.45,-261.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAuLAIh/qGIAAKGIlDAAIAA1/IFDAAIAAKCIB9qCIFTAAIiuKYIDELng");
	this.shape_12.setTransform(-80.825,-261.6);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAxLWQjHAAhnhrQhnhsAAjTIAApXQAAjTBnhsQBnhrDHAAIABAAQCZAACAA6Ih1EEQgygQg8AAIgCAAQh/AAAACbIAAIZQAABJAnApQAoApBBgBIADAAQA4ABBAgbIBzEDQiNBGimAAg");
	this.shape_13.setTransform(-162.3,-261.85);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AigLAIAA1/IFBAAIAAV/g");
	this.shape_14.setTransform(-224.55,-261.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AigLAIAAxBIjGAAIAAk+ILNAAIAAE+IjFAAIAARBg");
	this.shape_15.setTransform(-282.675,-261.6);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AleLMIAAkdQGRnDAAjrIAAgMQAAhMgngfQglggg4AAQgyAAiCAmIhlkLQCVhQDNAAQCtAABiB8QBiB8ACC2IAAAIQAABigfBjQgeBhg/BgQhABggsA7QgtA6hOBaIE+AAIAAEsg");
	this.shape_16.setTransform(-381.725,-262.825);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AigLAIAAmPIkNvwIFNAAIBiHXIBgnXIFNAAIkNPwIAAGPg");
	this.shape_17.setTransform(-488.95,-261.6);
	...
	this.shape_18.setTransform(-577.975,-260.75);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("Al4LAIAA1/IFjAAQCwAABnBVQBoBWAACvIAAAjQAABtgjBCQgjBDhPAjQCkA6AADoIAABWQAAC0hjBgQhkBhirAAgAg1GPIAUAAQAnAAAOgTQAPgSAAgoIAAiLQAAgqgOgTQgOgTgoAAIgUAAgAg1icIAZAAQAnAAAPgSQAOgSAAgoIAAhVQAAgpgNgUQgOgTgpAAIgZAAg");
	this.shape_19.setTransform(-664.375,-261.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-890.5,-369.4,1308.7,465.59999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(333).to({alpha:0},16).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(349).to({_off:false},0).to({y:24.4,alpha:1},16).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(257).to({_off:false},0).wait(1).to({regX:-236.5,regY:-156.8,x:135,y:27.9,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.85,alpha:0.0435},0).wait(1).to({y:27.75,alpha:0.0919},0).wait(1).to({y:27.55,alpha:0.1816},0).wait(1).to({y:27.25,alpha:0.3248},0).wait(1).to({y:26.9,alpha:0.4878},0).wait(1).to({y:26.6,alpha:0.6345},0).wait(1).to({y:26.35,alpha:0.7499},0).wait(1).to({y:26.15,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.9,alpha:0.9564},0).wait(1).to({y:25.85,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(62).to({regX:-236.5,regY:-156.8,x:135,y:25.85,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25.9,alpha:0.9565},0).wait(1).to({y:26,alpha:0.9081},0).wait(1).to({y:26.2,alpha:0.8184},0).wait(1).to({y:26.5,alpha:0.6752},0).wait(1).to({y:26.85,alpha:0.5122},0).wait(1).to({y:27.15,alpha:0.3655},0).wait(1).to({y:27.4,alpha:0.2501},0).wait(1).to({y:27.6,alpha:0.1612},0).wait(1).to({y:27.75,alpha:0.0912},0).wait(1).to({y:27.85,alpha:0.0436},0).wait(1).to({y:27.9,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:348.6,regY:-0.5,x:169.15,y:29.6,alpha:0.0037},0).wait(1).to({y:29.55,alpha:0.0167},0).wait(1).to({y:29.45,alpha:0.0435},0).wait(1).to({y:29.25,alpha:0.0919},0).wait(1).to({y:28.9,alpha:0.1816},0).wait(1).to({y:28.35,alpha:0.3248},0).wait(1).to({y:27.65,alpha:0.4878},0).wait(1).to({y:27.1,alpha:0.6345},0).wait(1).to({y:26.65,alpha:0.7499},0).wait(1).to({y:26.25,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.8,alpha:0.9564},0).wait(1).to({y:25.7,alpha:0.9834},0).wait(1).to({y:25.65,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:102.1,y:25.75,alpha:1},0).wait(62).to({regX:348.6,regY:-0.5,x:169.15,y:25.65,alpha:0.9963},0).wait(1).to({y:25.8,alpha:0.9833},0).wait(1).to({y:26.05,alpha:0.9565},0).wait(1).to({y:26.55,alpha:0.9081},0).wait(1).to({y:27.45,alpha:0.8184},0).wait(1).to({y:28.85,alpha:0.6752},0).wait(1).to({y:30.5,alpha:0.5122},0).wait(1).to({y:31.95,alpha:0.3655},0).wait(1).to({y:33.1,alpha:0.2501},0).wait(1).to({y:34,alpha:0.1612},0).wait(1).to({y:34.7,alpha:0.0912},0).wait(1).to({y:35.2,alpha:0.0436},0).wait(1).to({y:35.45,alpha:0.0166},0).wait(1).to({y:35.6,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:102.1,y:35.75,alpha:0},0).to({_off:true},76).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:-666.6,regY:20.2,x:131.15,y:25.05,alpha:0.0037},0).wait(1).to({x:130.8,alpha:0.0167},0).wait(1).to({x:130,alpha:0.0435},0).wait(1).to({x:128.6,alpha:0.0919},0).wait(1).to({x:125.95,alpha:0.1816},0).wait(1).to({x:121.8,alpha:0.3248},0).wait(1).to({x:117.05,alpha:0.4878},0).wait(1).to({x:112.75,alpha:0.6345},0).wait(1).to({x:109.4,alpha:0.7499},0).wait(1).to({x:106.8,alpha:0.8388},0).wait(1).to({x:104.75,alpha:0.9088},0).wait(1).to({x:103.35,alpha:0.9564},0).wait(1).to({x:102.55,alpha:0.9834},0).wait(1).to({x:102.2,alpha:0.9964},0).wait(1).to({regX:0,regY:0.6,x:159.95,y:23.35,alpha:1},0).wait(242).to({alpha:0},15).to({_off:true},1).wait(154));
