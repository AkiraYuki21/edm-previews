...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-146,-96,1.0486,1.0486);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(-146,-96,291.5,259), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("AhkDkIAAnHIDIAAIAABhIhgAAIAABOIBNAAIAABgIhNAAIAABXIBhAAIAABhg");
	this.shape.setTransform(96.9,-198.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("AhkDkIAAnHIDIAAIAABhIhhAAIAABOIBPAAIAABgIhPAAIAABXIBiAAIAABhg");
	this.shape_1.setTransform(74.45,-198.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("AATDkIgkiuIgHAAIAACuIhpAAIAAnHIBwAAQBIAAAcAgQAcAhAAA9IAAAhQAABDghAcIA0DJgAgYgdIAFAAQANAAAGgHQAFgGAAgPIAAgsQAAgOgFgHQgGgGgNAAIgFAAg");
	this.shape_2.setTransform(48.025,-198.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("AhnDkIAAnHIDOAAIAABhIhmAAIAABOIBUAAIAABgIhUAAIAAC4g");
	this.shape_3.setTransform(22.45,-198.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("AgcDnIAAlUIgvALIAAhhICXgjIAAHNg");
	this.shape_4.setTransform(-7.55,-199.25);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFE400").s().p("AgzDkIAAlgIhBAAIAAhnIDpAAIAABnIhAAAIAAFgg");
	this.shape_5.setTransform(-35.6,-198.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("AhkDkIAAnHIDIAAIAABhIhgAAIAABOIBNAAIAABgIhNAAIAABXIBhAAIAABhg");
	this.shape_6.setTransform(-58.15,-198.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("Ah4BsIAAjXQAAg7AlgiQAmgjA7ABQA3gBA0AdIgmBaQgagOgfAAQgoAAABAtIAADIQAAAVAPAAQAHAAAFgCIAAilIBjAAIAADpQggASgXAHQgXAJgggBQh7ABAAiAg");
	this.shape_7.setTransform(-82.725,-198.95);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhYBgIA+i/IBzAAIhYC/g");
	this.shape_8.setTransform(147.375,-244.525);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhxDVIAbheQAtARATAAQAkAAAAgcIAAgDQAAgNgJgOQgIgOgXgXIgTgTQgggfgOgbQgOgbgBgrIAAgBQABg8AeghQAegiA1AAQAsAAA1AVIgbBYQgigKgQAAQgiAAgBAdIAAABQABAFABADIADAIIAFAIIAHAIIAKAKIAKALQAOAQAIAGQAgAhAPAaQAPAbAAAuIAAABQAAA9ghAkQghAjg1AAQg2AAg2gWg");
	this.shape_9.setTransform(128.3,-267.225);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgzDkIAAlgIhBAAIAAhnIDoAAIAABnIg/AAIAAFgg");
	this.shape_10.setTransform(104.45,-267.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhkDkIAAnHIDIAAIAABhIhhAAIAABOIBPAAIAABhIhPAAIAABWIBiAAIAABhg");
	this.shape_11.setTransform(81.85,-267.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAPDkIgpjRIAADRIhoAAIAAnHIBoAAIAADQIAojQIBuAAIg4DXIA/Dwg");
	this.shape_12.setTransform(55.775,-267.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAPDrQg/AAghgjQgigjABhEIAAjCQgBhEAigjQAhgiA/AAIABAAQAyAAApASIgmBVQgQgFgUAAIAAAAQgoAAAAAyIAACtQgBAYAMANQANANAVAAIABAAQATAAAUgJIAmBVQguAWg2AAg");
	this.shape_13.setTransform(29.45,-267.175);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgzDkIAAnHIBnAAIAAHHg");
	this.shape_14.setTransform(9.275,-267.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgzDkIAAlgIhAAAIAAhnIDoAAIAABnIhAAAIAAFgg");
	this.shape_15.setTransform(-9.6,-267.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AhxDoIAAhcQCBiSABhMIAAgEQAAgZgNgKQgMgKgRAAQgRAAgqAMIgghWQAvgaBDAAQA3AAAgAoQAgApABA6IAAADQgBAfgJAgQgKAggVAeQgVAggOATQgOASgaAeIBnAAIAABhg");
	this.shape_16.setTransform(-41.65,-267.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgzDkIAAiBIhYlGIBsAAIAgCYIAeiYIBsAAIhXFGIAACBg");
	this.shape_17.setTransform(-76.4,-267.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AhXDJQghgfAAg8IAAlUIBrAAIAAFXQAAATANAAQAOAAAAgTIAAlXIBrAAIAAFUQAAA4geAhQgfAgg7AAQg3AAghgeg");
	this.shape_18.setTransform(-105.225,-266.825);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("Ah5DkIAAnHIByAAQA5AAAhAbQAiAcAAA5IAAALQAAAjgLAWQgMAVgZAMQA1ASAABMIAAAbQAAA6ggAgQggAfg4AAgAgRCBIAHAAQALAAAGgGQAEgGAAgNIAAgtQAAgNgEgHQgFgFgMgBIgHAAgAgRgyIAJAAQAMAAAEgGQAFgGAAgNIAAgbQAAgOgEgGQgFgGgMAAIgJAAg");
	this.shape_19.setTransform(-133.25,-267.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-148.8,-302.8,308.70000000000005,152.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_15.setTransform(176.975,586.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgSArIAAhVIAlAAIAAASIgTAAIAAAPIAQAAIAAARIgQAAIAAARIATAAIAAASg");
	this.shape_16.setTransform(172.3,586.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAHArIgCgRIgJAAIgCARIgTAAIALhVIAcAAIAMBVgAAAgOIgCAWIAFAAIgCgWIgBgIg");
	this.shape_17.setTransform(167.25,586.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAAArIgFg2IAAA2IgUAAIAAhVIAaAAIAFA1IAAg1IAUAAIAABVg");
	this.shape_18.setTransform(160.125,586.8);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgJArIAAhVIATAAIAABVg");
	this.shape_19.setTransform(155.95,586.8);
	...
	this.shape_24.setTransform(134.025,586.8);
	...
	this.shape_25.setTransform(128.6,586.8);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AgIA3IAAhtIARAAIAABtg");
	this.shape_26.setTransform(120.225,587.975);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AgJArIAAgYIgRg9IAVAAIAFAdIAGgdIAVAAIgRA9IAAAYg");
	this.shape_27.setTransform(111.675,586.8);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("AgUArIAAhVIAUAAIAABCIAUAAIAAATg");
	this.shape_28.setTransform(106.4,586.8);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("AgWArIAAhVIAWAAQAMAAAGAFQAFAHAAALIAAAIQAAAMgGAFQgHAFgKABIgCAAIAAAfgAgCgEIABAAQABAAAAAAQAAAAAAAAQABAAAAAAQAAgBABAAIAAgEIAAgKIAAgDIgDgBIgBAAg");
	this.shape_29.setTransform(101.45,586.8);
	...
	this.shape_32.setTransform(84.325,586.775);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AgFATIgEglIASAAIgDAlg");
	this.shape_33.setTransform(80.7,584.325);
	...
	this.shape_34.setTransform(77.175,586.775);
	...
	this.shape_35.setTransform(71.275,586.775);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFFFF").s().p("AgJArIAAhCIgMAAIAAgTIArAAIAAATIgMAAIAABCg");
	this.shape_36.setTransform(65.625,586.8);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFFFFF").s().p("AgIA3IAAhtIARAAIAABtg");
	this.shape_37.setTransform(57.525,587.975);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#FFFFFF").s().p("AgVAnIAHgRQAFAEAGAAQAFAAAAgHIAAgIQgBgKgIAAQgFAAgFADIAFgvIAgAAIAAASIgNAAIgBALQAHABAEAGQAFAGAAAKIAAALQAAALgHAHQgFAGgKAAQgLAAgKgFgAABgNIgBAAg");
	this.shape_38.setTransform(49.05,586.875);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(349).to({_off:false},0).wait(1).to({regX:0.4,regY:-206,x:150.2,y:395.95,alpha:0.0032},0).wait(1).to({y:395.6,alpha:0.0145},0).wait(1).to({y:394.85,alpha:0.0371},0).wait(1).to({y:393.5,alpha:0.077},0).wait(1).to({y:391.2,alpha:0.1467},0).wait(1).to({y:387.2,alpha:0.2672},0).wait(1).to({y:382.25,alpha:0.4164},0).wait(1).to({y:377.3,alpha:0.5648},0).wait(1).to({y:373.2,alpha:0.6887},0).wait(1).to({y:370,alpha:0.7859},0).wait(1).to({y:367.45,alpha:0.8625},0).wait(1).to({y:365.45,alpha:0.9229},0).wait(1).to({y:364.1,alpha:0.9628},0).wait(1).to({y:363.35,alpha:0.9857},0).wait(1).to({y:363,alpha:0.9969},0).wait(1).to({regX:0,regY:0.1,x:150,y:473.95,alpha:1},0).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(333).to({_off:false},0).wait(1).to({regY:-155,x:-153.6,y:240.3},0).wait(1).to({x:-150.15},0).wait(1).to({x:-143.25},0).wait(1).to({x:-131.1},0).wait(1).to({x:-109.9},0).wait(1).to({x:-73.2},0).wait(1).to({x:-27.7},0).wait(1).to({x:17.45},0).wait(1).to({x:55.2},0).wait(1).to({x:84.8},0).wait(1).to({x:108.1},0).wait(1).to({x:126.55},0).wait(1).to({x:138.7},0).wait(1).to({x:145.65},0).wait(1).to({x:149.05},0).wait(1).to({regY:0,x:150,y:356.25},0).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(256).to({_off:false},0).wait(1).to({regX:5.4,regY:-233.1,x:152.4,y:330.35,alpha:0.0037},0).wait(1).to({y:330.1,alpha:0.0167},0).wait(1).to({y:329.6,alpha:0.0435},0).wait(1).to({y:328.7,alpha:0.0919},0).wait(1).to({y:327,alpha:0.1816},0).wait(1).to({y:324.35,alpha:0.3248},0).wait(1).to({y:321.3,alpha:0.4878},0).wait(1).to({y:318.55,alpha:0.6345},0).wait(1).to({y:316.35,alpha:0.7499},0).wait(1).to({y:314.7,alpha:0.8388},0).wait(1).to({y:313.4,alpha:0.9088},0).wait(1).to({y:312.5,alpha:0.9564},0).wait(1).to({y:312,alpha:0.9834},0).wait(1).to({y:311.75,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:147.35,y:530.25,alpha:1},0).wait(63).to({regX:5.4,regY:-233.1,x:152.4,y:311.75,alpha:0.9968},0).wait(1).to({y:311.95,alpha:0.9855},0).wait(1).to({y:312.35,alpha:0.9629},0).wait(1).to({y:313.1,alpha:0.923},0).wait(1).to({y:314.45,alpha:0.8533},0).wait(1).to({y:316.7,alpha:0.7328},0).wait(1).to({y:319.5,alpha:0.5836},0).wait(1).to({y:322.25,alpha:0.4352},0).wait(1).to({y:324.6,alpha:0.3113},0).wait(1).to({y:326.4,alpha:0.2141},0).wait(1).to({y:327.85,alpha:0.1375},0).wait(1).to({y:329,alpha:0.0771},0).wait(1).to({y:329.75,alpha:0.0372},0).wait(1).to({y:330.15,alpha:0.0143},0).wait(1).to({y:330.35,alpha:0.0031},0).wait(1).to({regX:0,regY:0,x:147.35,y:549,alpha:0},0).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:-0.2,regY:33.5,x:149.55,y:333.9,alpha:0.0037},0).wait(1).to({y:333.55,alpha:0.0167},0).wait(1).to({y:332.85,alpha:0.0435},0).wait(1).to({y:331.6,alpha:0.0919},0).wait(1).to({x:149.6,y:329.25,alpha:0.1816},0).wait(1).to({y:325.55,alpha:0.3248},0).wait(1).to({x:149.65,y:321.3,alpha:0.4878},0).wait(1).to({x:149.7,y:317.5,alpha:0.6345},0).wait(1).to({x:149.75,y:314.5,alpha:0.7499},0).wait(1).to({x:149.8,y:312.15,alpha:0.8388},0).wait(1).to({y:310.35,alpha:0.9088},0).wait(1).to({y:309.1,alpha:0.9564},0).wait(1).to({y:308.4,alpha:0.9834},0).wait(1).to({y:308.05,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:150.05,y:274.5,alpha:1},0).wait(61).to({regX:-0.2,regY:33.5,x:149.85,y:307.85,alpha:0.9963},0).wait(1).to({y:307.45,alpha:0.9833},0).wait(1).to({y:306.65,alpha:0.9565},0).wait(1).to({y:305.2,alpha:0.9081},0).wait(1).to({y:302.55,alpha:0.8184},0).wait(1).to({y:298.25,alpha:0.6752},0).wait(1).to({y:293.35,alpha:0.5122},0).wait(1).to({y:288.95,alpha:0.3655},0).wait(1).to({y:285.5,alpha:0.2501},0).wait(1).to({y:282.8,alpha:0.1612},0).wait(1).to({y:280.7,alpha:0.0912},0).wait(1).to({y:279.3,alpha:0.0436},0).wait(1).to({y:278.45,alpha:0.0166},0).wait(1).to({y:278.1,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:150.05,y:244.5,alpha:0},0).to({_off:true},1).wait(156));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:-0.3,regY:-119.5,x:411.2,y:266.7,alpha:0.0037},0).wait(1).to({x:407.8,alpha:0.0167},0).wait(1).to({x:400.75,alpha:0.0435},0).wait(1).to({x:388.05,alpha:0.0919},0).wait(1).to({x:364.5,alpha:0.1816},0).wait(1).to({x:326.95,alpha:0.3248},0).wait(1).to({x:284.15,alpha:0.4878},0).wait(1).to({x:245.65,alpha:0.6345},0).wait(1).to({x:215.35,alpha:0.7499},0).wait(1).to({x:192.05,alpha:0.8388},0).wait(1).to({x:173.65,alpha:0.9088},0).wait(1).to({x:161.15,alpha:0.9564},0).wait(1).to({x:154.05,alpha:0.9834},0).wait(1).to({x:150.65,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:150,y:360,alpha:1},0).wait(166).to({alpha:0},15).to({_off:true},1).wait(231));

	// background
	this.instance_9 = new lib.background_mc();
	this.instance_9.setTransform(150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(428));
