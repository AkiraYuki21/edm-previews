...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape.setTransform(99.825,-252.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_1.setTransform(75.325,-252.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAVD5Igoi+IgHAAIAAC+IhyAAIAAnxIB5AAQBPAAAfAjQAfAkAABDIAAAkQAABIglAgIA4DbgAgaggIAFAAQAPAAAGgHQAFgGAAgRIAAgwQAAgRgFgGQgGgHgPAAIgFAAg");
	this.shape_2.setTransform(46.45,-252.85);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhwD5IAAnxIDhAAIAABqIhwAAIAABVIBcAAIAABpIhcAAIAADJg");
	this.shape_3.setTransform(18.55,-252.85);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgfD9IAAl0IgzAMIAAhrIClgmIAAH5g");
	this.shape_4.setTransform(-14.3,-253.225);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ag4D5IAAmAIhGAAIAAhxID9AAIAABxIhGAAIAAGAg");
	this.shape_5.setTransform(-44.825,-252.85);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_6.setTransform(-69.475,-252.85);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AiDB2IAAjrQAAhAApgmQApglBAAAQA9AAA4AfIgpBjQgdgQghAAQgsAAAAAyIAADaQAAAXARAAQAIAAAFgDIAAizIBsAAIAAD+QgiATgaAJQgZAIgiAAQiHAAAAiLg");
	this.shape_7.setTransform(-96.325,-252.925);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhgBoIBDjPIB+AAIhgDPg");
	this.shape_8.setTransform(86.275,-300.6);
	...
	this.shape_9.setTransform(65.425,-325.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Ag4D5IAAmBIhGAAIAAhwID9AAIAABwIhGAAIAAGBg");
	this.shape_10.setTransform(39.475,-325.25);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhtD5IAAnxIDaAAIAABqIhpAAIAABVIBVAAIAABpIhVAAIAABfIBqAAIAABqg");
	this.shape_11.setTransform(14.775,-325.25);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAQD5IgsjkIAADkIhyAAIAAnxIByAAIAADjIAsjjIB4AAIg+DrIBGEGg");
	this.shape_12.setTransform(-13.65,-325.25);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAREBQhGAAgkgmQgkgnAAhKIAAjTQAAhKAkgnQAkgmBGAAIAAAAQA2AAAuAUIgpBcQgSgEgWAAIAAAAQgtgBAAA3IAAC9QAAAaAOAPQAOAOAXAAIABAAQAUAAAXgKIAoBcQgyAZg7AAg");
	this.shape_13.setTransform(-42.425,-325.35);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("Ag4D5IAAnxIBxAAIAAHxg");
	this.shape_14.setTransform(-64.45,-325.25);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("Ag4D5IAAmBIhGAAIAAhwID9AAIAABwIhGAAIAAGBg");
	this.shape_15.setTransform(-85.025,-325.25);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("Ah7D+IAAhlQCNifAAhTIAAgFQAAgagOgLQgMgMgUAAQgSAAguANIgjheQA0gdBJAAQA8ABAjAsQAjArAABBIAAADQAAAjgLAiQgKAigXAiQgWAigQAVQgQAVgbAfIBwAAIAABrg");
	this.shape_16.setTransform(50.575,-398.15);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("Ag4D5IAAiNIhflkIB2AAIAiCmIAiimIB1AAIhfFkIAACNg");
	this.shape_17.setTransform(12.625,-397.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AhfDbQglgiAAhBIAAlzIB1AAIAAF3QAAAUAPAAQAQAAAAgUIAAl3IB1AAIAAFzQgBA+ghAjQgiAjhBAAQg7AAgkghg");
	this.shape_18.setTransform(-18.85,-397.4);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AiED5IAAnxIB9AAQA+AAAkAeQAlAeAAA/IAAAMQAAAmgNAYQgMAYgcAMQA6ATAABTIAAAeQAABAgjAiQgjAig9AAgAgSCNIAHAAQANAAAFgGQAFgHAAgOIAAgxQAAgPgFgHQgFgGgNAAIgHAAgAgSg3IAIAAQAOABAFgHQAFgHAAgOIAAgeQAAgOgFgHQgFgHgOAAIgIAAg");
	this.shape_19.setTransform(-49.425,-397.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-113.4,-436.8,226.9,237.10000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(173).to({_off:false},0).wait(1).to({regX:0.6,regY:-325.4,x:78.9,y:410.05,alpha:0.0032},0).wait(1).to({y:409.95,alpha:0.0145},0).wait(1).to({y:409.7,alpha:0.0371},0).wait(1).to({y:409.3,alpha:0.077},0).wait(1).to({y:408.6,alpha:0.1467},0).wait(1).to({y:407.4,alpha:0.2672},0).wait(1).to({y:405.9,alpha:0.4164},0).wait(1).to({y:404.45,alpha:0.5648},0).wait(1).to({y:403.2,alpha:0.6887},0).wait(1).to({y:402.2,alpha:0.7859},0).wait(1).to({y:401.45,alpha:0.8625},0).wait(1).to({y:400.85,alpha:0.9229},0).wait(1).to({y:400.45,alpha:0.9628},0).wait(1).to({y:400.2,alpha:0.9857},0).wait(1).to({y:400.1,alpha:0.9969},0).wait(1).to({regX:0,regY:0.1,x:78.6,y:562.85,alpha:1},0).wait(74).to({regX:0.6,regY:-325.4,x:79.4,y:400.1},0).wait(1).to({x:81.25},0).wait(1).to({x:84.9},0).wait(1).to({x:91.4},0).wait(1).to({x:102.8},0).wait(1).to({x:122.4},0).wait(1).to({x:146.75},0).wait(1).to({x:170.9},0).wait(1).to({x:191.1},0).wait(1).to({x:206.95},0).wait(1).to({x:219.4},0).wait(1).to({x:229.25},0).wait(1).to({x:235.75},0).wait(1).to({x:239.5},0).wait(1).to({x:241.3},0).wait(1).to({regX:0,regY:0.1,x:241.55,y:562.85},0).to({_off:true},17).wait(75));
