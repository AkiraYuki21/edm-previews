...
}).prototype = getMCSymbolPrototype(lib.ticket_mc, new cjs.Rectangle(-1847,-481,1211.3,652.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ABGNXIiHqMIgcAAIAAKMImIAAIAA6tIGkAAQEOAABrB5QBqB6AADnIAAB7QAAD7h+BtIDCLwgAhdhwIATAAQAzAAAUgYQAVgWAAg4IAAimQAAg4gVgYQgUgWgzAAIgTAAg");
	this.shape.setTransform(1255.675,-79.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Al6NXIAA6tILxAAIAAFsIlqAAIAAEkIEmAAIAAFtIkmAAIAAFDIFuAAIAAFtg");
	this.shape_1.setTransform(1160.775,-79.65);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AnFGWIAAsrQgBjcCPiAQCMiBDfAAQDQAADDBsIiOFSQhjg2h0ABQiZgBADCsIAALtQAABQA7AAQAcAAARgKIAAppIFyAAIAANqQh1BDhXAdQhYAch0AAQnUAAABncg");
	this.shape_2.setTransform(1068.65,-79.85);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AnGGWIAAsrQAAjcCPiAQCMiBDfAAQDQAADCBsIiNFSQhig2h1ABQiYgBACCsIAALtQAABQA7AAQAcAAARgKIAAppIFzAAIAANqQh2BDhXAdQhYAch1AAQnTAAAAncg");
	this.shape_3.setTransform(968.95,-79.85);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AjDNXIAA6tIGHAAIAAatg");
	this.shape_4.setTransform(891.25,-79.65);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AnJNXIAA6tIGuAAQDXAAB9BnQB+BoAADVIAAArQAACEgrBRQgqBRhgAqQDIBHgBEaIAABoQAADch4BzQh5B2jQAAgAhAHkIAXAAQAwAAARgWQATgWgBgxIAAioQAAg0gRgWQgRgYgxAAIgXAAgAhAi+IAdAAQAvAAAUgVQARgXAAgxIAAhmQAAgzgQgYQgSgWgyAAIgdAAg");
	this.shape_5.setTransform(814.3,-79.65);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgFNXIhsw7IAAQ7ImIAAIAA6tIIEAAIBoQhIAAwhIGHAAIAAatg");
	this.shape_6.setTransform(677.875,-79.65);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AjDNXIAA6tIGHAAIAAatg");
	this.shape_7.setTransform(595.05,-79.65);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("ABKNXIhKwEIhJQEIn5AAIh/6tIGfAAIATUgIBy0gIE8AAIBxUgIAT0gIGfAAIh+atg");
	this.shape_8.setTransform(494.275,-79.65);
	...
	this.shape_9.setTransform(337.175,-79.65);
	...
	this.shape_10.setTransform(230.5,-80.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AnFGWIAAsrQAAjcCNiAQCOiBDeAAQDQAADDBsIiOFSQhig2h1ABQiZgBADCsIAALtQAABQA8AAQAbAAARgKIAAppIFyAAIAANqQh1BDhYAdQhXAch0AAQnTAAAAncg");
	this.shape_11.setTransform(995.45,-364.25);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AjDNXIAA6tIGHAAIAAatg");
	this.shape_12.setTransform(917.8,-364.05);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AnINXIAA6tIGuAAQDVAAB/BnQB9BoAADVIAAArQAACEgqBRQgrBRhhAqQDJBHAAEaIAABoQAADch5BzQh5B2jPAAgAhBHkIAYAAQAwAAARgWQASgWAAgxIAAioQAAg0gRgWQgRgYgxAAIgYAAgAhBi+IAfAAQAuAAATgVQASgXAAgxIAAhmQAAgzgRgYQgRgWgxAAIgfAAg");
	this.shape_13.setTransform(840.8,-364.05);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgFNXIhsw7IAAQ7ImIAAIAA6tIIEAAIBoQhIAAwhIGHAAIAAatg");
	this.shape_14.setTransform(704.375,-364.05);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AjDNXIAA6tIGHAAIAAatg");
	this.shape_15.setTransform(621.6,-364.05);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("ABKNXIhKwEIhJQEIn5AAIh/6tIGfAAIATUgIBy0gIE8AAIBxUgIAT0gIGfAAIh+atg");
	this.shape_16.setTransform(520.825,-364.05);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:-581.9,regY:-46.8,x:187.8,y:44.25,alpha:0.0037},0).wait(1).to({x:186.75,alpha:0.0167},0).wait(1).to({x:184.65,alpha:0.0435},0).wait(1).to({x:180.85,alpha:0.0919},0).wait(1).to({x:173.8,alpha:0.1816},0).wait(1).to({x:162.55,alpha:0.3248},0).wait(1).to({x:149.7,alpha:0.4878},0).wait(1).to({x:138.15,alpha:0.6345},0).wait(1).to({x:129.1,alpha:0.7499},0).wait(1).to({x:122.1,alpha:0.8388},0).wait(1).to({x:116.6,alpha:0.9088},0).wait(1).to({x:112.85,alpha:0.9564},0).wait(1).to({x:110.75,alpha:0.9834},0).wait(1).to({x:109.7,alpha:0.9964},0).wait(1).to({regX:0,regY:0.6,x:159.95,y:48.35,alpha:1},0).wait(166).to({alpha:0},15).wait(62).to({regX:-581.9,regY:-46.8,x:109.65,y:44.25,alpha:0.0037},0).wait(1).to({x:110.3,alpha:0.0167},0).wait(1).to({x:111.65,alpha:0.0435},0).wait(1).to({x:114.05,alpha:0.0919},0).wait(1).to({x:118.55,alpha:0.1816},0).wait(1).to({x:125.7,alpha:0.3248},0).wait(1).to({x:133.85,alpha:0.4878},0).wait(1).to({x:141.2,alpha:0.6345},0).wait(1).to({x:146.95,alpha:0.7499},0).wait(1).to({x:151.4,alpha:0.8388},0).wait(1).to({x:154.9,alpha:0.9088},0).wait(1).to({x:157.3,alpha:0.9564},0).wait(1).to({x:158.65,alpha:0.9834},0).wait(1).to({x:159.3,alpha:0.9964},0).wait(1).to({regX:0,regY:0.6,x:209.95,y:48.35,alpha:1},0).wait(79));
