...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:87.5,regY:-7.3,x:273.4,y:53.3,alpha:0.0037},0).wait(1).to({y:53.2,alpha:0.0167},0).wait(1).to({y:52.95,alpha:0.0435},0).wait(1).to({y:52.55,alpha:0.0919},0).wait(1).to({y:51.8,alpha:0.1816},0).wait(1).to({y:50.6,alpha:0.3248},0).wait(1).to({y:49.25,alpha:0.4878},0).wait(1).to({y:48,alpha:0.6345},0).wait(1).to({y:47.05,alpha:0.7499},0).wait(1).to({y:46.3,alpha:0.8388},0).wait(1).to({y:45.7,alpha:0.9088},0).wait(1).to({y:45.3,alpha:0.9564},0).wait(1).to({y:45.05,alpha:0.9834},0).wait(1).to({y:44.95,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:240.05,y:47.75,alpha:1},0).wait(61).to({regX:87.5,regY:-7.3,x:274.95,y:44.9},0).wait(1).to({x:280.5},0).wait(1).to({x:291.9},0).wait(1).to({x:312.5},0).wait(1).to({x:350.7},0).wait(1).to({x:411.7},0).wait(1).to({x:481.15},0).wait(1).to({x:543.6},0).wait(1).to({x:592.8},0).wait(1).to({x:630.65},0).wait(1).to({x:660.45},0).wait(1).to({x:680.75},0).wait(1).to({x:692.25},0).wait(1).to({x:697.8},0).wait(1).to({regX:0,regY:0,x:666,y:47.7},0).wait(80));
