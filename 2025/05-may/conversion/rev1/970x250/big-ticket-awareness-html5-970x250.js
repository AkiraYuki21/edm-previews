...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-519,-198,1.4975,1.4975);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.promo_mc, new cjs.Rectangle(-519,-198,416.3,429.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAfF0Ig7kcIgMAAIAAEcIirAAIAArnIC3AAQB1AAAvA1QAuA0AABlIAAA2QAABtg3AvIBVFHgAgogwIAIAAQAWAAAJgKQAJgKAAgZIAAhIQAAgYgJgLQgJgKgWAAIgIAAg");
	this.shape.setTransform(803.625,-167.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AikF0IAArnIFHAAIAACeIidAAIAAB/ICAAAIAACfIiAAAIAACNICfAAIAACeg");
	this.shape_1.setTransform(762.35,-167.675);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AjFCxIAAlhQAAhfA+g4QA9g4BhAAQBbAABUAvIg9CTQgsgYgyAAQhCAAABBLIAAFGQAAAjAZAAQAMAAAIgFIAAkMIChAAIAAF8QgzAdgmANQgmAMgzAAQjLAAAAjPg");
	this.shape_2.setTransform(722.175,-167.775);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AjFCxIAAlhQAAhfA+g4QA9g4BhAAQBbAABUAvIg9CTQgsgYgyAAQhCAAABBLIAAFGQAAAjAZAAQAMAAAIgFIAAkMIChAAIAAF8QgzAdgmANQgmAMgzAAQjLAAAAjPg");
	this.shape_3.setTransform(678.725,-167.775);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhUF0IAArnICpAAIAALng");
	this.shape_4.setTransform(644.875,-167.675);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AjGF0IAArnIC7AAQBdAAA2AsQA3AuAABdIAAASQAAA6gSAjQgTAjgqATQBXAeAAB7IAAAtQAABfg0AzQg1AzhaAAgAgcDTIALAAQAUAAAHgKQAIgJAAgWIAAhJQAAgWgHgKQgHgLgVAAIgLAAgAgchSIANAAQAUAAAJgKQAHgJAAgWIAAgsQAAgWgHgLQgIgKgVAAIgNAAg");
	this.shape_5.setTransform(611.425,-167.675);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgCF0IgvnXIAAHXIiqAAIAArnIDgAAIAtHLIAAnLICqAAIAALng");
	this.shape_6.setTransform(552.025,-167.675);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhUF0IAArnICpAAIAALng");
	this.shape_7.setTransform(515.925,-167.675);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAgF0Iggm/IgfG/IjdAAIg3rnIC1AAIAII7IAyo7ICJAAIAxI7IAJo7IC1AAIg3Lng");
	this.shape_8.setTransform(472.05,-167.675);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAfF0Ig7kcIgMAAIAAEcIirAAIAArnIC3AAQB1AAAvA1QAuA0AABlIAAA2QAABtg3AvIBVFHgAgogwIAIAAQAWAAAJgKQAJgKAAgZIAAhIQAAgYgJgLQgJgKgWAAIgIAAg");
	this.shape_9.setTransform(403.575,-167.675);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AABF/QhhAAgzg1Qgyg1AAhjIAAliQAAhmA0g0QAzg0BeAAIACAAQBhAAAyA1QAxA1AABkIAAFiQAABngzAzQgzAzheAAgAgWi+IAAF9QAAAgAWAAIABAAQAXAAAAggIAAl9QAAgfgYAAIAAAAQgWAAAAAfg");
	this.shape_10.setTransform(357.125,-167.875);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AjFCxIAAlhQAAhfA+g4QA9g4BhAAQBbAABUAvIg9CTQgsgYgyAAQhCAAABBLIAAFGQAAAjAZAAQAMAAAIgFIAAkMIChAAIAAF8QgzAdgmANQgmAMgzAAQjLAAAAjPg");
	this.shape_11.setTransform(301.725,-167.775);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhUF0IAArnICpAAIAALng");
	this.shape_12.setTransform(267.875,-167.675);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AjGF0IAArnIC7AAQBdAAA2AsQA3AuAABdIAAASQAAA6gSAjQgTAjgqATQBXAeAAB7IAAAtQAABfg0AzQg1AzhaAAgAgcDTIALAAQAUAAAHgKQAIgJAAgWIAAhJQAAgWgHgKQgHgLgVAAIgLAAgAgchSIANAAQAUAAAJgKQAHgJAAgWIAAgsQAAgWgHgLQgIgKgVAAIgNAAg");
	this.shape_13.setTransform(234.425,-167.675);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgCF0IgvnXIAAHXIiqAAIAArnIDgAAIAtHLIAAnLICqAAIAALng");
	this.shape_14.setTransform(175.025,-167.675);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AhUF0IAArnICpAAIAALng");
	this.shape_15.setTransform(138.925,-167.675);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAgF0Iggm/IggG/IjbAAIg4rnIC1AAIAII7IAyo7ICJAAIAxI7IAJo7IC1AAIg3Lng");
	this.shape_16.setTransform(95.05,-167.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_sub_caption_mc, new cjs.Rectangle(61,-224.7,768.1,135.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgYAvIAAhdIAXAAQALAAAHAHQAIAIAAANIAAAlQAAAMgIAJQgHAHgLAAgAgCAbIABAAQAAAAABgBQAAAAAAAAQABAAAAAAQAAgBABAAQABgBAAgEIAAgoQAAgBAAgBQAAAAgBgBQAAAAAAgBQAAAAgBAAIgCgBIgBAAg");
	this.shape_15.setTransform(192.825,236.35);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgUAvIAAhdIApAAIAAAUIgUAAIAAAQIAQAAIAAATIgQAAIAAASIAUAAIAAAUg");
	this.shape_16.setTransform(187.775,236.35);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAHAvIgCgSIgJAAIgCASIgVAAIAMhdIAeAAIANBdgAAAgPIgDAYIAGAAIgCgYIgBgIg");
	this.shape_17.setTransform(182.35,236.35);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAAAvIgFg7IAAA7IgWAAIAAhdIAcAAIAFA5IAAg5IAWAAIAABdg");
	this.shape_18.setTransform(174.675,236.35);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgKAvIAAhdIAVAAIAABdg");
	this.shape_19.setTransform(170.075,236.35);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AgWAsIAFgTQAKADAEAAQAGAAAAgGIAAAAQAAgDgCgDIgFgHIgFgEQgGgGgDgGQgDgFAAgJQAAgNAHgGQAFgHALAAQAIAAAMAEIgGASIgKgCQgHAAAAAGIAAAAIAAACIABABIABACIABACIACACIACACIAFAFQAHAGADAFQACAGAAAJQABANgIAHQgGAHgKAAQgLAAgLgEg");
	this.shape_20.setTransform(164.7,236.325);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgUAvIAAhdIApAAIAAAUIgUAAIAAAQIAQAAIAAATIgQAAIAAASIAUAAIAAAUg");
	this.shape_21.setTransform(160.075,236.35);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgXAvIAAgTIAZg1IgWAAIAAgVIAsAAIAAATIgZA2IAZAAIAAAUg");
	this.shape_22.setTransform(154.975,236.35);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgKAvIAAhdIAVAAIAABdg");
	this.shape_23.setTransform(150.875,236.35);
	...
	this.shape_24.setTransform(146.425,236.35);
	...
	this.shape_29.setTransform(111.225,236.35);
	...
	this.shape_32.setTransform(92.75,236.325);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AgFAUIgEgnIATAAIgDAng");
	this.shape_33.setTransform(88.775,233.675);
	...
	this.shape_34.setTransform(85.025,236.35);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFFFFF").s().p("");
	this.shape_35.setTransform(78.65,236.325);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFFFF").s().p("AgKAvIAAhHIgNAAIAAgWIAvAAIAAAWIgNAAIAABHg");
	this.shape_36.setTransform(72.55,236.35);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFFFFF").s().p("AgJA8IAAh3IASAAIAAB3g");
	this.shape_37.setTransform(63.8,237.625);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#FFFFFF").s().p("AgXAqIAIgSQAGAEAGAAQAFAAAAgIIAAgIQAAgKgKAAQgEAAgGADIAFg0IAjAAIAAAUIgOAAIgBAMQAIABAEAGQAFAHAAALIAAALQAAANgHAHQgGAHgLAAQgMAAgLgGgAABgOIAAAAIAAAAIgBAAg");
	this.shape_38.setTransform(56.075,236.425);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:1.8,regY:9.5,x:727.9,y:124.85,alpha:0.0037},0).wait(1).to({x:727.35,alpha:0.0167},0).wait(1).to({x:726.25,alpha:0.0435},0).wait(1).to({x:724.2,alpha:0.0919},0).wait(1).to({x:720.45,alpha:0.1816},0).wait(1).to({x:714.45,alpha:0.3248},0).wait(1).to({x:707.6,alpha:0.4878},0).wait(1).to({x:701.45,alpha:0.6345},0).wait(1).to({x:696.6,alpha:0.7499},0).wait(1).to({x:692.85,alpha:0.8388},0).wait(1).to({x:689.9,alpha:0.9088},0).wait(1).to({x:687.9,alpha:0.9564},0).wait(1).to({x:686.75,alpha:0.9834},0).wait(1).to({x:686.25,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0,x:685,y:118.7,alpha:1},0).wait(69).to({regX:1.8,regY:9.5,x:686.1,y:124.85,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({alpha:0.9565},0).wait(1).to({alpha:0.9081},0).wait(1).to({alpha:0.8184},0).wait(1).to({alpha:0.6752},0).wait(1).to({alpha:0.5122},0).wait(1).to({alpha:0.3655},0).wait(1).to({alpha:0.2501},0).wait(1).to({alpha:0.1612},0).wait(1).to({alpha:0.0912},0).wait(1).to({alpha:0.0436},0).wait(1).to({alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.1,regY:0,x:685,y:118.7,alpha:0},0).to({_off:true},1).wait(253));

	// bonus_prizes
	this.instance_5 = new lib.big_win_prizes_mc();
	this.instance_5.setTransform(727,118.7,0.6495,0.6495,0,0,0,0.1,0);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.instance_6 = new lib.bonus_prizes_mc();
	this.instance_6.setTransform(685,98.7,0.6495,0.6495,0,0,0,0.1,0);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5}]},98).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},68).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).wait(170));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).wait(1).to({regX:5.3,regY:5.7,x:730.2,y:122.4,alpha:0.0037},0).wait(1).to({x:729.65,alpha:0.0167},0).wait(1).to({x:728.55,alpha:0.0435},0).wait(1).to({x:726.5,alpha:0.0919},0).wait(1).to({x:722.75,alpha:0.1816},0).wait(1).to({x:716.75,alpha:0.3248},0).wait(1).to({x:709.9,alpha:0.4878},0).wait(1).to({x:703.75,alpha:0.6345},0).wait(1).to({x:698.9,alpha:0.7499},0).wait(1).to({x:695.15,alpha:0.8388},0).wait(1).to({x:692.2,alpha:0.9088},0).wait(1).to({x:690.2,alpha:0.9564},0).wait(1).to({x:689.05,alpha:0.9834},0).wait(1).to({x:688.55,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0,x:685,y:118.7,alpha:1},0).wait(69).to({regX:5.3,regY:5.7,x:688.4,y:122.3,alpha:0.9963},0).wait(1).to({y:122.05,alpha:0.9833},0).wait(1).to({y:121.5,alpha:0.9565},0).wait(1).to({y:120.55,alpha:0.9081},0).wait(1).to({y:118.75,alpha:0.8184},0).wait(1).to({y:115.9,alpha:0.6752},0).wait(1).to({y:112.6,alpha:0.5122},0).wait(1).to({y:109.7,alpha:0.3655},0).wait(1).to({y:107.4,alpha:0.2501},0).wait(1).to({y:105.6,alpha:0.1612},0).wait(1).to({y:104.2,alpha:0.0912},0).wait(1).to({y:103.25,alpha:0.0436},0).wait(1).to({y:102.7,alpha:0.0166},0).wait(1).to({y:102.45,alpha:0.0036},0).to({_off:true},1).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({regX:444.5,regY:-167.8,x:714.8,y:134.2,alpha:0.0037},0).wait(1).to({y:134.05,alpha:0.0167},0).wait(1).to({y:133.75,alpha:0.0435},0).wait(1).to({y:133.25,alpha:0.0919},0).wait(1).to({x:714.75,y:132.3,alpha:0.1816},0).wait(1).to({x:714.7,y:130.75,alpha:0.3248},0).wait(1).to({x:714.65,y:129.05,alpha:0.4878},0).wait(1).to({x:714.6,y:127.45,alpha:0.6345},0).wait(1).to({x:714.55,y:126.25,alpha:0.7499},0).wait(1).to({y:125.3,alpha:0.8388},0).wait(1).to({x:714.5,y:124.55,alpha:0.9088},0).wait(1).to({y:124.05,alpha:0.9564},0).wait(1).to({y:123.75,alpha:0.9834},0).wait(1).to({y:123.6,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0.1,x:483.05,y:211.05,alpha:1},0).wait(60).to({x:483.4,y:211.25},0).wait(1).to({regX:444.5,regY:-167.8,x:714.85,y:123.8,alpha:0.9968},0).wait(1).to({y:123.95,alpha:0.9855},0).wait(1).to({y:124.15,alpha:0.9629},0).wait(1).to({y:124.6,alpha:0.923},0).wait(1).to({y:125.3,alpha:0.8533},0).wait(1).to({y:126.55,alpha:0.7328},0).wait(1).to({y:128.15,alpha:0.5836},0).wait(1).to({y:129.7,alpha:0.4352},0).wait(1).to({y:130.95,alpha:0.3113},0).wait(1).to({y:132,alpha:0.2141},0).wait(1).to({y:132.8,alpha:0.1375},0).wait(1).to({y:133.4,alpha:0.0771},0).wait(1).to({y:133.85,alpha:0.0372},0).wait(1).to({y:134.1,alpha:0.0143},0).wait(1).to({y:134.2,alpha:0.0031},0).wait(1).to({regX:0.1,regY:0.1,x:483.4,y:221.7,alpha:0},0).to({_off:true},1).wait(94));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(181).to({_off:false},0).wait(1).to({y:148.0262,alpha:0.0037},0).wait(1).to({y:147.7652,alpha:0.0167},0).wait(1).to({y:147.2308,alpha:0.0435},0).wait(1).to({y:146.2628,alpha:0.0919},0).wait(1).to({y:144.4687,alpha:0.1816},0).wait(1).to({y:141.6041,alpha:0.3248},0).wait(1).to({y:138.3445,alpha:0.4878},0).wait(1).to({y:135.4109,alpha:0.6345},0).wait(1).to({y:133.1018,alpha:0.7499},0).wait(1).to({y:131.3241,alpha:0.8388},0).wait(1).to({y:129.9247,alpha:0.9088},0).wait(1).to({y:128.9721,alpha:0.9564},0).wait(1).to({y:128.4313,alpha:0.9834},0).wait(1).to({y:128.172,alpha:0.9964},0).wait(1).to({y:128.1,alpha:1},0).wait(61).to({scaleX:0.9993,scaleY:0.9993,x:330.8605,y:128.095},0).wait(1).to({scaleX:0.997,scaleY:0.997,x:333.8705,y:128.0774},0).wait(1).to({scaleX:0.9922,scaleY:0.9922,x:339.9279,y:128.0421},0).wait(1).to({scaleX:0.9838,scaleY:0.9838,x:350.5964,y:127.9798},0).wait(1).to({scaleX:0.9691,scaleY:0.9691,x:369.2384,y:127.8711},0).wait(1).to({scaleX:0.9438,scaleY:0.9438,x:401.4502,y:127.6831},0).wait(1).to({scaleX:0.9123,scaleY:0.9123,x:441.3734,y:127.4502},0).wait(1).to({scaleX:0.8811,scaleY:0.8811,x:481.0624,y:127.2186},0).wait(1).to({scaleX:0.855,scaleY:0.855,x:514.1981,y:127.0252},0).wait(1).to({scaleX:0.8345,scaleY:0.8345,x:540.1999,y:126.8735},0).wait(1).to({scaleX:0.8184,scaleY:0.8184,x:560.6722,y:126.7541},0).wait(1).to({scaleX:0.8057,scaleY:0.8057,x:576.8357,y:126.6598},0).wait(1).to({scaleX:0.7973,scaleY:0.7973,x:587.5086,y:126.5975},0).wait(1).to({scaleX:0.7925,scaleY:0.7925,x:593.6274,y:126.5618},0).wait(1).to({scaleX:0.7901,scaleY:0.7901,x:596.6102,y:126.5444},0).wait(1).to({scaleX:0.7895,scaleY:0.7895,x:597.45,y:126.5},0).wait(95));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:-310.8,regY:16.9,x:495.25,y:124,alpha:0.0037},0).wait(1).to({x:493.35,alpha:0.0167},0).wait(1).to({x:489.45,alpha:0.0435},0).wait(1).to({x:482.4,alpha:0.0919},0).wait(1).to({x:469.3,alpha:0.1816},0).wait(1).to({x:448.4,alpha:0.3248},0).wait(1).to({x:424.65,alpha:0.4878},0).wait(1).to({x:403.25,alpha:0.6345},0).wait(1).to({x:386.45,alpha:0.7499},0).wait(1).to({x:373.5,alpha:0.8388},0).wait(1).to({x:363.3,alpha:0.9088},0).wait(1).to({x:356.35,alpha:0.9564},0).wait(1).to({x:352.4,alpha:0.9834},0).wait(1).to({x:350.5,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0,x:484.85,y:116.65,alpha:1},0).wait(166).to({alpha:0},15).wait(60).to({alpha:1},16).wait(95));
...
p.nominalBounds = new cjs.Rectangle(118.5,125,851.4,146.60000000000002);
// library properties:
lib.properties = {
