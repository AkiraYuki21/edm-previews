...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAOCqIgaiCIgGAAIAACCIhNAAIAAlSIBTAAQA1AAAVAYQAVAYAAAtIAAAZQAAAxgZAVIAmCWgAgSgWIAEAAQAKABAEgFQAEgEAAgMIAAghQAAgKgEgFQgEgEgKgBIgEAAg");
	this.shape.setTransform(101.275,-9.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhKCqIAAlSICUAAIAABIIhIAAIAAA5IA7AAIAABIIg7AAIAABBIBJAAIAABIg");
	this.shape_1.setTransform(82.5,-9.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhZBQIAAigQAAgrAcgZQAcgaArAAQApAAAnAVIgcBEQgTgLgXAAQgeAAABAiIAACUQAAAPAKAAQAGAAADgCIAAh5IBKAAIAACtQgYANgRAFQgRAGgXAAQhcAAAAhfg");
	this.shape_2.setTransform(64.2,-9.75);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhZBQIAAigQAAgrAcgZQAcgaAsAAQApAAAmAVIgcBEQgUgLgWAAQgeAAAAAiIAACUQABAPALAAQAFAAAEgCIAAh5IBJAAIAACtQgYANgRAFQgRAGgXAAQhcAAAAhfg");
	this.shape_3.setTransform(44.45,-9.75);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgmCqIAAlSIBNAAIAAFSg");
	this.shape_4.setTransform(29.025,-9.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhaCqIAAlSIBVAAQAqgBAZAVQAZAVAAAqIAAAIQAAAbgIAQQgJAPgTAJQAoANAAA4IAAAVQAAArgYAXQgYAYgpAAgAgMBgIAFAAQAIAAAEgEQADgEAAgLIAAghQAAgKgDgFQgDgEgJAAIgFAAgAgMglIAGAAQAIAAAEgEQAEgFAAgJIAAgVQAAgKgEgEQgDgEgJgBIgGAAg");
	this.shape_5.setTransform(13.775,-9.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAACqIgWjWIAADWIhNAAIAAlSIBlAAIAVDQIAAjQIBNAAIAAFSg");
	this.shape_6.setTransform(-13.275,-9.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgmCqIAAlSIBNAAIAAFSg");
	this.shape_7.setTransform(-29.725,-9.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAOCqIgOjLIgODLIhkAAIgZlSIBSAAIAEEDIAWkDIA+AAIAXEDIADkDIBTAAIgZFSg");
	this.shape_8.setTransform(-49.65,-9.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAOCqIgaiCIgGAAIAACCIhNAAIAAlSIBTAAQA1AAAVAYQAVAYAAAtIAAAZQAAAxgZAVIAmCWgAgSgWIAEAAQAKABAEgFQAEgEAAgMIAAghQAAgKgEgFQgEgEgKgBIgEAAg");
	this.shape_9.setTransform(-80.825,-9.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AABCvQgtgBgWgYQgXgYAAgtIAAigQAAgvAXgXQAYgZAqAAIABAAQAsABAWAYQAXAZAAAtIAACgQAAAvgXAXQgXAXgrABgAgJhWIAACtQgBAOAKABIABAAQAKgBAAgOIAAitQAAgOgLAAIAAAAQgJAAAAAOg");
	this.shape_10.setTransform(-101.95,-9.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhZBQIAAigQAAgrAcgZQAcgaAsAAQAoAAAnAVIgcBEQgTgLgXAAQgeAAABAiIAACUQAAAPALAAQAFAAAEgCIAAh5IBJAAIAACtQgYANgRAFQgRAGgXAAQhcAAAAhfg");
	this.shape_11.setTransform(49.7,-57);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgmCqIAAlSIBNAAIAAFSg");
	this.shape_12.setTransform(34.325,-56.95);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhaCqIAAlSIBVAAQAqgBAZAVQAZAVAAAqIAAAIQAAAbgIAQQgJAPgTAJQAoANAAA4IAAAVQAAArgYAXQgYAYgpAAgAgMBgIAFAAQAIAAAEgEQADgEAAgLIAAghQAAgKgDgFQgDgEgJAAIgFAAgAgMglIAGAAQAIAAAEgEQAEgFAAgJIAAgVQAAgKgEgEQgDgEgJgBIgGAAg");
	this.shape_13.setTransform(19.075,-56.95);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AAACqIgWjWIAADWIhNAAIAAlSIBlAAIAVDQIAAjQIBNAAIAAFSg");
	this.shape_14.setTransform(-8.025,-56.95);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgmCqIAAlSIBNAAIAAFSg");
	this.shape_15.setTransform(-24.425,-56.95);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAOCqIgOjLIgODLIhkAAIgZlSIBSAAIAEEDIAWkDIA+AAIAXEDIADkDIBTAAIgaFSg");
	this.shape_16.setTransform(-44.35,-56.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-113.8,-83.8,227.7,110.69999999999999), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(272).to({_off:false},0).wait(1).to({regX:0.4,regY:4,x:150.2,y:509.05,alpha:0.0032},0).wait(1).to({y:508.7,alpha:0.0145},0).wait(1).to({y:507.95,alpha:0.0371},0).wait(1).to({y:506.6,alpha:0.077},0).wait(1).to({y:504.3,alpha:0.1467},0).wait(1).to({y:500.3,alpha:0.2672},0).wait(1).to({y:495.35,alpha:0.4164},0).wait(1).to({y:490.4,alpha:0.5648},0).wait(1).to({y:486.3,alpha:0.6887},0).wait(1).to({y:483.1,alpha:0.7859},0).wait(1).to({y:480.55,alpha:0.8625},0).wait(1).to({y:478.55,alpha:0.9229},0).wait(1).to({y:477.2,alpha:0.9628},0).wait(1).to({y:476.45,alpha:0.9857},0).wait(1).to({y:476.1,alpha:0.9969},0).wait(1).to({regX:0,regY:0.1,x:150,y:473.95,alpha:1},0).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(181).to({_off:false},0).wait(1).to({regY:-33.4,y:517.6,alpha:0.0037},0).wait(1).to({y:517.35,alpha:0.0167},0).wait(1).to({y:516.85,alpha:0.0435},0).wait(1).to({y:515.95,alpha:0.0919},0).wait(1).to({y:514.25,alpha:0.1816},0).wait(1).to({y:511.6,alpha:0.3248},0).wait(1).to({y:508.55,alpha:0.4878},0).wait(1).to({y:505.8,alpha:0.6345},0).wait(1).to({y:503.6,alpha:0.7499},0).wait(1).to({y:501.95,alpha:0.8388},0).wait(1).to({y:500.65,alpha:0.9088},0).wait(1).to({y:499.75,alpha:0.9564},0).wait(1).to({y:499.25,alpha:0.9834},0).wait(1).to({y:499,alpha:0.9964},0).wait(1).to({regY:0,y:530.25,alpha:1},0).wait(61).to({regY:-33.4,y:499,alpha:0.9963},0).wait(1).to({y:499.25,alpha:0.9833},0).wait(1).to({y:499.75,alpha:0.9565},0).wait(1).to({y:500.65,alpha:0.9081},0).wait(1).to({y:502.35,alpha:0.8184},0).wait(1).to({y:505,alpha:0.6752},0).wait(1).to({y:508.05,alpha:0.5122},0).wait(1).to({y:510.8,alpha:0.3655},0).wait(1).to({y:513,alpha:0.2501},0).wait(1).to({y:514.65,alpha:0.1612},0).wait(1).to({y:515.95,alpha:0.0912},0).wait(1).to({y:516.85,alpha:0.0436},0).wait(1).to({y:517.35,alpha:0.0166},0).wait(1).to({y:517.6,alpha:0.0036},0).wait(1).to({regY:0,y:549,alpha:0},0).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(181).to({_off:false},0).wait(1).to({x:149.7511,y:300.4041,alpha:0.0037},0).wait(1).to({x:149.755,y:300.0648,alpha:0.0167},0).wait(1).to({x:149.763,y:299.37,alpha:0.0435},0).wait(1).to({x:149.7776,y:298.1117,alpha:0.0919},0).wait(1).to({x:149.8045,y:295.7794,alpha:0.1816},0).wait(1).to({x:149.8474,y:292.0553,alpha:0.3248},0).wait(1).to({x:149.8963,y:287.8179,alpha:0.4878},0).wait(1).to({x:149.9403,y:284.0042,alpha:0.6345},0).wait(1).to({x:149.975,y:281.0023,alpha:0.7499},0).wait(1).to({x:150.0016,y:278.6914,alpha:0.8388},0).wait(1).to({x:150.0226,y:276.8721,alpha:0.9088},0).wait(1).to({x:150.0369,y:275.6337,alpha:0.9564},0).wait(1).to({x:150.045,y:274.9307,alpha:0.9834},0).wait(1).to({x:150.0489,y:274.5937,alpha:0.9964},0).wait(1).to({x:150.05,y:274.5,alpha:1},0).wait(61).to({scaleX:0.9981,scaleY:0.9981,x:150.3157,y:274.6394},0).wait(1).to({scaleX:0.9912,scaleY:0.9912,x:151.256,y:275.1327},0).wait(1).to({scaleX:0.9771,scaleY:0.9771,x:153.1811,y:276.1427},0).wait(1).to({scaleX:0.9516,scaleY:0.9516,x:156.6679,y:277.972},0).wait(1).to({scaleX:0.9042,scaleY:0.9042,x:163.1306,y:281.3626},0).wait(1).to({scaleX:0.8287,scaleY:0.8287,x:173.4498,y:286.7764},0).wait(1).to({scaleX:0.7427,scaleY:0.7427,x:185.1915,y:292.9365},0).wait(1).to({scaleX:0.6654,scaleY:0.6654,x:195.759,y:298.4806},0).wait(1).to({scaleX:0.6045,scaleY:0.6045,x:204.077,y:302.8446},0).wait(1).to({scaleX:0.5576,scaleY:0.5576,x:210.4805,y:306.2041},0).wait(1).to({scaleX:0.5207,scaleY:0.5207,x:215.5215,y:308.8488},0).wait(1).to({scaleX:0.4956,scaleY:0.4956,x:218.9531,y:310.6491},0).wait(1).to({scaleX:0.4813,scaleY:0.4813,x:220.9011,y:311.6712},0).wait(1).to({scaleX:0.4745,scaleY:0.4745,x:221.835,y:312.1611},0).wait(1).to({regX:0.2,regY:0.1,scaleX:0.4726,scaleY:0.4726,x:222.1,y:312.3},0).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:-0.3,regY:-119.5,x:411.2,y:266.7,alpha:0.0037},0).wait(1).to({x:407.8,alpha:0.0167},0).wait(1).to({x:400.75,alpha:0.0435},0).wait(1).to({x:388.05,alpha:0.0919},0).wait(1).to({x:364.5,alpha:0.1816},0).wait(1).to({x:326.95,alpha:0.3248},0).wait(1).to({x:284.15,alpha:0.4878},0).wait(1).to({x:245.65,alpha:0.6345},0).wait(1).to({x:215.35,alpha:0.7499},0).wait(1).to({x:192.05,alpha:0.8388},0).wait(1).to({x:173.65,alpha:0.9088},0).wait(1).to({x:161.15,alpha:0.9564},0).wait(1).to({x:154.05,alpha:0.9834},0).wait(1).to({x:150.65,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:150,y:360,alpha:1},0).wait(166).to({alpha:0},15).wait(61).to({regX:-0.3,regY:-119.5,scaleX:0.7791,scaleY:0.7791,x:149.5,y:266.85,alpha:0.0037},0).wait(1).to({scaleX:0.7734,scaleY:0.7734,x:148.6,y:267.45,alpha:0.0167},0).wait(1).to({scaleX:0.7617,scaleY:0.7617,x:146.8,y:268.55,alpha:0.0435},0).wait(1).to({scaleX:0.7406,scaleY:0.7406,x:143.6,y:270.65,alpha:0.0919},0).wait(1).to({scaleX:0.7015,scaleY:0.7015,x:137.55,y:274.5,alpha:0.1816},0).wait(1).to({scaleX:0.639,scaleY:0.639,x:127.95,y:280.7,alpha:0.3248},0).wait(1).to({scaleX:0.5679,scaleY:0.5679,x:117.05,y:287.75,alpha:0.4878},0).wait(1).to({scaleX:0.504,scaleY:0.504,x:107.2,y:294.1,alpha:0.6345},0).wait(1).to({scaleX:0.4536,scaleY:0.4536,x:99.4,y:299.05,alpha:0.7499},0).wait(1).to({scaleX:0.4148,scaleY:0.4148,x:93.5,y:302.9,alpha:0.8388},0).wait(1).to({scaleX:0.3843,scaleY:0.3843,x:88.8,y:305.95,alpha:0.9088},0).wait(1).to({scaleX:0.3635,scaleY:0.3635,x:85.6,y:307.95,alpha:0.9564},0).wait(1).to({scaleX:0.3518,scaleY:0.3518,x:83.75,y:309.1,alpha:0.9834},0).wait(1).to({scaleX:0.3461,scaleY:0.3461,x:82.9,y:309.7,alpha:0.9964},0).wait(1).to({regX:0.3,regY:0,scaleX:0.3445,scaleY:0.3445,x:82.8,y:351.05,alpha:1},0).wait(80));
