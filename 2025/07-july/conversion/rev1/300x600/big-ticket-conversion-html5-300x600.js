...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgfAcQgMgJAAgTQAAgQAMgLQANgKASAAQATAAAMAKQANALAAAQQAAATgNAJQgMAKgTAAQgSAAgNgKg");
	this.shape.setTransform(113.85,9.5);
	...
	this.shape_1.setTransform(99.375,-4.15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhKCpIAAlRICVAAIAABIIhIAAIAAA5IA6AAIAABIIg6AAIAABAIBIAAIAABIg");
	this.shape_2.setTransform(82.6,-4.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAMCvQgvAAgZgaQgZgaAAgyIAAiQQAAgzAZgaQAZgaAvAAIAAAAQAlAAAfAOIgcA/QgMgEgPAAQgeAAAAAlIAACBQAAASAIAJQAKAKAQAAIAAAAQAOAAAPgGIAcA+QgiARgoAAg");
	this.shape_3.setTransform(65.675,-4.125);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAACpIgWjWIAADWIhNAAIAAlRIBlAAIAVDRIAAjRIBNAAIAAFRg");
	this.shape_4.setTransform(44.575,-4.05);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAZCpIgGhCIglAAIgGBCIhMAAIAtlRIBvAAIAtFRgAgBg7IgJBaIAVAAIgKhaIgBgcg");
	this.shape_5.setTransform(22.35,-4.05);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AALCpIAAiFIgVAAIAACFIhNAAIAAlRIBNAAIAACAIAVAAIAAiAIBNAAIAAFRg");
	this.shape_6.setTransform(1.275,-4.05);
	...
	this.shape_7.setTransform(-16.575,-4.125);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhKCpIAAlRICUAAIAABIIhIAAIAAA5IA7AAIAABIIg7AAIAABAIBJAAIAABIg");
	this.shape_8.setTransform(-39.75,-4.05);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAOCpIgaiAIgGAAIAACAIhNAAIAAlRIBTAAQA1AAAVAXQAVAZAAAtIAAAZQAAAxgZAWIAmCUgAgSgWIAEAAQAKAAAEgEQAEgEAAgLIAAgiQAAgLgEgEQgEgEgKAAIgEAAg");
	this.shape_9.setTransform(-59.375,-4.05);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AABCvQgtAAgWgZQgXgYAAgtIAAigQAAgvAXgXQAYgZAqAAIABAAQAsAAAWAZQAXAZAAAtIAACgQAAAvgXAXQgXAYgrAAgAgKhVIAACsQAAAPAKAAIABAAQAJAAABgPIAAisQAAgPgLAAIAAAAQgJAAgBAPg");
	this.shape_10.setTransform(-80.55,-4.15);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AA3CpIAAj9IgDAnIgXDWIg5AAIgYjWIgDgnIAAD9IhLAAIAAlRIB2AAIALCgIABAZIACgZIAMigIB1AAIAAFRg");
	this.shape_11.setTransform(-105.15,-4.05);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgfAcQgMgJAAgTQAAgRAMgKQANgLASAAQATAAAMALQANAKAAARQAAATgNAJQgMALgTAAQgSAAgNgLg");
	this.shape_12.setTransform(99.55,-43.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhTCeIAUhGQAhANAOABQAbgBAAgUIAAgDQAAgKgHgKQgGgKgRgRIgOgPQgYgWgLgUQgKgVAAgfIAAgBQAAgsAXgaQAWgZAnAAQAhAAAnAQIgUBBQgZgHgMAAQgZAAAAAWIAAABIABAGIACAFIAEAHIAFAGIAHAHIAIAIIAPAQQAZAYALAUQAKAUAAAiIAAAAQAAAvgYAZQgYAagnAAQgoAAgogQg");
	this.shape_13.setTransform(85.075,-57.05);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhKCqIAAlSICVAAIAABIIhIAAIAAA5IA6AAIAABIIg6AAIAABBIBIAAIAABIg");
	this.shape_14.setTransform(68.3,-56.95);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AhXCqIAAhFIBdjFIhTAAIAAhIIClAAIAABEIhfDEIBfAAIAABKg");
	this.shape_15.setTransform(49.9,-56.95);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgmCqIAAlSIBNAAIAAFSg");
	this.shape_16.setTransform(35.125,-56.95);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAOCqIgaiCIgGAAIAACCIhNAAIAAlSIBTAAQA1AAAVAYQAVAYAAAtIAAAZQAAAxgZAVIAmCWgAgSgWIAEAAQAKABAEgFQAEgEAAgMIAAghQAAgKgEgFQgEgEgKgBIgEAAg");
	this.shape_17.setTransform(19.075,-56.95);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AhYCqIAAlSIBSAAQA1AAAVAYQAVAYAAAtIAAAdQAAAzgZATQgZAVgtAAIgFAAIAAB9gAgLgRIADAAQAJAAAFgFQAEgEAAgMIAAglQAAgKgEgFQgFgEgJgBIgDAAg");
	this.shape_18.setTransform(-1.975,-56.95);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AhKCqIAAlSICUAAIAABIIhIAAIAAA5IA7AAIAABIIg7AAIAABBIBJAAIAABIg");
	this.shape_19.setTransform(-25.45,-56.95);
	...
	this.shape_20.setTransform(-45.125,-56.95);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AABCuQgsAAgXgYQgXgYAAgtIAAigQAAgvAXgXQAYgZAqAAIABAAQAsABAWAYQAXAZAAAtIAACgQAAAvgXAXQgXAXgrAAgAgJhWIAACtQAAAOAJABIABAAQAKgBgBgOIAAitQAAgOgKAAIAAAAQgJAAAAAOg");
	this.shape_21.setTransform(-66.3,-57.05);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AA3CqIAAj+IgDAoIgXDWIg5AAIgYjWIgDgoIAAD+IhLAAIAAlSIB2AAIALCgIABAZIACgZIAMigIB1AAIAAFSg");
	this.shape_22.setTransform(-90.85,-56.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-121.1,-83.8,242.3,116.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_24.setTransform(133.125,586.8);
	...
	this.shape_25.setTransform(127.75,586.8);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AgIA3IAAhtIARAAIAABtg");
	this.shape_26.setTransform(119.325,587.975);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AgJArIAAgYIgRg9IAVAAIAFAdIAGgdIAVAAIgRA9IAAAYg");
	this.shape_27.setTransform(110.775,586.8);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("AgTArIAAhVIATAAIAABCIAVAAIAAATg");
	this.shape_28.setTransform(105.55,586.8);
	...
	this.shape_29.setTransform(100.55,586.8);
	...
	this.shape_32.setTransform(83.475,586.775);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AgFATIgEglIASAAIgDAlg");
	this.shape_33.setTransform(79.8,584.325);
	...
	this.shape_34.setTransform(76.325,586.775);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(181).to({_off:false},0).wait(1).to({regY:-30.6,y:520.2,alpha:0.0037},0).wait(1).to({y:519.95,alpha:0.0167},0).wait(1).to({y:519.45,alpha:0.0435},0).wait(1).to({y:518.55,alpha:0.0919},0).wait(1).to({y:516.85,alpha:0.1816},0).wait(1).to({y:514.2,alpha:0.3248},0).wait(1).to({y:511.15,alpha:0.4878},0).wait(1).to({y:508.4,alpha:0.6345},0).wait(1).to({y:506.2,alpha:0.7499},0).wait(1).to({y:504.55,alpha:0.8388},0).wait(1).to({y:503.25,alpha:0.9088},0).wait(1).to({y:502.35,alpha:0.9564},0).wait(1).to({y:501.85,alpha:0.9834},0).wait(1).to({y:501.6,alpha:0.9964},0).wait(1).to({regY:0,y:530.25,alpha:1},0).wait(61).to({regY:-30.6,y:501.6,alpha:0.9963},0).wait(1).to({y:501.85,alpha:0.9833},0).wait(1).to({y:502.35,alpha:0.9565},0).wait(1).to({y:503.25,alpha:0.9081},0).wait(1).to({y:504.95,alpha:0.8184},0).wait(1).to({y:507.6,alpha:0.6752},0).wait(1).to({y:510.65,alpha:0.5122},0).wait(1).to({y:513.4,alpha:0.3655},0).wait(1).to({y:515.6,alpha:0.2501},0).wait(1).to({y:517.25,alpha:0.1612},0).wait(1).to({y:518.55,alpha:0.0912},0).wait(1).to({y:519.45,alpha:0.0436},0).wait(1).to({y:519.95,alpha:0.0166},0).wait(1).to({y:520.2,alpha:0.0036},0).wait(1).to({regY:0,y:549,alpha:0},0).wait(80));
