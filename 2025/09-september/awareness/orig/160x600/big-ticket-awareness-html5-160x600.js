...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhCFcQgbgWAAgoQAAgmAbgWQAbgXAnAAQAoAAAbAXQAbAWAAAmQAAAogbAWQgbAVgoAAQgnAAgbgVgAhSB8IAAnsICmAAIAAHsg");
	this.shape.setTransform(113.775,-265.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiMFAQg1gxAAhfIAAofICrAAIAAIkQAAAeAWAAQAXAAgBgeIAAokICrAAIAAIfQAABagwAzQgyA0heAAQhXgBg2gwg");
	this.shape_1.setTransform(73.55,-265.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AABF3QhfAAgxg0Qgxg0gBhhIAAlaQABhkAygzQAygzBcAAIACAAQBfAAAxA0QAvA0AABiIAAFaQABBkgyAzQgyAyhcAAgAgWi5IAAF0QABAfAVAAIABAAQAWAAAAgfIAAl0QAAgggXAAIAAAAQgVAAgBAgg");
	this.shape_2.setTransform(28.55,-266.475);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhTFsIAAjPIiKoIICsAAIAyDzIAxjzICsAAIiKIIIAADPg");
	this.shape_3.setTransform(-16.55,-266.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AihFsIAArXIFBAAIAACbIiaAAIAAB8IB9AAIAACbIh9AAIAACKICbAAIAACbg");
	this.shape_4.setTransform(-68.35,-266.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AjCFsIAArXIC4AAQBaAAA2AsQA1AsAABbIAAASQAAA5gSAhQgSAjgpASQBVAeAAB4IAAAsQAABdg0AyQgzAyhYAAgAgbDOIAKAAQAUAAAHgKQAIgIAAgWIAAhHQAAgWgHgJQgHgKgVAAIgKAAgAgbhQIANAAQATgBAJgIQAHgKAAgVIAAgsQAAgVgHgKQgIgJgUAAIgNAAg");
	this.shape_5.setTransform(-108.85,-266.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AjAFsIAArXICzAAQBZAAA6A6QA7A7AABiIAAElQAABjg7A8Qg6A8hYAAgAgZDOIAHAAQAYAAAHgKQAHgMAAgfIAAk5QAAgcgJgJQgIgHgVgBIgHAAg");
	this.shape_6.setTransform(120.325,-380.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AipFsIAArXICnAAIAAIyICtAAIAAClg");
	this.shape_7.setTransform(77.8,-380.55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AiMFAQg1gwAAhfIAAohICrAAIAAIkQAAAgAWAAQAXAAgBggIAAokICrAAIAAIhQAABYgwA0QgyA0hegBQhXABg2gxg");
	this.shape_8.setTransform(35.2,-380.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AABF3QhfAAgxg0Qgyg0AAhhIAAlaQAAhkAzgzQAygzBcAAIACAAQBfAAAxA0QAvA0AABiIAAFaQABBkgyAzQgyAyhbAAgAgWi5IAAF0QAAAfAWAAIABAAQAWAAAAgfIAAl0QAAgggXAAIAAAAQgWAAAAAgg");
	this.shape_9.setTransform(-9.8,-380.725);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAZF3QhmAAg1g3Qg2g4AAhtIAAk1QAAhtA2g4QA1g3BmAAIABAAQBPAABCAdIg8CHQgagIggAAIAAAAQhCAAAABQIAAEVQAAAmAUAVQAVAVAiAAIABAAQAdAAAhgOIA8CGQhJAkhWAAg");
	this.shape_10.setTransform(-49.375,-380.675);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhSFsIAAozIhnAAIAAikIFzAAIAACkIhmAAIAAIzg");
	this.shape_11.setTransform(-101.175,-380.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhSFsIAArXIClAAIAALXg");
	this.shape_12.setTransform(-131.25,-380.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-144.2,-436.8,288.5,247.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(173).to({_off:false},0).wait(1).to({regY:-323.6,y:410.95,alpha:0.0032},0).wait(1).to({y:410.85,alpha:0.0145},0).wait(1).to({y:410.6,alpha:0.0371},0).wait(1).to({y:410.2,alpha:0.077},0).wait(1).to({y:409.5,alpha:0.1467},0).wait(1).to({y:408.3,alpha:0.2672},0).wait(1).to({y:406.8,alpha:0.4164},0).wait(1).to({y:405.35,alpha:0.5648},0).wait(1).to({y:404.1,alpha:0.6887},0).wait(1).to({y:403.1,alpha:0.7859},0).wait(1).to({y:402.35,alpha:0.8625},0).wait(1).to({y:401.75,alpha:0.9229},0).wait(1).to({y:401.35,alpha:0.9628},0).wait(1).to({y:401.1,alpha:0.9857},0).wait(1).to({y:401,alpha:0.9969},0).wait(1).to({regY:0.1,y:562.85,alpha:1},0).wait(74).to({regY:-323.6,x:79.1,y:401},0).wait(1).to({x:80.95},0).wait(1).to({x:84.6},0).wait(1).to({x:91.1},0).wait(1).to({x:102.5},0).wait(1).to({x:122.1},0).wait(1).to({x:146.45},0).wait(1).to({x:170.6},0).wait(1).to({x:190.8},0).wait(1).to({x:206.65},0).wait(1).to({x:219.1},0).wait(1).to({x:228.95},0).wait(1).to({x:235.45},0).wait(1).to({x:239.2},0).wait(1).to({x:241},0).wait(1).to({regY:0.1,x:241.55,y:562.85},0).to({_off:true},17).wait(75));
