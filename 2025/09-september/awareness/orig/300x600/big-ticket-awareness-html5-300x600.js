...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgeCiQgNgKAAgTQAAgRANgLQAMgKASAAQATAAAMAKQANALAAARQAAATgNAKQgMAKgTAAQgSAAgMgKgAgmA6IAAjlIBNAAIAADlg");
	this.shape.setTransform(121.95,-56.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhACVQgZgXAAgsIAAj8IBPAAIAAD+QAAAOAKABQALgBAAgOIAAj+IBPAAIAAD8QAAAqgXAXQgXAYgrAAQgpABgYgXg");
	this.shape_1.setTransform(103.275,-56.75);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAACuQgrAAgXgYQgXgYAAgtIAAigQAAgvAYgXQAXgZAqAAIAAAAQAtABAWAYQAXAZAAAtIAACgQAAAvgXAXQgXAXgrAAgAgJhWIAACtQAAAOAJABIAAAAQALgBgBgOIAAitQAAgOgKAAIAAAAQgKAAABAOg");
	this.shape_2.setTransform(82.3,-57.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgmCqIAAhgIhBjyIBRAAIAWBxIAXhxIBRAAIhBDyIAABgg");
	this.shape_3.setTransform(61.225,-56.95);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhKCqIAAlSICUAAIAABIIhIAAIAAA5IA7AAIAABIIg7AAIAABBIBJAAIAABIg");
	this.shape_4.setTransform(37.1,-56.95);
	...
	this.shape_5.setTransform(18.225,-56.95);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhZCqIAAlSIBTAAQApAAAbAbQAcAbAAAtIAACIQAAAvgcAbQgbAdgoAAgAgLBgIADAAQALAAADgFQADgFAAgOIAAiSQAAgNgEgEQgEgDgJgBIgDAAg");
	this.shape_6.setTransform(-7.725,-56.95);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhOCqIAAlSIBNAAIAAEFIBQAAIAABNg");
	this.shape_7.setTransform(-27.525,-56.95);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhACVQgZgXAAgsIAAj8IBPAAIAAD+QAAAOAKABQALgBAAgOIAAj+IBPAAIAAD8QAAAqgXAXQgXAYgrAAQgpABgYgXg");
	this.shape_8.setTransform(-47.375,-56.75);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAACuQgrAAgXgYQgXgYAAgtIAAigQAAgvAYgXQAXgZAqAAIAAAAQAtABAXAYQAWAZAAAtIAACgQAAAvgXAXQgXAXgrAAgAgJhWIAACtQAAAOAJABIAAAAQALgBgBgOIAAitQAAgOgKAAIAAAAQgKAAABAOg");
	this.shape_9.setTransform(-68.35,-57.05);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAMCvQgvAAgZgaQgZgaAAgyIAAiQQAAgzAZgaQAZgaAvAAIAAAAQAlAAAfAOIgcA/QgMgEgPAAQgeAAAAAlIAACBQAAASAIAJQAKAKAQAAIAAAAQAOAAAPgGIAcA+QgiARgoAAg");
	this.shape_10.setTransform(-86.775,-57.025);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgmCqIAAkGIgvAAIAAhMICsAAIAABMIgwAAIAAEGg");
	this.shape_11.setTransform(-110.9,-56.95);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgmCqIAAlSIBNAAIAAFSg");
	this.shape_12.setTransform(-124.875,-56.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-131.7,-83.8,263.4,63.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(181).to({_off:false},0).wait(1).to({regX:-1.2,regY:-57,x:146.25,y:495.45,alpha:0.0037},0).wait(1).to({y:495.2,alpha:0.0167},0).wait(1).to({y:494.7,alpha:0.0435},0).wait(1).to({y:493.8,alpha:0.0919},0).wait(1).to({y:492.1,alpha:0.1816},0).wait(1).to({y:489.45,alpha:0.3248},0).wait(1).to({y:486.4,alpha:0.4878},0).wait(1).to({y:483.65,alpha:0.6345},0).wait(1).to({y:481.45,alpha:0.7499},0).wait(1).to({y:479.8,alpha:0.8388},0).wait(1).to({y:478.5,alpha:0.9088},0).wait(1).to({y:477.6,alpha:0.9564},0).wait(1).to({y:477.1,alpha:0.9834},0).wait(1).to({y:476.85,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:147.35,y:530.25,alpha:1},0).wait(61).to({regX:-1.2,regY:-57,x:146.25,y:476.85,alpha:0.9963},0).wait(1).to({y:477.1,alpha:0.9833},0).wait(1).to({y:477.6,alpha:0.9565},0).wait(1).to({y:478.5,alpha:0.9081},0).wait(1).to({y:480.2,alpha:0.8184},0).wait(1).to({y:482.85,alpha:0.6752},0).wait(1).to({y:485.9,alpha:0.5122},0).wait(1).to({y:488.65,alpha:0.3655},0).wait(1).to({y:490.85,alpha:0.2501},0).wait(1).to({y:492.5,alpha:0.1612},0).wait(1).to({y:493.8,alpha:0.0912},0).wait(1).to({y:494.7,alpha:0.0436},0).wait(1).to({y:495.2,alpha:0.0166},0).wait(1).to({y:495.45,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:147.35,y:549,alpha:0},0).wait(80));
