...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgUBtQgIgGAAgNQAAgMAIgHQAJgHALAAQAMAAAJAHQAJAHgBAMQABANgJAGQgJAHgMAAQgLAAgJgHgAgZAnIAAiaIAzAAIAACag");
	this.shape.setTransform(82.4,-0.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgrBkQgRgPAAgeIAAiqIA2AAIAACrQAAALAGgBQAHABAAgLIAAirIA2AAIAACqQAAAdgQAQQgPAQgeAAQgbAAgQgQg");
	this.shape_1.setTransform(69.775,-0.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAAB2QgdAAgPgQQgQgRAAgeIAAhsQAAggAQgQQAQgQAcAAIABAAQAdAAAQAQQAPARAAAfIAABsQAAAfgQAQQgPAQgdAAgAgGg6IAAB0QAAALAGgBIAAAAQAHABAAgLIAAh0QAAgKgHAAQgGAAAAAKg");
	this.shape_2.setTransform(55.575,-0.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgZBzIAAhBIgsikIA2AAIAPBNIAQhNIA2AAIgsCkIAABBg");
	this.shape_3.setTransform(41.35,-0.75);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgyBzIAAjlIBkAAIAAAxIgwAAIAAAnIAnAAIAAAxIgnAAIAAAqIAxAAIAAAyg");
	this.shape_4.setTransform(25.075,-0.75);
	...
	this.shape_5.setTransform(12.325,-0.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ag8BzIAAjlIA5AAQAbABATASQARASABAfIAABbQgBAggRATQgTASgbABgAgHBBIACAAQAHAAACgDQACgEABgKIAAhhQAAgKgDgCQgDgDgGAAIgCAAg");
	this.shape_6.setTransform(-5.25,-0.75);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ag1BzIAAjlIA1AAIAACxIA1AAIAAA0g");
	this.shape_7.setTransform(-18.65,-0.75);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgrBkQgRgPAAgeIAAiqIA2AAIAACrQAAALAGgBQAHABAAgLIAAirIA2AAIAACqQAAAdgQAQQgPAQgeAAQgbAAgQgQg");
	this.shape_8.setTransform(-32.025,-0.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAAB2QgdAAgPgQQgQgRAAgeIAAhsQAAggAQgQQAQgQAcAAIABAAQAdAAAQAQQAPARAAAfIAABsQAAAfgQAQQgPAQgdAAgAgGg6IAAB0QAAALAGgBIAAAAQAHABAAgLIAAh0QAAgKgHAAQgGAAAAAKg");
	this.shape_9.setTransform(-46.225,-0.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgoBlQgRgSAAgiIAAhhQAAgiARgSQAQgRAgAAQAZAAAVAKIgTApQgJgCgJAAIgBAAQgTAAAAAZIAABXQAAALAFAIQAHAGAKAAQAKAAALgEIASAqQgXALgbAAQggAAgQgRg");
	this.shape_10.setTransform(-58.7,-0.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgZBzIAAixIghAAIAAg0IB0AAIAAA0IggAAIAACxg");
	this.shape_11.setTransform(-74.95,-0.75);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgZBzIAAjlIAzAAIAADlg");
	this.shape_12.setTransform(-84.475,-0.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_sub_caption_mc, new cjs.Rectangle(-89.3,-19.2,178.7,43.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(181).to({_off:false},0).wait(1).to({regX:-0.9,regY:-0.8,x:156.25,y:424.75,alpha:0.0037},0).wait(1).to({y:424.5,alpha:0.0167},0).wait(1).to({y:423.95,alpha:0.0435},0).wait(1).to({y:423,alpha:0.0919},0).wait(1).to({y:421.25,alpha:0.1816},0).wait(1).to({x:156.2,y:418.45,alpha:0.3248},0).wait(1).to({y:415.25,alpha:0.4878},0).wait(1).to({x:156.15,y:412.35,alpha:0.6345},0).wait(1).to({y:410.1,alpha:0.7499},0).wait(1).to({x:156.1,y:408.35,alpha:0.8388},0).wait(1).to({y:406.95,alpha:0.9088},0).wait(1).to({y:406.05,alpha:0.9564},0).wait(1).to({y:405.5,alpha:0.9834},0).wait(1).to({y:405.25,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:157,y:406,alpha:1},0).wait(61).to({x:157.2,y:405.65},0).wait(1).to({regX:-0.9,regY:-0.8,x:156.3,y:404.9,alpha:0.9968},0).wait(1).to({y:405.1,alpha:0.9855},0).wait(1).to({y:405.55,alpha:0.9629},0).wait(1).to({y:406.35,alpha:0.923},0).wait(1).to({y:407.75,alpha:0.8533},0).wait(1).to({y:410.15,alpha:0.7328},0).wait(1).to({y:413.15,alpha:0.5836},0).wait(1).to({y:416.1,alpha:0.4352},0).wait(1).to({y:418.6,alpha:0.3113},0).wait(1).to({y:420.55,alpha:0.2141},0).wait(1).to({y:422.05,alpha:0.1375},0).wait(1).to({y:423.3,alpha:0.0771},0).wait(1).to({y:424.1,alpha:0.0372},0).wait(1).to({y:424.55,alpha:0.0143},0).wait(1).to({y:424.75,alpha:0.0031},0).wait(1).to({regX:0,regY:0,x:157.2,y:425.65,alpha:0},0).wait(78));
