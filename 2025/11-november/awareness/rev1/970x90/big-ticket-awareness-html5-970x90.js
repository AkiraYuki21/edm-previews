...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).wait(1).to({regX:198.9,regY:-6.8,x:315.7,y:53.5,alpha:0.0037},0).wait(1).to({x:315.1,y:53.4,alpha:0.0167},0).wait(1).to({x:313.9,y:53.15,alpha:0.0435},0).wait(1).to({x:311.75,y:52.75,alpha:0.0919},0).wait(1).to({x:307.7,y:51.95,alpha:0.1816},0).wait(1).to({x:301.25,y:50.7,alpha:0.3248},0).wait(1).to({x:293.95,y:49.3,alpha:0.4878},0).wait(1).to({x:287.3,y:48,alpha:0.6345},0).wait(1).to({x:282.15,y:47,alpha:0.7499},0).wait(1).to({x:278.15,y:46.25,alpha:0.8388},0).wait(1).to({x:275,y:45.6,alpha:0.9088},0).wait(1).to({x:272.85,y:45.2,alpha:0.9564},0).wait(1).to({x:271.6,y:44.95,alpha:0.9834},0).wait(1).to({x:271.05,y:44.85,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:195.05,y:47.45,alpha:1},0).wait(100).to({x:240.05,y:47.75},0).wait(1).to({regX:198.9,regY:-6.8,scaleX:0.381,scaleY:0.381,x:317.25,y:45.15},0).wait(1).to({scaleX:0.3801,scaleY:0.3801,x:322.15},0).wait(1).to({scaleX:0.3781,scaleY:0.3781,x:332.2,y:45.2},0).wait(1).to({scaleX:0.3746,scaleY:0.3746,x:350.45,y:45.25},0).wait(1).to({scaleX:0.3681,scaleY:0.3681,x:384.2,y:45.35},0).wait(1).to({scaleX:0.3576,scaleY:0.3576,x:438.1,y:45.5},0).wait(1).to({scaleX:0.3457,scaleY:0.3457,x:499.45,y:45.75},0).wait(1).to({scaleX:0.335,scaleY:0.335,x:554.7,y:45.9},0).wait(1).to({scaleX:0.3266,scaleY:0.3266,x:598.15,y:46.1},0).wait(1).to({scaleX:0.3201,scaleY:0.3201,x:631.6,y:46.15},0).wait(1).to({scaleX:0.315,scaleY:0.315,x:657.95,y:46.25},0).wait(1).to({scaleX:0.3115,scaleY:0.3115,x:675.9,y:46.35},0).wait(1).to({scaleX:0.3095,scaleY:0.3095,x:686.05},0).wait(1).to({scaleX:0.3086,scaleY:0.3086,x:690.95},0).wait(1).to({regX:0,regY:0,scaleX:0.3083,scaleY:0.3083,x:631,y:48.5},0).wait(80));
