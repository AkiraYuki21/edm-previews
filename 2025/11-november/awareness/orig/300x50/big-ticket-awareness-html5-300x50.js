...
}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(-22,-24,60.6,48.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90).to({_off:false},0).wait(1).to({regX:8.3,regY:0.2,x:101.2,y:32.35,alpha:0.0037},0).wait(1).to({x:101.15,y:32.25,alpha:0.0167},0).wait(1).to({x:101,y:32.1,alpha:0.0435},0).wait(1).to({x:100.7,y:31.75,alpha:0.0919},0).wait(1).to({x:100.25,y:31.2,alpha:0.1816},0).wait(1).to({x:99.45,y:30.25,alpha:0.3248},0).wait(1).to({x:98.55,y:29.15,alpha:0.4878},0).wait(1).to({x:97.75,y:28.2,alpha:0.6345},0).wait(1).to({x:97.1,y:27.45,alpha:0.7499},0).wait(1).to({x:96.6,y:26.85,alpha:0.8388},0).wait(1).to({x:96.25,y:26.4,alpha:0.9088},0).wait(1).to({x:95.95,y:26.05,alpha:0.9564},0).wait(1).to({x:95.8,y:25.9,alpha:0.9834},0).wait(1).to({x:95.75,y:25.8,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:87.45,y:25.6,alpha:1},0).wait(106).to({x:93.2,y:25.2},0).wait(1).to({regX:8.3,regY:0.2,scaleX:0.9999,scaleY:0.9999,x:101.75,y:25.4},0).wait(1).to({scaleX:0.9995,scaleY:0.9995,x:102.75},0).wait(1).to({scaleX:0.9988,scaleY:0.9988,x:104.75},0).wait(1).to({scaleX:0.9974,scaleY:0.9974,x:108.4},0).wait(1).to({scaleX:0.9948,scaleY:0.9948,x:115.15,y:25.45},0).wait(1).to({scaleX:0.9907,scaleY:0.9907,x:125.95,y:25.55},0).wait(1).to({scaleX:0.9861,scaleY:0.9861,x:138.25,y:25.6},0).wait(1).to({scaleX:0.9819,scaleY:0.9819,x:149.3,y:25.7},0).wait(1).to({scaleX:0.9786,scaleY:0.9786,x:157.95,y:25.75},0).wait(1).to({scaleX:0.9761,scaleY:0.9761,x:164.7,y:25.8},0).wait(1).to({scaleX:0.9741,scaleY:0.9741,x:170,y:25.85},0).wait(1).to({scaleX:0.9727,scaleY:0.9727,x:173.55},0).wait(1).to({scaleX:0.9719,scaleY:0.9719,x:175.55},0).wait(1).to({scaleX:0.9716,scaleY:0.9716,x:176.55},0).wait(1).to({regX:0.1,regY:0.1,scaleX:0.9715,scaleY:0.9715,x:168.8,y:25.7},0).wait(96));
