...
}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(-41,-121,285.7,228.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).wait(1).to({regX:101.8,regY:-6.8,x:278.85,y:53.5,alpha:0.0037},0).wait(1).to({y:53.4,alpha:0.0167},0).wait(1).to({y:53.15,alpha:0.0435},0).wait(1).to({y:52.75,alpha:0.0919},0).wait(1).to({y:52,alpha:0.1816},0).wait(1).to({y:50.8,alpha:0.3248},0).wait(1).to({y:49.45,alpha:0.4878},0).wait(1).to({y:48.2,alpha:0.6345},0).wait(1).to({y:47.25,alpha:0.7499},0).wait(1).to({y:46.5,alpha:0.8388},0).wait(1).to({y:45.9,alpha:0.9088},0).wait(1).to({y:45.5,alpha:0.9564},0).wait(1).to({y:45.25,alpha:0.9834},0).wait(1).to({y:45.15,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:240.05,y:47.75,alpha:1},0).wait(101).to({regX:101.8,regY:-6.8,x:280.4,y:45.1},0).wait(1).to({x:285.95},0).wait(1).to({x:297.35},0).wait(1).to({x:317.95},0).wait(1).to({x:356.15},0).wait(1).to({x:417.15},0).wait(1).to({x:486.6},0).wait(1).to({x:549.05},0).wait(1).to({x:598.25},0).wait(1).to({x:636.1},0).wait(1).to({x:665.9},0).wait(1).to({x:686.2},0).wait(1).to({x:697.7},0).wait(1).to({x:703.25},0).wait(1).to({regX:0,regY:0,x:666,y:47.7},0).wait(80));
