...
}).prototype = getMCSymbolPrototype(lib.secondprize_mc, new cjs.Rectangle(-129,-130,322.5,257.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90).to({_off:false},0).wait(1).to({regX:32.2,regY:-1.1,x:-88.3,y:207.55},0).wait(1).to({x:-86.4},0).wait(1).to({x:-82.6},0).wait(1).to({x:-75.9},0).wait(1).to({x:-64.2},0).wait(1).to({x:-43.95},0).wait(1).to({x:-18.85},0).wait(1).to({x:6.05},0).wait(1).to({x:26.85},0).wait(1).to({x:43.15},0).wait(1).to({x:56},0).wait(1).to({x:66.2},0).wait(1).to({x:72.9},0).wait(1).to({x:76.7},0).wait(1).to({x:78.6},0).wait(1).to({regX:0.2,regY:0.2,x:61.75,y:208.25},0).wait(106).to({regX:32.2,regY:-1.1,scaleX:0.5428,scaleY:0.5428,x:79.15,y:208.15},0).wait(1).to({scaleX:0.5414,scaleY:0.5414,y:210.4},0).wait(1).to({scaleX:0.5386,scaleY:0.5386,x:79.1,y:214.9},0).wait(1).to({scaleX:0.5336,scaleY:0.5336,y:222.85},0).wait(1).to({scaleX:0.5248,scaleY:0.5248,x:79.05,y:236.7},0).wait(1).to({scaleX:0.5098,scaleY:0.5098,x:78.95,y:260.7},0).wait(1).to({scaleX:0.4911,scaleY:0.4911,x:78.9,y:290.4},0).wait(1).to({scaleX:0.4725,scaleY:0.4725,x:78.8,y:319.95},0).wait(1).to({scaleX:0.457,scaleY:0.457,x:78.75,y:344.6},0).wait(1).to({scaleX:0.4449,scaleY:0.4449,x:78.7,y:363.9},0).wait(1).to({scaleX:0.4353,scaleY:0.4353,x:78.65,y:379.15},0).wait(1).to({scaleX:0.4277,scaleY:0.4277,x:78.6,y:391.2},0).wait(1).to({scaleX:0.4228,scaleY:0.4228,y:399.15},0).wait(1).to({scaleX:0.4199,scaleY:0.4199,y:403.7},0).wait(1).to({scaleX:0.4185,scaleY:0.4185,x:78.65,y:405.9},0).wait(1).to({regX:0.6,regY:0.6,scaleX:0.4181,scaleY:0.4181,x:65.25,y:407.1},0).wait(92));
