...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("Al1FOIAAqbQAAi1B1hqQB0hqC3AAQCsAACfBZIh0EWQhRgshgAAQh9AAACCNIAAJpQAABCAxAAQAWAAAOgJIAAn7IExAAIAALPQhhA3hIAYQhIAYhfAAQmBAAAAmJg");
	this.shape.setTransform(1088.925,-157.275);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgELAIhZt8IAAN8IlDAAIAA1/IGpAAIBWNnIAAtnIFCAAIAAV/g");
	this.shape_1.setTransform(999.475,-157.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AihLAIAA1/IFCAAIAAV/g");
	this.shape_2.setTransform(931.2,-157.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAuLAIh/qGIAAKGIlDAAIAA1/IFDAAIAAKCIB9qCIFTAAIiuKZIDELmg");
	this.shape_3.setTransform(865.925,-157.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAwLWQjHAAhmhrQhnhtAAjRIAApYQAAjTBnhsQBmhrDHAAIACAAQCZAAB/A6Ih0EEQgxgQg+AAIgBAAQh/AAAACbIAAIZQAABJAmApQAoApBDgBIABAAQA5ABBBgbIByEDQiNBGimAAg");
	this.shape_4.setTransform(784.45,-157.35);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AihLAIAA1/IFCAAIAAV/g");
	this.shape_5.setTransform(722.15,-157.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AigLAIAAxBIjGAAIAAk+ILNAAIAAE+IjFAAIAARBg");
	this.shape_6.setTransform(664.075,-157.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AldKSIBUkiQCJA1A7AAQBxAAAAhYIAAgJQAAgogcgrQgcgshFhFIg9g7QhjhigrhUQgshUAAiFIAAgDQAAi4BehnQBehoClAAQCIAAChBBIhTEPQhngfgwAAQhuAAAABZIAAAGQAAAMAFAMQADAMAHALQAFAKAMAPIAWAaIAeAfIAfAiQAsAvAWAVQBmBlAtBTQAsBSAACOIAAACQAAC/hkBsQhkBtilAAQinAAinhDg");
	this.shape_7.setTransform(568,-157.475);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhdEuIg8pbIEyAAIg4Jbg");
	this.shape_8.setTransform(509,-197.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAuLAIh/qGIAAKGIlDAAIAA1/IFDAAIAAKCIB9qCIFTAAIiuKZIDELmg");
	this.shape_9.setTransform(442.675,-157.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAwLWQjGAAhnhrQhnhtAAjRIAApYQAAjTBnhsQBnhrDGAAIACAAQCYAACBA6Ih0EEQgygQg+AAIgBAAQh/AAAACbIAAIZQAABJAmApQAoApBCgBIACAAQA5ABBBgbIByEDQiNBGimAAg");
	this.shape_10.setTransform(361.2,-157.35);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AABLVQi4AAhfhkQhfhlAAi8IAAqdQAAjCBhhiQBihjCyAAIADAAQC4AABeBlQBdBlAAC9IAAKdQAADDhgBhQhgBhixAAgAgqlnIAALRQAAA7AqAAIABAAQAsAAAAg7IAArRQAAg8gtAAIgBAAQgpAAAAA8g");
	this.shape_11.setTransform(277.675,-157.475);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AlILAIAA1/IFDAAIAARBIFOAAIAAE+g");
	this.shape_12.setTransform(195.3,-157.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAxLWQjIAAhmhrQhnhtAAjRIAApYQAAjTBnhsQBmhrDIAAIABAAQCZAAB/A6Ih0EEQgxgQg9AAIgCAAQh/AAAACbIAAIZQAABJAnApQAoApBCgBIACAAQA4ABBAgbIBzEDQiNBGimAAg");
	this.shape_13.setTransform(123.2,-157.35);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-307.3,-264.9,1825.5,255.49999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-232,-129,1.0219,1.0219);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(-232,-129,289.2,252.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AjAKqQg1goAAhQQAAhHA1gsQA0gsBOAAQBNAAA0AsQA1AsAABHQAABQg1AoQg0AqhNAAQhOAAg0gqgAjMDxIgCjJQBShYA4hZQA4haAAg2IAAgGQAAgwgmghQgmghg2AAQg7AAhQAsIBClbQBWgTA8AAQCmAABcBVQBdBVAACWIAAAUQAAA3gLA2QgLA2gLAjQgLAkgcAvIgoBBQgMASgjArIgmAyIAACng");
	this.shape.setTransform(965.075,-168.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgELAIhZt7IAAN7IlDAAIAA1/IGpAAIBWNmIAAtmIFCAAIAAV/g");
	this.shape_1.setTransform(884.775,-168.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AigLAIAA1/IFCAAIAAV/g");
	this.shape_2.setTransform(816.5,-168.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AkPJrQhmheAAi4IAAwdIFJAAIAAQlQAAA8AsAAQAsAAAAg8IAAwlIFKAAIAAQdQAACshfBkQhfBki2gBQiqAAhnhdg");
	this.shape_3.setTransform(728.375,-167.25);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AABLVQi4AAhfhkQhfhlAAi8IAAqdQAAjCBhhiQBihjCyAAIADAAQC4AABeBlQBdBlAAC9IAAKdQAADDhgBhQhgBhixAAgAgqlnIAALRQAAA7AqAAIABAAQAsAAAAg7IAArRQAAg8gtAAIgBAAQgpAAAAA8g");
	this.shape_4.setTransform(641.325,-168.475);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AigLAIAAmPIkOvwIFOAAIBhHXIBhnXIFNAAIkNPwIAAGPg");
	this.shape_5.setTransform(553.9,-168.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ak3LAIAA1/IJrAAIAAEsIkpAAIAADwIDxAAIAAEtIjxAAIAAEKIEtAAIAAEsg");
	this.shape_6.setTransform(453.65,-168.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AA7LAIhxoZIgWAAIAAIZIlDAAIAA1/IFZAAQDfAABYBkQBXBkABC/IAABkQAADOhpBaIChJsgAhMhcIAQAAQApAAARgTQARgTAAgvIAAiHQAAgugRgUQgRgTgpAAIgQAAg");
	this.shape_7.setTransform(372.05,-168.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("ABoLAIgakTIibAAIgaETIk8AAIC61/IHTAAIC6V/gAgGj4IgoF5IBdAAIgol5IgHh1g");
	this.shape_8.setTransform(281.375,-168.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-213.7,-275.9,1663.6000000000001,255.49999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(210).to({alpha:0},16).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(226).to({_off:false},0).to({y:24.4,alpha:1},16).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(210).to({_off:false},0).wait(1).to({regX:-1354.7,regY:-10.8,x:-29,y:21.6,alpha:0.0032},0).wait(1).to({x:-28.1,alpha:0.0145},0).wait(1).to({x:-26.4,alpha:0.0371},0).wait(1).to({x:-23.35,alpha:0.077},0).wait(1).to({x:-18,y:21.65,alpha:0.1467},0).wait(1).to({x:-8.75,y:21.7,alpha:0.2672},0).wait(1).to({x:2.65,y:21.75,alpha:0.4164},0).wait(1).to({x:14.05,y:21.8,alpha:0.5648},0).wait(1).to({x:23.55,y:21.85,alpha:0.6887},0).wait(1).to({x:31,y:21.9,alpha:0.7859},0).wait(1).to({x:36.85,alpha:0.8625},0).wait(1).to({x:41.45,y:21.95,alpha:0.9229},0).wait(1).to({x:44.55,alpha:0.9628},0).wait(1).to({x:46.3,alpha:0.9857},0).wait(1).to({x:47.15,alpha:0.9969},0).wait(1).to({regX:0,regY:0,x:159.95,y:22.9,alpha:1},0).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:606.9,regY:-157.3,x:222.85,y:27.85,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.8,alpha:0.0435},0).wait(1).to({y:27.7,alpha:0.0919},0).wait(1).to({y:27.5,alpha:0.1816},0).wait(1).to({y:27.2,alpha:0.3248},0).wait(1).to({y:26.85,alpha:0.4878},0).wait(1).to({y:26.55,alpha:0.6345},0).wait(1).to({y:26.3,alpha:0.7499},0).wait(1).to({y:26.1,alpha:0.8388},0).wait(1).to({y:25.95,alpha:0.9088},0).wait(1).to({y:25.85,alpha:0.9564},0).wait(1).to({y:25.8,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(69).to({regX:606.9,regY:-157.3,x:222.85,y:25.8,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25.85,alpha:0.9565},0).wait(1).to({y:25.95,alpha:0.9081},0).wait(1).to({y:26.15,alpha:0.8184},0).wait(1).to({y:26.45,alpha:0.6752},0).wait(1).to({y:26.8,alpha:0.5122},0).wait(1).to({y:27.1,alpha:0.3655},0).wait(1).to({y:27.35,alpha:0.2501},0).wait(1).to({y:27.55,alpha:0.1612},0).wait(1).to({y:27.7,alpha:0.0912},0).wait(1).to({y:27.8,alpha:0.0436},0).wait(1).to({y:27.85,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).to({_off:true},61).wait(130));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).wait(1).to({regX:616.4,regY:-168.3,x:223.85,y:26.7,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:26.65,alpha:0.0435},0).wait(1).to({y:26.55,alpha:0.0919},0).wait(1).to({y:26.35,alpha:0.1816},0).wait(1).to({y:26.05,alpha:0.3248},0).wait(1).to({y:25.7,alpha:0.4878},0).wait(1).to({y:25.4,alpha:0.6345},0).wait(1).to({y:25.15,alpha:0.7499},0).wait(1).to({y:24.95,alpha:0.8388},0).wait(1).to({y:24.8,alpha:0.9088},0).wait(1).to({y:24.7,alpha:0.9564},0).wait(1).to({y:24.65,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(98).to({regX:616.4,regY:-168.3,x:223.85,y:24.65,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:24.7,alpha:0.9565},0).wait(1).to({y:24.8,alpha:0.9081},0).wait(1).to({y:25,alpha:0.8184},0).wait(1).to({y:25.3,alpha:0.6752},0).wait(1).to({y:25.65,alpha:0.5122},0).wait(1).to({y:25.95,alpha:0.3655},0).wait(1).to({y:26.2,alpha:0.2501},0).wait(1).to({y:26.4,alpha:0.1612},0).wait(1).to({y:26.55,alpha:0.0912},0).wait(1).to({y:26.65,alpha:0.0436},0).wait(1).to({y:26.7,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).wait(79));

	// second_prize
	this.instance_6 = new lib.second_prize_mc();
	this.instance_6.setTransform(119.35,29.8,0.1923,0.1923);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).wait(1).to({regX:-87.4,regY:-2.8,x:102.55,y:29.2,alpha:0.0037},0).wait(1).to({x:102.6,y:29.15,alpha:0.0167},0).wait(1).to({x:102.75,y:29.05,alpha:0.0435},0).wait(1).to({x:103.05,y:28.85,alpha:0.0919},0).wait(1).to({x:103.55,y:28.5,alpha:0.1816},0).wait(1).to({x:104.35,y:27.9,alpha:0.3248},0).wait(1).to({x:105.25,y:27.25,alpha:0.4878},0).wait(1).to({x:106.1,y:26.6,alpha:0.6345},0).wait(1).to({x:106.7,y:26.15,alpha:0.7499},0).wait(1).to({x:107.2,y:25.8,alpha:0.8388},0).wait(1).to({x:107.6,y:25.5,alpha:0.9088},0).wait(1).to({x:107.9,y:25.3,alpha:0.9564},0).wait(1).to({x:108.05,y:25.2,alpha:0.9834},0).wait(1).to({x:108.1,y:25.15,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:124.95,y:25.7,alpha:1},0).wait(98).to({regX:-87.4,regY:-2.8,x:108.4,y:25.1},0).wait(1).to({scaleX:0.1922,scaleY:0.1922,x:109.4},0).wait(1).to({scaleX:0.1919,scaleY:0.1919,x:111.55},0).wait(1).to({scaleX:0.1915,scaleY:0.1915,x:115.25,y:25.05},0).wait(1).to({scaleX:0.1907,scaleY:0.1907,x:122.3},0).wait(1).to({scaleX:0.1895,scaleY:0.1895,x:133.45,y:24.95},0).wait(1).to({scaleX:0.1881,scaleY:0.1881,x:146.1,y:24.85},0).wait(1).to({scaleX:0.1868,scaleY:0.1868,x:157.5},0).wait(1).to({scaleX:0.1858,scaleY:0.1858,x:166.55,y:24.75},0).wait(1).to({scaleX:0.185,scaleY:0.185,x:173.5,y:24.7},0).wait(1).to({scaleX:0.1844,scaleY:0.1844,x:178.95},0).wait(1).to({scaleX:0.184,scaleY:0.184,x:182.6,y:24.65},0).wait(1).to({scaleX:0.1838,scaleY:0.1838,x:184.75},0).wait(1).to({scaleX:0.1837,scaleY:0.1837,x:185.75},0).wait(1).to({regX:-20.7,regY:0,x:202.1,y:25.15},0).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({regX:-751.6,regY:20.2,x:123.8,y:25,alpha:0.0037},0).wait(1).to({x:123.55,alpha:0.0167},0).wait(1).to({x:123,alpha:0.0435},0).wait(1).to({x:122,alpha:0.0919},0).wait(1).to({x:120.2,alpha:0.1816},0).wait(1).to({x:117.3,alpha:0.3248},0).wait(1).to({x:114,alpha:0.4878},0).wait(1).to({x:111.05,y:24.95,alpha:0.6345},0).wait(1).to({x:108.75,alpha:0.7499},0).wait(1).to({x:106.95,alpha:0.8388},0).wait(1).to({x:105.5,alpha:0.9088},0).wait(1).to({x:104.55,alpha:0.9564},0).wait(1).to({x:104,alpha:0.9834},0).wait(1).to({x:103.75,alpha:0.9964},0).wait(1).to({regX:0,regY:0.6,x:168.95,y:23.25,alpha:1},0).wait(83).to({x:159.95,y:23.35,alpha:0},15).wait(97).to({regX:-667,regY:20.2,x:102.1,y:25.05},0).wait(1).to({regX:-751.6,x:94.65},0).wait(1).to({x:94.7},0).wait(1).to({x:95.45,y:25,alpha:0.0206},0).wait(1).to({scaleX:0.0866,scaleY:0.0866,x:97.3,alpha:0.075},0).wait(1).to({scaleX:0.0865,scaleY:0.0865,x:99.6,alpha:0.1453},0).wait(1).to({scaleX:0.0863,scaleY:0.0863,x:102.65,alpha:0.2353},0).wait(1).to({scaleX:0.0861,scaleY:0.0861,x:106.5,alpha:0.3498},0).wait(1).to({scaleX:0.0858,scaleY:0.0858,x:111.1,alpha:0.4866},0).wait(1).to({scaleX:0.0856,scaleY:0.0856,x:115.85,alpha:0.6273},0).wait(1).to({scaleX:0.0853,scaleY:0.0853,x:119.95,y:24.95,alpha:0.7499},0).wait(1).to({scaleX:0.0852,scaleY:0.0852,x:123.3,y:24.9,alpha:0.848},0).wait(1).to({scaleX:0.085,scaleY:0.085,x:125.85,alpha:0.9252},0).wait(1).to({scaleX:0.0849,scaleY:0.0849,x:127.9,alpha:0.9846},0).wait(1).to({x:128.4,alpha:1},0).wait(1).to({regX:-666.9,regY:21.2,x:135.6,y:24.95},0).wait(79));
...
p.nominalBounds = new cjs.Rectangle(88.9,24.1,231.1,29.5);
// library properties:
lib.properties = {
