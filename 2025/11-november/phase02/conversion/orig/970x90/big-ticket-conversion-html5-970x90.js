...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-41,-121,0.9182,0.9182);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.second_prize_mc, new cjs.Rectangle(-41,-121,259.9,226.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AnPZmQh+hhAAjAQAAirB+hqQB8hpC7AAQC9AAB8BpQB+BqAACrQAADAh+BhQh8Bki9AAQi7AAh8hkgAnrJCIgEniQDDjVCGjWQCJjYAAiAIAAgQQAAhyhchPQhchQiCAAQiMAAjCBqICftDQDOgsCQAAQGQAADeDMQDgDLAAFqIAAAvQAACEgbCCQgcCAgbBWQgaBWhDByQhDBvgdArQgcAthUBpQhTBqgIAOIAAGPg");
	this.shape.setTransform(2206.275,-197.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgKaaMgDWgheMAAAAheIsHAAMAAAg0zIP9AAMADNAgrMAAAggrIMFAAMAAAA0zg");
	this.shape_1.setTransform(2013.425,-197.675);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AmDaaMAAAg0zIMHAAMAAAA0zg");
	this.shape_2.setTransform(1849.575,-197.675);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AqLXPQj2jiAAm5MAAAgnhIMXAAMAAAAn1QAACOBrAAQBoAAgBiOMAAAgn1IMaAAMAAAAnhQAAGcjjDwQjkDvm2AAQmaAAj2jgg");
	this.shape_3.setTransform(1637.9,-195.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AADbMQm8AAjkjwQjljyAAnCIAA5IQAAnTDqjsQDrjsGtAAIAIAAQG5AADiDyQDfDyAAHHIAAZIQAAHSjoDqQjlDomqAAgAhotfIAAbEQAACOBoAAIADAAQBoAAAAiOIAA7EQAAiRhrAAIgEAAQhkAAAACRg");
	this.shape_4.setTransform(1428.9,-198.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AmCaaIAAu+MgKHgl1IMiAAIDrRpIDmxpIMgAAMgKFAl1IAAO+g");
	this.shape_5.setTransform(1218.95,-197.675);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("ArsaaMAAAg0zIXRAAIAALQIrKAAIAAJAIJDAAIAALUIpDAAIAAJ/ILSAAIAALQg");
	this.shape_6.setTransform(978.4,-197.675);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ACLaaIkN0IIg3AAIAAUIIsIAAMAAAg0zIM/AAQIYAADUDwQDRDwAAHKIAADyQAAHvj6DZIGBXPgAi5jeIAmAAQBkAAApgvQAqgsAAhwIAAlGQAAhwgqgvQgpgshkAAIgmAAg");
	this.shape_7.setTransform(782.475,-197.675);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AD5aaIg9qTIl3AAIg9KTIr3AAMAG9g0zIRlAAMAG9A0zgAgQpUIhgOKIDhAAIhguKIgQkZg");
	this.shape_8.setTransform(564.725,-197.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_sub_caption_mc, new cjs.Rectangle(-2035.5,-456.5,6817.4,613.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AuCMjIAA5FQAAmxEZj/QEXj+G5AAQGdAAF+DWIkWKbQjEhqjlAAQkvAAAFFSIAAXLQAACeB2AAQA4AAAggUIAAzEILcAAIAAbBQjnCEiuA5QitA5jmAAQudAAAAuug");
	this.shape.setTransform(2667.4,-170.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgKaaMgDWgheMAAAAheIsHAAMAAAg0zIP9AAMADNAgrMAAAggrIMFAAMAAAA0zg");
	this.shape_1.setTransform(2452.475,-169.675);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AmDaaMAAAg0zIMHAAMAAAA0zg");
	this.shape_2.setTransform(2288.675,-169.675);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("ABuaaIky4OIAAYOIsIAAMAAAg0zIMIAAIAAYHIEu4HIMuAAImhY7IHWb4g");
	this.shape_3.setTransform(2131.825,-169.675);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AB0bPQnfAAj2kCQj3kDAAn5IAA2hQAAn5D3kDQD2kCHfAAIAEAAQFvAAEzCKIkXJxQh4gliTAAIgEAAQkyAAAAFzIAAULQAACvBfBiQBfBiCfAAIAEAAQCJAACahAIETJvQlSCnmPAAg");
	this.shape_4.setTransform(1936.225,-170.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AmDaaMAAAg0zIMHAAMAAAA0zg");
	this.shape_5.setTransform(1786.725,-169.675);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AmCaaMAAAgo4IncAAIAAr7Ia9AAIAAL7InaAAMAAAAo4g");
	this.shape_6.setTransform(1647.225,-169.675);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AtIYrIDKq4QFKCBCNgBQERAAAAjTIAAgXQAAhfhDhoQhFhoiminIiTiOQjujrhojMQhojJABk9IAAgIQAAm6Dij5QDfj4GQAAQFGAAGCCbIjHKLQj2hLh0AAQkJAAgBDYIAAALQABAfAJAdQALAcAOAbQAOAYAdAlQAhAmAVAXIBHBLIBLBSQBoBvA3A0QD0D0BsDGQBpDFABFWIAAAFQAAHJjxEEQjwEFmOAAQmRAAmRihg");
	this.shape_7.setTransform(1416.5,-170.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AjhLWIiO2qILfAAIiIWqg");
	this.shape_8.setTransform(1274.825,-266.15);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABuaaIky4OIAAYOIsIAAMAAAg0zIMIAAIAAYHIEu4HIMuAAImhY7IHWb4g");
	this.shape_9.setTransform(1115.675,-169.675);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AB0bPQnfAAj2kCQj3kDAAn5IAA2hQAAn5D3kDQD2kCHfAAIAEAAQFvAAEzCKIkXJxQh4gliTAAIgEAAQkyAAAAFzIAAULQAACvBfBiQBfBiCfAAIAEAAQCJAACahAIETJvQlSCnmPAAg");
	this.shape_10.setTransform(920.075,-170.275);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AADbMQm9AAjjjwQjkjyAAnCIAA5IQgBnTDrjsQDpjsGuAAIAHAAQG6AADiDzQDgDxgBHHIAAZIQAAHSjnDqQjnDomoAAgAhntfIAAbEQgBCPBogBIADAAQBoABAAiPIAA7EQAAiRhrAAIgEAAQhjAAAACRg");
	this.shape_11.setTransform(719.55,-170.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AsWaaMAAAg0zIMIAAMAAAAo4IMlAAIAAL7g");
	this.shape_12.setTransform(521.675,-169.675);
	...
	this.shape_13.setTransform(348.575,-170.275);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(213).to({alpha:0},16).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(213).to({_off:false},0).wait(1).to({regX:-2454.6,regY:25.5,x:179.8,y:44.55,alpha:0.0032},0).wait(1).to({x:181.2,alpha:0.0145},0).wait(1).to({x:183.95,alpha:0.0371},0).wait(1).to({x:188.8,alpha:0.077},0).wait(1).to({x:197.3,y:44.6,alpha:0.1467},0).wait(1).to({x:212,y:44.65,alpha:0.2672},0).wait(1).to({x:230.2,y:44.7,alpha:0.4164},0).wait(1).to({x:248.3,y:44.75,alpha:0.5648},0).wait(1).to({x:263.4,y:44.8,alpha:0.6887},0).wait(1).to({x:275.25,y:44.85,alpha:0.7859},0).wait(1).to({x:284.6,alpha:0.8625},0).wait(1).to({x:292,y:44.9,alpha:0.9229},0).wait(1).to({x:296.85,alpha:0.9628},0).wait(1).to({x:299.65,alpha:0.9857},0).wait(1).to({x:301,y:44.95,alpha:0.9969},0).wait(1).to({regX:0,regY:0,x:484.95,y:43.1,alpha:1},0).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},68).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},84).wait(111));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:1510.1,regY:-170.1,x:626.2,y:46.4,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({alpha:0.0435},0).wait(1).to({y:46.5,alpha:0.0919},0).wait(1).to({y:46.55,alpha:0.1816},0).wait(1).to({y:46.75,alpha:0.3248},0).wait(1).to({y:46.9,alpha:0.4878},0).wait(1).to({y:47.05,alpha:0.6345},0).wait(1).to({y:47.2,alpha:0.7499},0).wait(1).to({y:47.3,alpha:0.8388},0).wait(1).to({y:47.35,alpha:0.9088},0).wait(1).to({y:47.45,alpha:0.9564},0).wait(1).to({alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:1.1,regY:0.6,x:484.75,y:63.5,alpha:1},0).wait(69).to({regX:1510.1,regY:-170.1,x:626.2,y:47.45,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({alpha:0.9565},0).wait(1).to({y:47.35,alpha:0.9081},0).wait(1).to({y:47.3,alpha:0.8184},0).wait(1).to({y:47.1,alpha:0.6752},0).wait(1).to({y:46.95,alpha:0.5122},0).wait(1).to({y:46.8,alpha:0.3655},0).wait(1).to({y:46.65,alpha:0.2501},0).wait(1).to({y:46.55,alpha:0.1612},0).wait(1).to({y:46.5,alpha:0.0912},0).wait(1).to({y:46.4,alpha:0.0436},0).wait(1).to({alpha:0.0166},0).wait(1).to({alpha:0.0036},0).to({_off:true},1).wait(195));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).wait(1).to({regX:88.9,regY:-7.6,x:273.75,y:53.2,alpha:0.0037},0).wait(1).to({x:273.15,y:53.1,alpha:0.0167},0).wait(1).to({x:271.95,y:52.85,alpha:0.0435},0).wait(1).to({x:269.8,y:52.45,alpha:0.0919},0).wait(1).to({x:265.75,y:51.65,alpha:0.1816},0).wait(1).to({x:259.3,y:50.4,alpha:0.3248},0).wait(1).to({x:252,y:49,alpha:0.4878},0).wait(1).to({x:245.35,y:47.7,alpha:0.6345},0).wait(1).to({x:240.2,y:46.7,alpha:0.7499},0).wait(1).to({x:236.2,y:45.95,alpha:0.8388},0).wait(1).to({x:233.05,y:45.3,alpha:0.9088},0).wait(1).to({x:230.9,y:44.9,alpha:0.9564},0).wait(1).to({x:229.65,y:44.65,alpha:0.9834},0).wait(1).to({x:229.1,y:44.55,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:195.05,y:47.45,alpha:1},0).wait(100).to({x:240.05,y:47.75},0).wait(1).to({regX:88.9,regY:-7.6,x:275.35,y:44.85},0).wait(1).to({scaleX:0.3814,scaleY:0.3814,x:280.45},0).wait(1).to({scaleX:0.3815,scaleY:0.3815,x:290.9},0).wait(1).to({scaleX:0.3816,scaleY:0.3816,x:309.9},0).wait(1).to({scaleX:0.3819,scaleY:0.3819,x:344.95,y:44.9},0).wait(1).to({scaleX:0.3824,scaleY:0.3824,x:401,y:45},0).wait(1).to({scaleX:0.383,scaleY:0.383,x:464.75,y:45.05},0).wait(1).to({scaleX:0.3835,scaleY:0.3835,x:522.15,y:45.15},0).wait(1).to({scaleX:0.3839,scaleY:0.3839,x:567.35,y:45.2},0).wait(1).to({scaleX:0.3842,scaleY:0.3842,x:602.1,y:45.25},0).wait(1).to({scaleX:0.3845,scaleY:0.3845,x:629.5,y:45.3},0).wait(1).to({scaleX:0.3847,scaleY:0.3847,x:648.15},0).wait(1).to({scaleX:0.3848,scaleY:0.3848,x:658.7},0).wait(1).to({x:663.75},0).wait(1).to({regX:0,regY:0,x:631,y:48.25},0).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(98).to({_off:false},0).wait(1).to({regX:1369,regY:-198.3,x:612.95,y:43.7,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({alpha:0.0435},0).wait(1).to({alpha:0.0919},0).wait(1).to({alpha:0.1816},0).wait(1).to({y:43.65,alpha:0.3248},0).wait(1).to({alpha:0.4878},0).wait(1).to({y:43.6,alpha:0.6345},0).wait(1).to({alpha:0.7499},0).wait(1).to({y:43.55,alpha:0.8388},0).wait(1).to({alpha:0.9088},0).wait(1).to({alpha:0.9564},0).wait(1).to({alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:1.1,regY:0.6,x:484.75,y:62.2,alpha:1},0).wait(101).to({regX:1369,regY:-198.3,x:612.95,y:43.55,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({alpha:0.9565},0).wait(1).to({alpha:0.9081},0).wait(1).to({alpha:0.8184},0).wait(1).to({y:43.6,alpha:0.6752},0).wait(1).to({alpha:0.5122},0).wait(1).to({y:43.65,alpha:0.3655},0).wait(1).to({alpha:0.2501},0).wait(1).to({y:43.7,alpha:0.1612},0).wait(1).to({alpha:0.0912},0).wait(1).to({alpha:0.0436},0).wait(1).to({alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:1.1,regY:0.6,x:484.75,y:62.4,alpha:0},0).wait(80));
