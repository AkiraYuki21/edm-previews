...
if (reversed == null) { reversed = false; }
	...
	this.shape_16.setTransform(-62.9,-0.725);
	...
	this.shape_17.setTransform(-65.325,-0.725);
	...
	this.shape_22.setTransform(-77.225,-0.75);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("");
	this.shape_23.setTransform(-80.1,-0.75);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AgEAVIAAggIgGAAIAAgJIAVAAIAAAJIgGAAIAAAgg");
	this.shape_24.setTransform(-82.875,-0.725);
	...
	this.shape_26.graphics.f("#FFFFFF").s().p("AABAVIAAgKIgNAAIAJgfIANAAIAAAXIACAAIAAAIIgCAAIAAAKgAgBADIACAAIAAgOg");
	this.shape_26.setTransform(-91.05,-0.725);
	...
	this.shape_29.graphics.f("#FFFFFF").s().p("AgFAWIgEgCIACgJIADACIADAAIACgBIAAgCIAAgCIgCgEIgCgCIgEgDIgBgDIgBgFQAAgGADgDQADgDAEAAIAEABIAFABIgCAJIgEgBIgBAAIgCAAIgBACIABACIACADIABABIABABIADACIACAFIAAAEIAAAHIgFAEQgCACgDAAIgFAAg");
	this.shape_29.setTransform(-99.15,-0.75);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFFFFF").s().p("AgJAVIAAgpIATAAIAAAJIgJAAIAAAHIAGAAIAAAIIgGAAIAAAIIAJAAIAAAJg");
	this.shape_30.setTransform(-101.25,-0.725);
	...
	this.shape_34.graphics.f("#FFFFFF").s().p("AgFAWIgEgCIACgJIADACIADAAIACgBIABgCIgBgCIgDgEIgBgCIgDgDIgCgDIgBgFQAAgGADgDQADgDAEAAIAEABIAFABIgCAJIgEgBIgBAAIgCAAIgBACIABACIACADIABABIABABIADACIACAFIABAEIgBAHIgFAEQgCACgDAAIgFAAg");
	this.shape_34.setTransform(-109.6,-0.75);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("");
	this.shape_18.setTransform(477.75,-247.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AhPFdIAAjGIiFnzIClAAIAwDpIAvjpIClAAIiFHzIAADGg");
	this.shape_19.setTransform(437.375,-246.95);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AAzFdIgMiIIhNAAIgNCIIicAAIBcq5IDnAAIBdK5gAAXBAIgUi6IgDg7IgDA7IgUC6IAuAAg");
	this.shape_20.setTransform(392.6,-246.95);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AAeFdIgemjIgdGjIjPAAIgzq5ICpAAIAIIXIAvoXICAAAIAuIXIAIoXICqAAIg1K5g");
	this.shape_21.setTransform(339.5,-246.95);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgBFdIgsm6IAAG6IihAAIAAq5IDSAAIArGvIAAmvICgAAIAAK5g");
	this.shape_22.setTransform(274.475,-246.95);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AABFoQhdgBgugyQgvgxAAhdIAAlMQABhiAxgwQAwgwBXABIABAAQBcAAAuAyQAuAyAABdIAAFMQgBBigvAvQgxAwhWAAgAgQjJQgFAIAAAQIAAFlQAAAPAFAHQAGAHAKAAIABAAQAKAAAGgIQAFgGAAgPIAAllQAAgQgFgIQgHgHgKAAIAAAAQgMAAgEAHg");
	this.shape_23.setTransform(230.15,-247.1003);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AhPFdIAAq5ICfAAIAAK5g");
	this.shape_24.setTransform(198.425,-246.95);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AiiFdIAAq5ICgAAIAAIcIClAAIAACdg");
	this.shape_25.setTransform(168.075,-246.95);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AiiFdIAAq5ICgAAIAAIcIClAAIAACdg");
	this.shape_26.setTransform(129.425,-246.95);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AhPFdIAAq5ICfAAIAAK5g");
	this.shape_27.setTransform(99.975,-246.95);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("ABzFdIAAoLIgHBQIgwG7Ih4AAIgvm7IgHhQIAAILIibAAIAAq5IDzAAIAXFKIADA0IAEg0IAZlKIDxAAIAAK5g");
	this.shape_28.setTransform(59.8,-246.95);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("AheFPQgpgZgWgsQgXgsgBg8IAAlDQABg7AXgtQAWgsApgZQAogYA2gBQA3ABApAYQApAZAWAsQAWAtAAA7IAAFDQAAA8gWAsQgWAsgpAZQgpAYg3ABQg2gBgogYgAgMjKQgFAFAAALIAAF3QAAAKAFAEQAEAEAFABIADABQASAAAAgUIAAl3QAAgKgEgFQgEgEgFgBIgFgCQgIAAgEAGg");
	this.shape_29.setTransform(-1.65,-247.125);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFFFFF").s().p("AgrFiIAAoJIhJAQIAAiVIDpg1IAALDg");
	this.shape_30.setTransform(-38.775,-247.475);
...
}).prototype = getMCSymbolPrototype(lib.hero_mc, new cjs.Rectangle(621,-410,1072.3,764), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(149.95,39.7,0.0598,0.0598,0,0,0,0,0.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(164).to({_off:false},0).wait(1).to({regX:422.4,regY:-186.1,x:175.2,y:28.45,alpha:0.0032},0).wait(1).to({y:28.4,alpha:0.0145},0).wait(1).to({y:28.35,alpha:0.0371},0).wait(1).to({y:28.2,alpha:0.077},0).wait(1).to({y:27.95,alpha:0.1467},0).wait(1).to({y:27.5,alpha:0.2672},0).wait(1).to({y:26.95,alpha:0.4164},0).wait(1).to({y:26.4,alpha:0.5648},0).wait(1).to({y:25.95,alpha:0.6887},0).wait(1).to({y:25.55,alpha:0.7859},0).wait(1).to({y:25.3,alpha:0.8625},0).wait(1).to({y:25.05,alpha:0.9229},0).wait(1).to({y:24.9,alpha:0.9628},0).wait(1).to({y:24.85,alpha:0.9857},0).wait(1).to({y:24.8,alpha:0.9969},0).wait(1).to({regX:0,regY:0.8,x:149.95,y:36,alpha:1},0).wait(1));

	// ticket
	this.instance_4 = new lib.ticket_mc();
	this.instance_4.setTransform(73.35,22.5,0.0831,0.0831);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(148).to({_off:false},0).wait(1).to({regX:-1090,regY:25.1,x:-17.05,y:24.6},0).wait(1).to({x:-16.15},0).wait(1).to({x:-14.45},0).wait(1).to({x:-11.4},0).wait(1).to({x:-6.05,y:24.65},0).wait(1).to({x:3.2,y:24.7},0).wait(1).to({x:14.6,y:24.75},0).wait(1).to({x:26,y:24.8},0).wait(1).to({x:35.5,y:24.85},0).wait(1).to({x:42.95,y:24.9},0).wait(1).to({x:48.8},0).wait(1).to({x:53.4,y:24.95},0).wait(1).to({x:56.5},0).wait(1).to({x:58.25},0).wait(1).to({x:59.1},0).wait(1).to({regX:0,regY:0,x:149.95,y:22.9},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(55).to({_off:false},0).wait(1).to({regX:218.4,regY:-190.4,x:172.4,y:24.4,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:24.35,alpha:0.0435},0).wait(1).to({y:24.25,alpha:0.0919},0).wait(1).to({y:24.05,alpha:0.1816},0).wait(1).to({y:23.75,alpha:0.3248},0).wait(1).to({y:23.4,alpha:0.4878},0).wait(1).to({y:23.1,alpha:0.6345},0).wait(1).to({y:22.85,alpha:0.7499},0).wait(1).to({y:22.65,alpha:0.8388},0).wait(1).to({y:22.5,alpha:0.9088},0).wait(1).to({y:22.4,alpha:0.9564},0).wait(1).to({y:22.35,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(20).to({regX:218.4,regY:-190.4,x:172.4,y:22.35,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:22.4,alpha:0.9565},0).wait(1).to({y:22.5,alpha:0.9081},0).wait(1).to({y:22.7,alpha:0.8184},0).wait(1).to({y:23,alpha:0.6752},0).wait(1).to({y:23.35,alpha:0.5122},0).wait(1).to({y:23.65,alpha:0.3655},0).wait(1).to({y:23.9,alpha:0.2501},0).wait(1).to({y:24.1,alpha:0.1612},0).wait(1).to({y:24.25,alpha:0.0912},0).wait(1).to({y:24.35,alpha:0.0436},0).wait(1).to({y:24.4,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).wait(77));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(97).to({_off:false},0).wait(1).to({regX:364.1,regY:-240.4,x:177.8,y:25.75,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:25.7,alpha:0.0435},0).wait(1).to({y:25.55,alpha:0.0919},0).wait(1).to({y:25.35,alpha:0.1816},0).wait(1).to({y:25.05,alpha:0.3248},0).wait(1).to({y:24.7,alpha:0.4878},0).wait(1).to({y:24.35,alpha:0.6345},0).wait(1).to({y:24.1,alpha:0.7499},0).wait(1).to({y:23.9,alpha:0.8388},0).wait(1).to({y:23.75,alpha:0.9088},0).wait(1).to({y:23.6,alpha:0.9564},0).wait(1).to({y:23.55,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0,regY:0.7,x:149.95,y:41.95,alpha:1},0).wait(37).to({regX:364.1,regY:-240.4,x:177.9,y:23.45,alpha:0.9968},0).wait(1).to({x:178.4,alpha:0.9855},0).wait(1).to({x:179.35,alpha:0.9629},0).wait(1).to({x:181,alpha:0.923},0).wait(1).to({x:183.9,y:23.4,alpha:0.8533},0).wait(1).to({x:188.95,y:23.35,alpha:0.7328},0).wait(1).to({x:195.2,y:23.25,alpha:0.5836},0).wait(1).to({x:201.4,y:23.2,alpha:0.4352},0).wait(1).to({x:206.6,y:23.15,alpha:0.3113},0).wait(1).to({x:210.65,y:23.1,alpha:0.2141},0).wait(1).to({x:213.85,y:23.05,alpha:0.1375},0).wait(1).to({x:216.4,y:23,alpha:0.0771},0).wait(1).to({x:218.05,alpha:0.0372},0).wait(1).to({x:219.05,alpha:0.0143},0).wait(1).to({x:219.5,alpha:0.0031},0).wait(1).to({regX:0,regY:0.7,x:191.8,y:41.45,alpha:0},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(40).to({_off:false},0).wait(1).to({regX:-568.6,regY:20.2,x:129.65,y:25.05,alpha:0.0037},0).wait(1).to({x:129.3,alpha:0.0167},0).wait(1).to({x:128.5,alpha:0.0435},0).wait(1).to({x:127.1,alpha:0.0919},0).wait(1).to({x:124.45,alpha:0.1816},0).wait(1).to({x:120.3,alpha:0.3248},0).wait(1).to({x:115.55,alpha:0.4878},0).wait(1).to({x:111.25,alpha:0.6345},0).wait(1).to({x:107.9,alpha:0.7499},0).wait(1).to({x:105.3,alpha:0.8388},0).wait(1).to({x:103.25,alpha:0.9088},0).wait(1).to({x:101.85,alpha:0.9564},0).wait(1).to({x:101.05,alpha:0.9834},0).wait(1).to({x:100.7,alpha:0.9964},0).wait(1).to({regX:0,regY:0.6,x:149.95,y:23.35,alpha:1},0).wait(94).to({regX:-568.6,regY:20.2,x:100.75,y:25.05,alpha:0.9968},0).wait(1).to({x:101.25,alpha:0.9855},0).wait(1).to({x:102.25,alpha:0.9629},0).wait(1).to({x:104,alpha:0.923},0).wait(1).to({x:107.05,y:25.1,alpha:0.8533},0).wait(1).to({x:112.3,y:25.15,alpha:0.7328},0).wait(1).to({x:118.85,y:25.2,alpha:0.5836},0).wait(1).to({x:125.35,y:25.25,alpha:0.4352},0).wait(1).to({x:130.75,y:25.3,alpha:0.3113},0).wait(1).to({x:135,y:25.35,alpha:0.2141},0).wait(1).to({x:138.35,alpha:0.1375},0).wait(1).to({x:141,y:25.4,alpha:0.0771},0).wait(1).to({x:142.75,alpha:0.0372},0).wait(1).to({x:143.75,alpha:0.0143},0).wait(1).to({x:144.25,alpha:0.0031},0).wait(1).to({regX:0.6,regY:0.6,x:193.7,y:23.75,alpha:0},0).wait(17));

	// lock_up
	this.instance_8 = new lib.lock_up_mc();
	this.instance_8.setTransform(116.25,14.7,0.0764,0.0764,0,0,0,0,0.7);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:-422.9,regY:131.8,x:84.1,y:24.7,alpha:0.0045},0).wait(1).to({x:83.85,alpha:0},0).wait(1).to({x:85.7,alpha:0.053},0).wait(1).to({x:89,alpha:0.1499},0).wait(1).to({x:92.4,alpha:0.2513},0).wait(1).to({x:95.85,alpha:0.3543},0).wait(1).to({x:99.35,alpha:0.4584},0).wait(1).to({x:102.85,alpha:0.5622},0).wait(1).to({x:106.25,alpha:0.6631},0).wait(1).to({x:109.4,alpha:0.7565},0).wait(1).to({x:112.1,alpha:0.8366},0).wait(1).to({x:114.2,alpha:0.8987},0).wait(1).to({x:115.7,alpha:0.9424},0).wait(1).to({x:116.65,alpha:0.9711},0).wait(1).to({x:117.25,alpha:0.9892},0).wait(1).to({regX:0,regY:0.7,x:149.95,y:14.7,alpha:1},0).wait(25).to({regX:-422.9,regY:131.8,x:117.5,y:24.7,alpha:0.9963},0).wait(1).to({x:117.05,alpha:0.9833},0).wait(1).to({x:116.1,alpha:0.9565},0).wait(1).to({x:114.35,alpha:0.9081},0).wait(1).to({x:111.15,alpha:0.8184},0).wait(1).to({x:106.05,alpha:0.6752},0).wait(1).to({x:100.25,alpha:0.5122},0).wait(1).to({x:95,alpha:0.3655},0).wait(1).to({x:90.9,alpha:0.2501},0).wait(1).to({x:87.7,alpha:0.1612},0).wait(1).to({x:85.25,alpha:0.0912},0).wait(1).to({x:83.55,alpha:0.0436},0).wait(1).to({x:82.55,alpha:0.0166},0).wait(1).to({x:82.1,alpha:0.0036},0).wait(1).to({regX:0.7,regY:0.7,x:114.3,y:14.7,alpha:0},0).to({_off:true},1).wait(125));

	// hero_image
	this.instance_9 = new lib.hero_mc();
	this.instance_9.setTransform(220.7,36.8,0.0878,0.0878,0,0,0,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:1157.2,regY:-28,x:321.85,y:34.3},0).wait(1).to({x:322.3,y:34.25},0).wait(1).to({x:318.45,y:34.3},0).wait(1).to({x:311.6,y:34.4},0).wait(1).to({x:304.4,y:34.45},0).wait(1).to({x:297.15,y:34.5},0).wait(1).to({x:289.8,y:34.6},0).wait(1).to({x:282.45,y:34.65},0).wait(1).to({x:275.35,y:34.75},0).wait(1).to({x:268.75,y:34.8},0).wait(1).to({x:263.05,y:34.85},0).wait(1).to({x:258.7,y:34.9},0).wait(1).to({x:255.6,y:34.95},0).wait(1).to({x:253.55},0).wait(1).to({x:252.3},0).wait(1).to({regX:0.6,regY:0.6,x:150.05,y:37.5},0).wait(165));
...
p.nominalBounds = new cjs.Rectangle(74.9,18.4,294.4,50.199999999999996);
// library properties:
lib.properties = {
