...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AgYDBQgLgEgIgKQgGgKgBgQQABgUAOgMQAOgMAVAAQAWAAAOAMQAOAMABAUQgBAQgGAKQgIAKgLAEQgMAFgNAAQgMAAgMgFgAgrBDIAAkIIBYAAIAAEIg");
	this.shape.setTransform(68.35,-13.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhNCuQgagbAAg2IAAi5QABgiAPgYQAOgZAagNQAbgMAggBQAXAAAYAHQAYAGAVAMIggBNQgLgGgNgDQgNgDgMAAQgSAAgIAKQgJAJABAUIAACrQAAAKADAEQAEAEAGAAIAHgBIADgBIAAiMIBVAAIAADGQgQAKgOAGQgPAGgPAEQgPADgTAAQg1AAgbgcg");
	this.shape_1.setTransform(48.025,-13.425);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgsDEIAAmHIBZAAIAAGHg");
	this.shape_2.setTransform(30.275,-13.35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhoDEIAAmHIBjAAQAeAAAYAKQAYAKAOAVQANAWAAAhIAAAKQAAAdgJAUQgJATgXAJQAYAIAKATQAMAUAAAhIAAAYQAAAigOAXQgMAXgXAMQgXALgfABgAgOBuIAFAAQALABAEgGQAEgFAAgLIAAgmQAAgLgEgGQgDgGgMAAIgFAAgAgOgrIAHAAQALAAAEgFQADgGAAgKIAAgYQAAgKgDgGQgEgGgLAAIgHAAg");
	this.shape_3.setTransform(12.65,-13.35);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAADEIgZj4IAAD4IhaAAIAAmHIB1AAIAYDxIAAjxIBaAAIAAGHg");
	this.shape_4.setTransform(-18.525,-13.35);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgsDEIAAmHIBZAAIAAGHg");
	this.shape_5.setTransform(-37.475,-13.35);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AARDEIgRjqIgQDqIhzAAIgemHIBgAAIAEEsIAaksIBHAAIAaEsIAFksIBeAAIgdGHg");
	this.shape_6.setTransform(-60.5,-13.35);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FEE400").s().p("AhLBSIA1ijIBiAAIhLCjg");
	this.shape_7.setTransform(131.3,-50.55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FEE400").s().p("AAQDEIgeiWIgHAAIAACWIhZAAIAAmHIBgAAQArAAAXAOQAZAOAJAYQALAYgBAhIAAAcQAAAegIAVQgHATgOALIAsCtgAgVgZIAFAAQALAAAFgFQAFgFgBgOIAAglQABgMgFgHQgEgFgMAAIgFAAg");
	this.shape_8.setTransform(112.6,-69.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FEE400").s().p("AhVDEIAAmHICqAAIAABUIhSAAIAABDIBDAAIAABSIhDAAIAABKIBTAAIAABUg");
	this.shape_9.setTransform(90.9,-69.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FEE400").s().p("AhnDEIAAmHIBiAAQAeAAAYAKQAYAKAOAVQANAVAAAjIAAAJQABAdgKATQgKAUgWAJQAYAIALATQAKATABAiIAAAYQgBAigNAXQgMAXgXALQgXANgfAAgAgOBuIAFAAQALAAAEgFQAEgFAAgKIAAgoQAAgKgEgGQgEgFgLgBIgFAAgAgOgrIAHAAQALABADgHQAEgFAAgKIAAgYQAAgLgEgFQgDgGgLAAIgHAAg");
	this.shape_10.setTransform(69.1,-69.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FEE400").s().p("ABADEIAAklIgEAtIgbD4IhCAAIgbj4IgEgtIAAElIhWAAIAAmHICIAAIANC6IABAcIACgcIAOi6ICHAAIAAGHg");
	this.shape_11.setTransform(40.675,-69.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FEE400").s().p("AhWDEIAAmHICrAAIAABUIhSAAIAABDIBDAAIAABSIhDAAIAABKIBTAAIAABUg");
	this.shape_12.setTransform(14.95,-69.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FEE400").s().p("AANDKQg3gBgcgeQgcgeAAg5IAAinQAAg6AcgeQAcgdA3AAIABAAQAWAAATADQATAFASAIIggBIIgQgEIgPgBIgBAAQgSAAgJALQgIALAAAVIAACVQABAVAKAKQALALASAAIAAAAQAJAAAIgBQAIgBAJgEIAgBHQgUAKgUAEQgUAFgZABg");
	this.shape_13.setTransform(-4.525,-69.95);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FEE400").s().p("AhVDEIAAmHICrAAIAABUIhTAAIAABDIBDAAIAABSIhDAAIAABKIBUAAIAABUg");
	this.shape_14.setTransform(-25.05,-69.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FEE400").s().p("AhnDEIAAmHIBgAAQAfABAZAOQAZANAPAaQAOAaAAAkIAACdQAAAlgOAZQgPAbgZAOQgZAPgeAAgAgNBuIAEAAQAMABAEgHQAEgGAAgQIAAioQAAgPgGgFQgFgEgJAAIgEAAg");
	this.shape_15.setTransform(-46.95,-69.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FEE400").s().p("");
	this.shape_16.setTransform(-75.225,-69.975);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FEE400").s().p("AgsDEIAAmHIBZAAIAAGHg");
	this.shape_17.setTransform(-91.325,-69.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FEE400").s().p("AAMDEIAAibIgXAAIAACbIhaAAIAAmHIBaAAIAACUIAXAAIAAiUIBaAAIAAGHg");
	this.shape_18.setTransform(-108.95,-69.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FEE400").s().p("AgsDEIAAkuIg3AAIAAhZIDHAAIAABZIg3AAIAAEug");
	this.shape_19.setTransform(-130.325,-69.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-142.2,-100.7,284.5,129.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:-0.7,regY:-41.7,x:146.7,y:509.8,alpha:0.0037},0).wait(1).to({y:509.55,alpha:0.0167},0).wait(1).to({y:509.05,alpha:0.0435},0).wait(1).to({y:508.15,alpha:0.0919},0).wait(1).to({y:506.45,alpha:0.1816},0).wait(1).to({y:503.8,alpha:0.3248},0).wait(1).to({y:500.75,alpha:0.4878},0).wait(1).to({y:498,alpha:0.6345},0).wait(1).to({y:495.8,alpha:0.7499},0).wait(1).to({y:494.15,alpha:0.8388},0).wait(1).to({y:492.85,alpha:0.9088},0).wait(1).to({y:491.95,alpha:0.9564},0).wait(1).to({y:491.45,alpha:0.9834},0).wait(1).to({y:491.2,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:147.35,y:530.25,alpha:1},0).wait(69).to({regX:-0.7,regY:-41.7,x:146.7,y:491.2,alpha:0.9963},0).wait(1).to({y:491.45,alpha:0.9833},0).wait(1).to({y:491.95,alpha:0.9565},0).wait(1).to({y:492.85,alpha:0.9081},0).wait(1).to({y:494.55,alpha:0.8184},0).wait(1).to({y:497.2,alpha:0.6752},0).wait(1).to({y:500.25,alpha:0.5122},0).wait(1).to({y:503,alpha:0.3655},0).wait(1).to({y:505.2,alpha:0.2501},0).wait(1).to({y:506.85,alpha:0.1612},0).wait(1).to({y:508.15,alpha:0.0912},0).wait(1).to({y:509.05,alpha:0.0436},0).wait(1).to({y:509.55,alpha:0.0166},0).wait(1).to({y:509.8,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:147.35,y:549,alpha:0},0).to({_off:true},1).wait(169));
