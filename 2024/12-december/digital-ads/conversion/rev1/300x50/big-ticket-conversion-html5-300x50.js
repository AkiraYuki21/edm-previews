...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AhLJOQgigOgWgfQgVgegBgwQABg/ArgjQArgkBCgBQBDABArAkQArAjABA/QAAAwgWAeQgWAfgiAOQgjAOgpAAQgoAAgjgOgAiHDNIAAsoIEQAAIAAMog");
	this.shape.setTransform(335.725,1.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AjsITQhQhUABijIAAo1QAAhpAuhKQAuhKBOgoQBQgnBlAAQBFAABJATQBJAUBBAjIhiDrQgigSgmgJQgngKgnAAQg2AAgaAdQgaAdACA9IAAILQAAAeAKANQALANAUAAQANAAAIgEIAKgEIAAmtIECAAIAAJgQgxAcgrATQgrAUguAJQguAKg6AAQilAAhQhTg");
	this.shape_1.setTransform(273.9744,0.15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiIJUIAAynIERAAIAASng");
	this.shape_2.setTransform(219.775,0.325);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ak+JUIAAynIEsAAQBdAABKAeQBJAeAqBBQApBAABBnIAAAeQAABZgdA7QgdA6hEAdQBGAYAjA8QAiA8AABmIAABIQgBBngmBHQgoBGhFAkQhGAkhfAAgAgsFSIAQAAQAiAAANgSQALgQAAgfIAAh2QAAghgLgSQgLgRgkAAIgQAAgAgsiEIAVAAQAhAAAMgRQANgRgBgeIAAhJQABghgMgRQgLgRgjAAIgVAAg");
	this.shape_3.setTransform(166.15,0.325);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgDJUIhMryIAALyIkRAAIAAynIFoAAIBILhIAArhIERAAIAASng");
	this.shape_4.setTransform(71.15,0.325);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AiIJUIAAynIERAAIAASng");
	this.shape_5.setTransform(13.425,0.325);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA0JUIg0rMIgzLMIlgAAIhYynIEhAAIAOOTIBPuTIDbAAIBPOTIAOuTIEhAAIhYSng");
	this.shape_6.setTransform(-56.75,0.325);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FEE400").s().p("AjmD6ICfnzIEuAAIjlHzg");
	this.shape_7.setTransform(403.075,-102.825);
	...
	this.shape_8.setTransform(346.025,-161.825);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FEE400").s().p("AkHJUIAAynIIMAAIAAD+Ij7AAIAADLIDMAAIAAD/IjMAAIAADhID+AAIAAD+g");
	this.shape_9.setTransform(279.875,-161.825);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FEE400").s().p("Ak+JUIAAynIEsAAQBeAABJAeQBJAeAqBBQApBAABBnIAAAeQABBZgeA7QgdA6hFAdQBHAYAjA8QAiA8AABmIAABIQgBBngnBHQgnBGhFAkQhGAkhfAAgAgtFSIARAAQAiAAAMgSQAMgQAAgfIAAh2QABghgMgSQgMgRgjAAIgRAAgAgtiEIAWAAQAhAAANgRQAMgRgBgeIAAhJQABghgLgRQgMgRgjAAIgWAAg");
	this.shape_10.setTransform(213.55,-161.825);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FEE400").s().p("ADDJUIAAt8IgLCIIhRL0IjOAAIhRr0IgLiIIAAN8IkJAAIAAynIGfAAIAnI0IAGBaIAHhaIAqo0IGcAAIAASng");
	this.shape_11.setTransform(126.9,-161.825);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FEE400").s().p("AkHJUIAAynIIMAAIAAD+Ij7AAIAADLIDMAAIAAD/IjMAAIAADhID+AAIAAD+g");
	this.shape_12.setTransform(48.525,-161.825);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FEE400").s().p("AAoJmQipAAhWhbQhWhbAAixIAAn9QAAiwBWhcQBWhbCpAAIABAAQBGAAA5ANQA7ALA1AZIhiDbQgXgGgagDQgZgEgVABIgCAAQg2gBgbAiQgaAhAABAIAAHHQAABAAiAhQAhAiA4gBIABAAQAZAAAYgEQAZgGAcgLIBiDaQg8Aeg+AOQg/APhMAAg");
	this.shape_13.setTransform(-10.8,-162);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FEE400").s().p("AkHJUIAAynIIMAAIAAD+Ij7AAIAADLIDMAAIAAD/IjMAAIAADhID+AAIAAD+g");
	this.shape_14.setTransform(-73.375,-161.825);
	...
	this.shape_15.setTransform(-140.075,-161.825);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:127.3,regY:-162,x:162.9,y:27.4,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.35,alpha:0.0435},0).wait(1).to({y:27.25,alpha:0.0919},0).wait(1).to({y:27.05,alpha:0.1816},0).wait(1).to({y:26.75,alpha:0.3248},0).wait(1).to({y:26.4,alpha:0.4878},0).wait(1).to({y:26.1,alpha:0.6345},0).wait(1).to({y:25.85,alpha:0.7499},0).wait(1).to({y:25.65,alpha:0.8388},0).wait(1).to({y:25.5,alpha:0.9088},0).wait(1).to({y:25.4,alpha:0.9564},0).wait(1).to({y:25.35,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(61).to({regX:127.3,regY:-162,x:162.9,y:25.35,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25.4,alpha:0.9565},0).wait(1).to({y:25.5,alpha:0.9081},0).wait(1).to({y:25.7,alpha:0.8184},0).wait(1).to({y:26,alpha:0.6752},0).wait(1).to({y:26.35,alpha:0.5122},0).wait(1).to({y:26.65,alpha:0.3655},0).wait(1).to({y:26.9,alpha:0.2501},0).wait(1).to({y:27.1,alpha:0.1612},0).wait(1).to({y:27.25,alpha:0.0912},0).wait(1).to({y:27.35,alpha:0.0436},0).wait(1).to({y:27.4,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).to({_off:true},1).wait(177));
...
p.nominalBounds = new cjs.Rectangle(74.9,17.9,228.20000000000002,39.5);
// library properties:
lib.properties = {
