...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AgRCOQgJgEgEgHQgGgHAAgMQABgPAKgIQAKgJAPAAQAQAAAKAJQALAIAAAPQAAAMgFAHQgGAHgHAEQgJADgKAAQgIAAgJgDgAgfAxIAAjBIBAAAIAADBg");
	this.shape.setTransform(32.4,20.275);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAACPIgSi0IAAC0IhCAAIAAkdIBWAAIARCwIAAiwIBCAAIAAEdg");
	this.shape_1.setTransform(16.075,20.075);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AggCPIAAkdIBBAAIAAEdg");
	this.shape_2.setTransform(2.175,20.075);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AANCPIgNirIgLCrIhVAAIgVkdIBFAAIAEDbIATjbIA0AAIATDbIADjbIBFAAIgVEdg");
	this.shape_3.setTransform(-14.725,20.075);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FEE400").s().p("Ag3A8IAnh3IBIAAIg3B3g");
	this.shape_4.setTransform(126,-5.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FEE400").s().p("AAvCPIAAjVIgDAgIgTC1IgxAAIgTi1IgDggIAADVIhAAAIAAkdIBkAAIAJCHIABAVIACgVIAKiHIBjAAIAAEdg");
	this.shape_5.setTransform(109.375,-19.475);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FEE400").s().p("AAVCPIgFg4IgfAAIgFA4IhAAAIAlkdIBfAAIAmEdgAAJAaIgIhMIgBgXIgBAXIgIBMIASAAg");
	this.shape_6.setTransform(88,-19.475);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FEE400").s().p("Ag+CPIAAkdIB9AAIAAA9Ig9AAIAAAxIAyAAIAAA8IgyAAIAAA2IA9AAIAAA9g");
	this.shape_7.setTransform(72.025,-19.475);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FEE400").s().p("AAMCPIgWhtIgFAAIAABtIhBAAIAAkdIBGAAQAfAAASAKQARAKAIARQAGASAAAYIAAAVQAAAWgFAPQgGAOgKAIIAhB+gAgPgSIADAAQAJAAADgEQADgDAAgKIAAgcQAAgJgDgEQgDgEgJAAIgDAAg");
	this.shape_8.setTransform(55.45,-19.475);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FEE400").s().p("AhLCPIAAkdIBHAAQAWAAASAKQASAKALATQALATAAAaIAABzQAAAbgLATQgLATgSALQgSAKgWAAgAgJBRIACAAQAKAAACgEQADgFAAgMIAAh6QAAgMgEgDQgEgDgHAAIgCAAg");
	this.shape_9.setTransform(37.625,-19.475);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FEE400").s().p("AggCPIAAjcIgoAAIAAhBICRAAIAABBIgoAAIAADcg");
	this.shape_10.setTransform(16.9,-19.475);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FEE400").s().p("");
	this.shape_11.setTransform(1.975,-19.525);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FEE400").s().p("AgmCJQgRgIgKgRQgKgQAAgaIAAjWIBDAAIAADXQAAAGACADQACADAEAAQAFAAACgDQACgDAAgGIAAjXIBDAAIAADWQAAAWgIARQgJARgQAJQgRAKgZAAQgWAAgRgIg");
	this.shape_12.setTransform(-14.475,-19.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FEE400").s().p("AgiCNQgRgFgRgIIAYg6IAPAHQAHACAHAAQAKAAAEgFQADgHAAgMIAAjIIBDAAIAADTQAAAmgUAUQgUAVgiABQgNgBgQgEg");
	this.shape_13.setTransform(-31.825,-19.25);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FEE400").s().p("AggCPIAAjcIgoAAIAAhBICRAAIAABBIgoAAIAADcg");
	this.shape_14.setTransform(-50.5,-19.475);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FEE400").s().p("AgSA9IgMh6IA9AAIgLB6g");
	this.shape_15.setTransform(-62.575,-27.65);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FEE400").s().p("AAACPIgSi0IAAC0IhCAAIAAkdIBWAAIARCwIAAiwIBCAAIAAEdg");
	this.shape_16.setTransform(-76.625,-19.475);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FEE400").s().p("AAACTQglAAgTgUQgTgVAAgmIAAiHQAAgoAUgUQAUgUAjABIAAAAQAmAAATAUQATAVAAAmIAACHQAAAogUAUQgUATgjAAgAgGhSQgCADAAAHIAACSQAAAGACADQACADAEAAIAAAAQAFAAACgDQACgDAAgGIAAiSQAAgHgCgDQgDgDgEAAIAAAAQgEAAgCADg");
	this.shape_17.setTransform(-94.825,-19.5256);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FEE400").s().p("AhLCPIAAkdIBHAAQAWAAASAKQASAKALATQALATAAAaIAABzQAAAbgLATQgLATgSALQgSAKgWAAgAgJBRIACAAQAKAAACgEQADgFAAgMIAAh6QAAgMgEgDQgEgDgHAAIgCAAg");
	this.shape_18.setTransform(-112.125,-19.475);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-122.2,-42.2,256.5,93.30000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:5.9,regY:0.3,x:163.05,y:425.85,alpha:0.0037},0).wait(1).to({y:425.6,alpha:0.0167},0).wait(1).to({y:425.05,alpha:0.0435},0).wait(1).to({y:424.05,alpha:0.0919},0).wait(1).to({y:422.2,alpha:0.1816},0).wait(1).to({x:163,y:419.2,alpha:0.3248},0).wait(1).to({y:415.85,alpha:0.4878},0).wait(1).to({x:162.95,y:412.8,alpha:0.6345},0).wait(1).to({y:410.45,alpha:0.7499},0).wait(1).to({x:162.9,y:408.6,alpha:0.8388},0).wait(1).to({y:407.15,alpha:0.9088},0).wait(1).to({y:406.2,alpha:0.9564},0).wait(1).to({y:405.6,alpha:0.9834},0).wait(1).to({y:405.35,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:157,y:405,alpha:1},0).wait(68).to({x:157.2,y:405.65},0).wait(1).to({regX:5.9,regY:0.3,x:163.1,y:406,alpha:0.9963},0).wait(1).to({y:406.25,alpha:0.9833},0).wait(1).to({y:406.8,alpha:0.9565},0).wait(1).to({y:407.75,alpha:0.9081},0).wait(1).to({y:409.55,alpha:0.8184},0).wait(1).to({y:412.4,alpha:0.6752},0).wait(1).to({y:415.7,alpha:0.5122},0).wait(1).to({y:418.6,alpha:0.3655},0).wait(1).to({y:420.9,alpha:0.2501},0).wait(1).to({y:422.7,alpha:0.1612},0).wait(1).to({y:424.1,alpha:0.0912},0).wait(1).to({y:425.05,alpha:0.0436},0).wait(1).to({y:425.6,alpha:0.0166},0).wait(1).to({y:425.85,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:157.2,y:425.65,alpha:0},0).to({_off:true},1).wait(169));
