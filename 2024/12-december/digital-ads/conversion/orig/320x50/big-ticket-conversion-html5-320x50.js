...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(513.775,-73.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgEKKIhSs3IAAM3IkqAAIAA0TIGIAAIBPMjIAAsjIEqAAIAAUTg");
	this.shape_1.setTransform(439.6,-74.625);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiUKKIAA0TIEpAAIAAUTg");
	this.shape_2.setTransform(376.625,-74.625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AA4KKIg4sNIg3MNImAAAIhh0TIE8AAIAPPmIBWvmIDwAAIBWPmIAOvmIE8AAIhgUTg");
	this.shape_3.setTransform(300.025,-74.625);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FEE400").s().p("Aj7EQICuofIFJAAIj5Ifg");
	this.shape_4.setTransform(191.675,-10.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FEE400").s().p("ADVKKIAAvNIgNCUIhYM5IjgAAIhYs5IgNiUIAAPNIkhAAIAA0TIHFAAIArJnIAGBjIAIhjIAupnIHBAAIAAUTg");
	this.shape_5.setTransform(116.175,-74.625);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FEE400").s().p("ABgKKIgYj+IiPAAIgYD+IkkAAICs0TIGvAAICsUTgAArB3IgklcIgHhsIgGBsIgkFcIBVAAg");
	this.shape_6.setTransform(19.175,-74.625);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FEE400").s().p("AkfKKIAA0TII7AAIAAEVIkRAAIAADeIDfAAIAAEVIjfAAIAAD2IEVAAIAAEVg");
	this.shape_7.setTransform(-53.275,-74.625);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FEE400").s().p("AA2KKIhnnwIgVAAIAAHwIkrAAIAA0TIFAAAQCQABBRAtQBQAsAgBRQAgBQgBBtIAABdQAABlgZBDQgZBDgvAnICTI8gAhGhVIAOAAQAmABARgSQAQgRgBgsIAAh+QABgpgQgTQgPgTgoABIgOAAg");
	this.shape_8.setTransform(-128.55,-74.625);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FEE400").s().p("AlXKKIAA0TIE/AAQBpABBTAuQBTAuAvBWQAxBVABB3IAAINQgBB5gvBXQgxBXhSAwQhTAvhoABgAgsFwIALAAQAsABANgVQAOgVgBg2IAAowQgBgygQgQQgSgQgjACIgLAAg");
	this.shape_9.setTransform(-209.5,-74.625);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FEE400").s().p("AiUKKIAAvtIi3AAIAAkmIKWAAIAAEmIi2AAIAAPtg");
	this.shape_10.setTransform(443.5,-265.475);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FEE400").s().p("");
	this.shape_11.setTransform(375.575,-265.75);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FEE400").s().p("AixJtQhOgkgthOQgshLgBh1IAAvMIExAAIAAPUQAAAdAKAOQALAMAVAAQAUAAAKgOQAJgNAAgcIAAvUIEwAAIAAPMQAABogmBMQglBNhNArQhMAqhyABQhnAAhNglg");
	this.shape_12.setTransform(300.8,-264.65);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FEE400").s().p("AifJ/QhLgUhNgpIBrkBQAmAUAgALQAgAJAdABQAugBASgbQASgcgBg6IAAuLIEwAAIAAO9QgBCrhaBfQhaBeibACQg9AAhKgVg");
	this.shape_13.setTransform(222.2,-264.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FEE400").s().p("AiUKKIAAvtIi3AAIAAkmIKXAAIAAEmIi3AAIAAPtg");
	this.shape_14.setTransform(137.3,-265.475);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FEE400").s().p("AhWEXIg3otIEbAAIg2Itg");
	this.shape_15.setTransform(82.675,-302.55);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FEE400").s().p("AgDKKIhSs3IAAM3IkrAAIAA0TIGIAAIBPMjIAAsjIEqAAIAAUTg");
	this.shape_16.setTransform(18.8,-265.475);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FEE400").s().p("AABKdQisgBhWhcQhXhdAAisIAAprQABi3BahYQBchaChABIACAAQCrABBWBdQBWBcAACuIAAJrQgBC1haBZQhZBYihAAgAgfl2QgJAOABAdIAAKZQAAAdAJAOQAKAMAUAAIABAAQAVAAAKgNQAIgOABgcIAAqZQgBgegJgNQgLgOgUAAIgBAAQgWAAgIAOg");
	this.shape_17.setTransform(-63.75,-265.7505);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FEE400").s().p("AlXKKIAA0TIFAAAQBoABBTAuQBTAuAvBWQAxBVABB3IAAINQgBB5gwBXQgwBXhSAwQhTAvhoABgAgtFwIAMAAQAsABANgVQAOgVgCg2IAAowQAAgygQgQQgSgQgjACIgMAAg");
	this.shape_18.setTransform(-142.3,-265.475);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-575.3,-365.1,1446.6999999999998,427), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:143.4,regY:-157.9,x:174.6,y:27.8,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.75,alpha:0.0435},0).wait(1).to({y:27.65,alpha:0.0919},0).wait(1).to({y:27.45,alpha:0.1816},0).wait(1).to({y:27.15,alpha:0.3248},0).wait(1).to({y:26.8,alpha:0.4878},0).wait(1).to({y:26.5,alpha:0.6345},0).wait(1).to({y:26.25,alpha:0.7499},0).wait(1).to({y:26.05,alpha:0.8388},0).wait(1).to({y:25.9,alpha:0.9088},0).wait(1).to({y:25.8,alpha:0.9564},0).wait(1).to({y:25.75,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(69).to({regX:143.4,regY:-157.9,x:174.6,y:25.75,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25.8,alpha:0.9565},0).wait(1).to({y:25.9,alpha:0.9081},0).wait(1).to({y:26.1,alpha:0.8184},0).wait(1).to({y:26.4,alpha:0.6752},0).wait(1).to({y:26.75,alpha:0.5122},0).wait(1).to({y:27.05,alpha:0.3655},0).wait(1).to({y:27.3,alpha:0.2501},0).wait(1).to({y:27.5,alpha:0.1612},0).wait(1).to({y:27.65,alpha:0.0912},0).wait(1).to({y:27.75,alpha:0.0436},0).wait(1).to({y:27.8,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).to({_off:true},1).wait(169));
