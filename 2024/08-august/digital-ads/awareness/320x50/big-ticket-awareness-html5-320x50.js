...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAlKKIAAqUQAAgZgKgLQgKgNgVAAIgPABIgRACIAALCIkbAAIAA0TIEbAAIAAFGIAagCIAZAAQCSgBBPBGQBQBGABCZIAAKrg");
	this.shape.setTransform(439.8,-72.475);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AC3JXQiRAAhNgiQhPgigdhBQgehCACheIAAmAIhVAAIAAkAIBVAAIAAkHIEaAAIAAEHICYAAIAAEAIiYAAIAAE3QgBA7AbAVQAdAVBEgCIAfAAIAAELg");
	this.shape_1.setTransform(370.475,-67.35);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAlHoIAAqUQAAgZgKgLQgKgNgVAAIgQABIgQACIAALCIkcAAIAAuSQBegdBXgPQBYgRBCAAQCSgBBPBGQBPBGACCZIAAKrg");
	this.shape_2.setTransform(302.8,-56.2757);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AACHwIgBAAQibABhRhYQhRhXgBi2IAAkYQABi2BRhXQBRhXCbABIABAAQCagBBQBXQBRBXABC2IAAEYQgBC2hRBXQhQBXiYAAIgCAAgAgbjSQgIATAAAqIAAErQAAAqAIATQAIASAUAAIABAAQATgBAIgTQAHgTAAgoIAAkrQAAgpgHgTQgIgTgTgBIgBAAQgUAAgIATg");
	this.shape_3.setTransform(227.725,-55.4504);
	...
	this.shape_4.setTransform(136.075,-72.475);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(27.6014,-55.1562);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AiNKlIAAulIEbAAIAAOlgAhimjQghgoAAhIQAAhDAhgnQAigmA/gBQA9ABAiAmQAiAnAABDQAABIgiAoQgiAng9AAQg/AAgigng");
	this.shape_6.setTransform(-26.425,-75.225);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAlKKIAAqUQAAgZgKgLQgKgNgVAAIgPABIgRACIAALCIkcAAIAA0TIEcAAIAAFGIAbgCIAYAAQCSgBBPBGQBQBGABCZIAAKrg");
	this.shape_7.setTransform(-85.45,-72.475);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AiUKKIAAvtIi2AAIAAkmIKVAAIAAEmIi2AAIAAPtg");
	this.shape_8.setTransform(-157.85,-72.475);
	...
	this.shape_9.setTransform(328.5252,-235.6504);
	...
	this.shape_10.setTransform(271.075,-272.725);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFE400").s().p("AlbKKIAA0TIFHAAQBnAABQAgQBPAhAuBHQAtBGABBxIAAAgQABBhghBAQgfA/hLAgQBOAbAlBBQAlBBAABvIAABPQgBBxgqBNQgrBNhMAnQhMAnhoAAgAgxFwIASAAQAlAAAOgTQANgSgBghIAAiBQABgkgMgTQgNgTgnAAIgSAAgAgxiQIAXAAQAlAAANgTQAOgSgBgiIAAhPQABgkgMgSQgNgTgnAAIgXAAg");
	this.shape_11.setTransform(211.7,-269.975);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFE400").s().p("AAlHoIAAqUQAAgZgKgLQgKgNgVAAIgRABIgPACIAALCIkbAAIAAuSQBdgdBYgPQBXgRBBAAQCTgBBPBGQBPBGABCZIAAKrg");
	this.shape_12.setTransform(112.85,-253.7757);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("");
	this.shape.setTransform(482.7505,-71.2995);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("AifEwQhIhEgBiPIAAjHQgBiIA7hBQA8hBB7ABQBzgBA3BBQA2BBAACHIAACrIj+AAIAAAmQAAAgAYATQAZATAzABQAWAAAcgEQAegDAWgGIATDBQgvAKgpAEQgoAFgeAAIgBAAQiAAAhIhEgAgOiuQgGANAAAfIAAA3IA1AAIAAg3QABgfgGgNQgGgOgPABIgBgBQgOAAgGAOg");
	this.shape_1.setTransform(430.85,-71.5006);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("AjUFeIAAjGIDBkuIixAAIAAjHIGOAAIAADFIi9EvIDHAAIAADHg");
	this.shape_2.setTransform(380.8,-70.575);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("AhpH8IAAq7IDTAAIAAK7gAhJk7QgZgcAAg2QAAgzAZgdQAZgdAvgBQAuABAZAdQAaAdAAAzQAAA2gaAcQgZAeguAAQgvAAgZgeg");
	this.shape_3.setTransform(340.475,-86.35);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("AivFuIAAq9QApgLA+gKQA/gIBFgBIBzAAIAADIIhzAAIgUAAIgQABIAAISg");
	this.shape_4.setTransform(306.3,-72.125);
	...
	this.shape_5.setTransform(255.7544,-84.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("AAcHnIAAnuQAAgTgIgJQgHgJgQAAIgLABIgNABIAAIRIjUAAIAAvNIDUAAIAAD0IAUgBIASAAQBugBA7A0QA8A0AABzIAAIAg");
	this.shape_6.setTransform(182.075,-84.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("");
	this.shape_7.setTransform(128.8005,-71.2995);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFE400").s().p("Ai2E7Qg4g5AAhoIAAgLQAAhpA4g2QA5g4BzgBIAQAAIAWACIAAgcQABgqgVgQQgTgQg1ABQggAAgnAJQgnAJgnAPIA5jPQAKgEAYgGQAYgFAfgFQAegFAbAAQBdAAA3AbQA3AbAXA3QAXA2AABTIAAHKQhBAQg9ALQg9ALg+ABQhzgBg5g4gAgNBPQgNAMgBAbIAAATQABAeANANQANANAQAAIAMAAIAAh/IgMAAQgQAAgNANg");
	this.shape_8.setTransform(75.0255,-71.45);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFE400").s().p("AAhH2QiKAAhHhKQhGhLAAiRIAAmfQAAiRBGhLQBHhKCKAAIABAAQA5AAAvAKQAvAKAsAUIhRCzQgSgFgVgDQgVgCgQAAIgCAAQgsAAgXAbQgVAbAAA0IAAF1QABA0AbAbQAbAbAtAAIABAAQAVAAATgEQAVgEAXgKIBQCzQgyAYgyANQgzALg+AAg");
	this.shape_9.setTransform(24.05,-84.425);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFE400").s().p("AgNHmQgbAAgigFQgigEgdgGQgegGgRgEIg4jPQAwAPAwAJQAwAKAhAAQAiAAAVgFQATgFAIgWQAIgUAAgvIgSABIgSAAQg+ABg0gVQg0gVgggzQgfgygChXIAAm+IDWAAIAAG4QABASAHAKQAHAJAPAAIAMgBIALgCIABjvIAAjrIDVAAIAAK0QAACRg9BEQg8BCiBAAIgEAAg");
	this.shape_10.setTransform(-48.7498,-56.9993);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFE400").s().p("AhpHnIAAvNIDTAAIAAPNg");
	this.shape_11.setTransform(-93.175,-84.275);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFE400").s().p("AhpH8IAAq7IDTAAIAAK7gAhJk7QgZgcAAg2QAAgzAZgdQAZgdAvgBQAuABAZAdQAaAdAAAzQAAA2gaAcQgZAeguAAQgvAAgZgeg");
	this.shape_12.setTransform(-124.075,-86.35);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFE400").s().p("Ai2E7Qg4g5AAhoIAAgLQAAhpA4g2QA5g4BzgBIAQAAIAWACIAAgcQABgqgVgQQgTgQg1ABQggAAgnAJQgnAJgnAPIA5jPQAKgEAYgGQAYgFAfgFQAegFAbAAQBdAAA3AbQA3AbAXA3QAXA2AABTIAAHKQhBAQg9ALQg9ALg+ABQhzgBg5g4gAgNBPQgNAMgBAbIAAATQABAeANANQANANAQAAIAMAAIAAh/IgMAAQgQAAgNANg");
	this.shape_13.setTransform(-168.1745,-71.45);
	...
	this.shape_14.setTransform(-225.075,-84.275);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AAiHnIhOkrIAAErIjUAAIAAvNIDUAAIAAIdIBCkJIDYAAIhoFAIB7F5g");
	this.shape_15.setTransform(279.25,-225.425);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AiFHTQg4giggg+Qgfg9AAhUIAAnDQAAhTAfg/QAgg9A4gjQA5ghBMgBQBMABA6AhQA4AjAfA9QAgA/ABBTIAAHDQgBBUggA9QgfA+g4AiQg6AihMABQhMgBg5gigAgSkbQgGAIAAAOIAAIMQAAAOAGAGQAGAGAGACQAGACAAgBQAZAAAAgdIAAoMQgBgNgFgHQgGgGgHgCIgGgBQgMAAgGAHg");
	this.shape_16.setTransform(219.8,-225.65);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AiAHfQg9gPg4gfIBQi0QAVARAfALQAeANAoABQAigBAOgYQAOgYgBglIAAhQQABgagJgaQgIgagXgQQgXgRgvgBQgfABgcAKQgdAKgVAMIA5ofIFzAAIAADOIiRAAIgNB+QBUAHAuBCQAuBCAAB/IAAB2QgBCBhDBHQhEBHh0ABQg+gBg8gPgAABidIgDAAIADAAIAJgBIgBgBIgIACIAAAAg");
	this.shape_17.setTransform(160.175,-224.7);
	...
	this.shape_18.setTransform(85.775,-225.425);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AjWHnIAAvNIGrAAIAADPIjNAAIAACmICnAAIAADQIinAAIAAC5IDQAAIAADPg");
	this.shape_19.setTransform(33.6,-225.425);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("ABIHnIgSi+IhrAAIgSC+IjbAAICBvNIFDAAICBPNgAAhBZIgckEIgFhRIgEBRIgbEEIBAAAg");
	this.shape_20.setTransform(-23.025,-225.425);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-596.9,-300.9,1446.6999999999998,319.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:140.4,regY:-173,x:174.25,y:26.25,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:26.2,alpha:0.0435},0).wait(1).to({y:26.1,alpha:0.0919},0).wait(1).to({y:25.9,alpha:0.1816},0).wait(1).to({y:25.6,alpha:0.3248},0).wait(1).to({y:25.25,alpha:0.4878},0).wait(1).to({y:24.95,alpha:0.6345},0).wait(1).to({y:24.7,alpha:0.7499},0).wait(1).to({y:24.5,alpha:0.8388},0).wait(1).to({y:24.35,alpha:0.9088},0).wait(1).to({y:24.25,alpha:0.9564},0).wait(1).to({y:24.2,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(61).to({regX:140.4,regY:-173,x:174.25,y:24.2,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:24.25,alpha:0.9565},0).wait(1).to({y:24.35,alpha:0.9081},0).wait(1).to({y:24.55,alpha:0.8184},0).wait(1).to({y:24.85,alpha:0.6752},0).wait(1).to({y:25.2,alpha:0.5122},0).wait(1).to({y:25.5,alpha:0.3655},0).wait(1).to({y:25.75,alpha:0.2501},0).wait(1).to({y:25.95,alpha:0.1612},0).wait(1).to({y:26.1,alpha:0.0912},0).wait(1).to({y:26.2,alpha:0.0436},0).wait(1).to({y:26.25,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).wait(178));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(174).to({_off:false},0).wait(1).to({regX:172,regY:-211,x:173.1,y:28,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.95,alpha:0.0435},0).wait(1).to({y:27.8,alpha:0.0919},0).wait(1).to({y:27.6,alpha:0.1816},0).wait(1).to({y:27.3,alpha:0.3248},0).wait(1).to({y:26.95,alpha:0.4878},0).wait(1).to({y:26.6,alpha:0.6345},0).wait(1).to({y:26.35,alpha:0.7499},0).wait(1).to({y:26.15,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.85,alpha:0.9564},0).wait(1).to({y:25.8,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0,regY:0.7,x:159.95,y:41.95,alpha:1},0).wait(62).to({regX:172,regY:-211,x:173.2,y:25.7,alpha:0.9968},0).wait(1).to({x:173.7,alpha:0.9855},0).wait(1).to({x:174.65,alpha:0.9629},0).wait(1).to({x:176.3,alpha:0.923},0).wait(1).to({x:179.2,y:25.65,alpha:0.8533},0).wait(1).to({x:184.25,y:25.6,alpha:0.7328},0).wait(1).to({x:190.5,y:25.5,alpha:0.5836},0).wait(1).to({x:196.7,y:25.45,alpha:0.4352},0).wait(1).to({x:201.9,y:25.4,alpha:0.3113},0).wait(1).to({x:205.95,y:25.35,alpha:0.2141},0).wait(1).to({x:209.15,y:25.3,alpha:0.1375},0).wait(1).to({x:211.7,y:25.25,alpha:0.0771},0).wait(1).to({x:213.35,alpha:0.0372},0).wait(1).to({x:214.35,alpha:0.0143},0).wait(1).to({x:214.8,alpha:0.0031},0).wait(1).to({regX:0,regY:0.7,x:201.8,y:41.45,alpha:0},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).wait(1).to({regX:127.2,regY:-142.1,x:172.9,y:29.45,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:29.4,alpha:0.0435},0).wait(1).to({y:29.3,alpha:0.0919},0).wait(1).to({y:29.1,alpha:0.1816},0).wait(1).to({y:28.8,alpha:0.3248},0).wait(1).to({y:28.45,alpha:0.4878},0).wait(1).to({y:28.15,alpha:0.6345},0).wait(1).to({y:27.9,alpha:0.7499},0).wait(1).to({y:27.7,alpha:0.8388},0).wait(1).to({y:27.55,alpha:0.9088},0).wait(1).to({y:27.45,alpha:0.9564},0).wait(1).to({y:27.4,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(62).to({regX:127.2,regY:-142.1,x:172.9,y:27.4,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:27.45,alpha:0.9565},0).wait(1).to({y:27.55,alpha:0.9081},0).wait(1).to({y:27.75,alpha:0.8184},0).wait(1).to({y:28.05,alpha:0.6752},0).wait(1).to({y:28.4,alpha:0.5122},0).wait(1).to({y:28.7,alpha:0.3655},0).wait(1).to({y:28.95,alpha:0.2501},0).wait(1).to({y:29.15,alpha:0.1612},0).wait(1).to({y:29.3,alpha:0.0912},0).wait(1).to({y:29.4,alpha:0.0436},0).wait(1).to({y:29.45,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).wait(94));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(98).to({_off:false},0).wait(1).to({regX:-17,regY:-0.5,x:98.85,y:29.6,alpha:0.0037},0).wait(1).to({y:29.55,alpha:0.0167},0).wait(1).to({y:29.45,alpha:0.0435},0).wait(1).to({y:29.25,alpha:0.0919},0).wait(1).to({y:28.9,alpha:0.1816},0).wait(1).to({y:28.35,alpha:0.3248},0).wait(1).to({y:27.65,alpha:0.4878},0).wait(1).to({y:27.1,alpha:0.6345},0).wait(1).to({y:26.65,alpha:0.7499},0).wait(1).to({y:26.25,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.8,alpha:0.9564},0).wait(1).to({y:25.7,alpha:0.9834},0).wait(1).to({y:25.65,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:102.1,y:25.75,alpha:1},0).to({_off:true},152).wait(18));
