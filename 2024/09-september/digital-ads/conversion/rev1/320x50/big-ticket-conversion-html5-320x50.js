...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(467.6014,-43.1562);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAlHoIAAqUQAAgZgKgLQgKgNgVAAIgRABIgPACIAALCIkcAAIAAuSQBfgdBWgPQBYgRBBAAQCTgBBPBGQBQBGAACZIAAKrg");
	this.shape_1.setTransform(395.75,-44.2757);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiNKlIAAulIEbAAIAAOlgAhimjQghgoAAhIQAAhDAhgnQAigmA/gBQA9ABAiAmQAiAnAABDQAABIgiAoQgiAng9AAQg/AAgigng");
	this.shape_2.setTransform(336.675,-63.225);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AA4KKIg4sNIg3MNImAAAIhh0TIE8AAIAPPmIBWvmIDwAAIBWPmIAOvmIE8AAIhgUTg");
	this.shape_3.setTransform(259.175,-60.475);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AjpHoIAAunQA2gPBTgMQBTgMBdgBICaAAIAAEKIiaAAIgaAAIgWACIAALDg");
	this.shape_4.setTransform(156.475,-44.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AjTGVQhhhagCi/IAAkJQAAi2BPhXQBPhWClABQCZgBBJBWQBIBWgBC1IAADkIlSAAIAAAyQAAAsAhAZQAhAZBDABQAdAAAngFQAngDAegIIAYEAQg9AOg3AGQg3AGgmAAIgCAAQirAAhfhbgAgTjpQgIASAAAqIAABJIBHAAIAAhJQACgqgIgSQgIgSgUABIgCgBQgSAAgJASg");
	this.shape_5.setTransform(92.2501,-43.4504);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(17.8752,-26.1504);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(-57.4248,-26.1504);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AiNKlIAAulIEbAAIAAOlgAhimjQghgoAAhIQAAhDAhgnQAigmA/gBQA9ABAiAmQAiAnAABDQAABIgiAoQgiAng9AAQg/AAgigng");
	this.shape_8.setTransform(-114.875,-63.225);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AlbKKIAA0TIFIAAQBlAABRAgQBPAhAuBHQAtBGABBxIAAAgQABBhghBAQgfA/hLAgQBOAbAlBBQAlBBAABvIAABPQgBBxgqBNQgrBNhLAnQhNAnhnAAgAgxFwIASAAQAmAAANgTQAOgSgCghIAAiBQACgkgOgTQgMgTgnAAIgSAAgAgxiQIAXAAQAmAAANgTQANgSgBgiIAAhPQABgkgMgSQgNgTgnAAIgXAAg");
	this.shape_9.setTransform(-174.3,-60.475);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFE400").s().p("Aj7EQICuofIFJAAIj5Ifg");
	this.shape_10.setTransform(500.325,-205.625);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFE400").s().p("AjUGVQhghagCi/IAAkJQgBi2BPhXQBQhWCkABQCagBBJBWQBIBWgBC1IAADkIlSAAIAAAyQAAAsAhAZQAhAZBEABQAdAAAmgFQAmgDAfgIIAYEAQg9AOg2AGQg4AGgmAAIgCAAQirAAhghbgAgSjpQgJASABAqIAABJIBHAAIAAhJQABgqgJgSQgHgSgUABIgCgBQgSAAgIASg");
	this.shape_11.setTransform(444.0001,-252.9504);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFE400").s().p("AkbHTIAAkJIEBmSIjrAAIAAkKIITAAIAAEGIj8GVIEKAAIAAEKg");
	this.shape_12.setTransform(377.275,-251.7);
	...
	this.shape_13.setTransform(323.525,-272.725);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFE400").s().p("AjpHoIAAunQA2gPBTgMQBTgMBdgBICaAAIAAEKIiaAAIgaAAIgWACIAALDg");
	this.shape_14.setTransform(277.925,-253.775);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFE400").s().p("AlWKKIAA0TIE9AAQCPABBRAtQBQAsAhBRQAgBQgCBuIAABtQgBCLgvBMQgvBMhTAeQhSAehrgBIgSAAIAAHfgAgrhEIALAAQAlABAQgSQASgSgBgsIAAiNQABgqgRgTQgQgTgmABIgLAAg");
	this.shape_15.setTransform(210.5534,-269.975);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFE400").s().p("AjpHoIAAunQA2gPBTgMQBTgMBdgBICaAAIAAEKIiaAAIgaAAIgWACIAALDg");
	this.shape_16.setTransform(125.675,-253.775);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFE400").s().p("AjUGVQhghagCi/IAAkJQgBi2BPhXQBQhWCkABQCagBBJBWQBIBWgBC1IAADkIlSAAIAAAyQAAAsAhAZQAhAZBEABQAdAAAmgFQAmgDAfgIIAYEAQg9AOg2AGQg4AGgmAAIgCAAQirAAhghbgAgSjpQgJASABAqIAABJIBHAAIAAhJQABgqgJgSQgHgSgUABIgCgBQgSAAgIASg");
	this.shape_17.setTransform(61.5001,-252.9504);
	...
	this.shape_18.setTransform(-12.8748,-235.6504);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFE400").s().p("");
	this.shape_19.setTransform(-88.2248,-235.6504);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFE400").s().p("AiNKlIAAulIEbAAIAAOlgAhimjQghgoAAhIQAAhDAhgnQAigmA/gBQA9ABAiAmQAiAnAABDQAABIgiAoQgiAng9AAQg/AAgigng");
	this.shape_20.setTransform(-145.675,-272.725);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFE400").s().p("AlbKKIAA0TIFIAAQBmAABPAgQBQAhAtBHQAuBGAABxIAAAgQABBhgfBAQghA/hKAgQBNAbAmBBQAlBBAABvIAABPQgBBxgrBNQgpBNhMAnQhNAnhnAAgAgwFwIASAAQAkAAAOgTQAOgSgBghIAAiBQAAgkgNgTQgMgTgmAAIgSAAgAgwiQIAWAAQAmAAANgTQANgSgBgiIAAhPQABgkgNgSQgMgTgnAAIgWAAg");
	this.shape_21.setTransform(-205.05,-269.975);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-580.1,-369.6,1446.7,445.70000000000005), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:142.8,regY:-149.8,x:174.5,y:28.65,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:28.6,alpha:0.0435},0).wait(1).to({y:28.5,alpha:0.0919},0).wait(1).to({y:28.3,alpha:0.1816},0).wait(1).to({y:28,alpha:0.3248},0).wait(1).to({y:27.65,alpha:0.4878},0).wait(1).to({y:27.35,alpha:0.6345},0).wait(1).to({y:27.1,alpha:0.7499},0).wait(1).to({y:26.9,alpha:0.8388},0).wait(1).to({y:26.75,alpha:0.9088},0).wait(1).to({y:26.65,alpha:0.9564},0).wait(1).to({y:26.6,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(69).to({regX:142.8,regY:-149.8,x:174.5,y:26.6,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:26.65,alpha:0.9565},0).wait(1).to({y:26.75,alpha:0.9081},0).wait(1).to({y:26.95,alpha:0.8184},0).wait(1).to({y:27.25,alpha:0.6752},0).wait(1).to({y:27.6,alpha:0.5122},0).wait(1).to({y:27.9,alpha:0.3655},0).wait(1).to({y:28.15,alpha:0.2501},0).wait(1).to({y:28.35,alpha:0.1612},0).wait(1).to({y:28.5,alpha:0.0912},0).wait(1).to({y:28.6,alpha:0.0436},0).wait(1).to({y:28.65,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).to({_off:true},1).wait(169));
