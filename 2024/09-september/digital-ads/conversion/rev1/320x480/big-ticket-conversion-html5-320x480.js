...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("");
	this.shape.setTransform(130.25,-8.1812);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("AgkBFQgQgPAAghIAAgtQgBgfAOgPQAOgPAbABQAagBANAPQAMAPAAAfIAAAmIg5AAIAAAJQAAAIAFAEQAGAEALAAIAMAAIAMgCIAEAsIgUADIgQABQgdAAgRgQgAgCgnQgCADAAAHIAAAMIAMAAIAAgMQAAgHgCgDQgBgDgDAAQgDAAgBADg");
	this.shape_1.setTransform(118.3741,-8.2258);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("AgwBQIAAgtIAthFIgpAAIAAgtIBbAAIAAAtIgsBFIAuAAIAAAtg");
	this.shape_2.setTransform(106.875,-8.025);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("AgXB1IAAigIAvAAIAACggAgQhHQgGgHAAgMQAAgMAGgGQAGgHAKgBQAKABAGAHQAGAGAAAMQAAAMgGAHQgGAGgKABQgKgBgGgGg");
	this.shape_3.setTransform(97.675,-11.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("AgnBUIAAigIAXgFQAPgCAPAAIAaAAIAAAuIgaAAIgFAAIgEAAIAAB5g");
	this.shape_4.setTransform(89.825,-8.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFE400").s().p("Ag6BwIAAjfIA2AAQAZABAOAHQANAIAGAOQAFAOAAASIAAATQgBAYgHAMQgJANgOAFQgOAGgSgBIgDAAIAABTgAgHgLIACAAQAGAAACgDQAEgDAAgHIAAgZQAAgHgDgDQgDgDgGAAIgCAAg");
	this.shape_5.setTransform(78.25,-11.175);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("AgQBuIgPgCIgKgCIgNgwIAWAFQALADAHAAQAIAAAFgCQADgBACgEQACgFAAgLIgEABIgDAAQgOgBgMgEQgMgFgIgLQgHgMAAgUIAAhlIAxAAIAABlQAAADACADQABACADAAIADAAIACgBIABg2IAAg2IAwAAIAACdQAAAigOAPQgOAPgdAAIgOgBg");
	this.shape_6.setTransform(61.375,-4.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("AgXBwIAAjfIAvAAIAADfg");
	this.shape_7.setTransform(51.175,-11.175);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFE400").s().p("AAHBwIgRhFIAABFIgwAAIAAjfIAwAAIAAB8IAPg8IAxAAIgXBIIAcBXg");
	this.shape_8.setTransform(41.2,-11.175);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFE400").s().p("AgkBFQgQgPAAghIAAgtQgBgfAOgPQAOgPAbABQAagBANAPQAMAPAAAfIAAAmIg5AAIAAAJQAAAIAFAEQAGAEALAAIAMAAIAMgCIAEAsIgUADIgQABQgdAAgRgQgAgCgnQgCADAAAHIAAAMIAMAAIAAgMQAAgHgCgDQgBgDgDAAQgDAAgBADg");
	this.shape_9.setTransform(28.0741,-8.2258);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFE400").s().p("AgkBFQgQgPAAghIAAgtQgBgfAOgPQAOgPAbABQAagBANAPQAMAPAAAfIAAAmIg5AAIAAAJQAAAIAFAEQAGAEALAAIAMAAIAMgCIAEAsIgUADIgQABQgdAAgRgQgAgCgnQgCADAAAHIAAAMIAMAAIAAgMQAAgHgCgDQgBgDgDAAQgDAAgBADg");
	this.shape_10.setTransform(15.7241,-8.2258);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFE400").s().p("AAKBwIgKiGIgJCGIhCAAIgQjfIA2AAIADCrIAOirIApAAIAPCrIACirIA2AAIgQDfg");
	this.shape_11.setTransform(-0.225,-11.175);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgpBjQgNgPAAggIAAgwQAAgfANgPQANgPAcABIAGAAIAAg4IAxAAIAADZQgOAEgOACIgbACQgcAAgNgOgAgDgIQgDAEAAAJIAAAuQAAAKADADQACAEAEgBIADAAIAAhOIgDAAQgEAAgCADg");
	this.shape_12.setTransform(-20.1759,-11.025);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgkBFQgQgPAAghIAAgtQgBgfAOgPQAOgPAbABQAagBANAPQAMAPAAAfIAAAmIg5AAIAAAJQAAAIAFAEQAGAEALAAIAMAAIAMgCIAEAsIgUADIgQABQgdAAgRgQgAgCgnQgCADAAAHIAAAMIAMAAIAAgMQAAgHgCgDQgBgDgDAAQgDAAgBADg");
	this.shape_13.setTransform(-32.6259,-8.2258);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgkBFQgQgPAAghIAAgtQgBgfAOgPQAOgPAbABQAagBANAPQAMAPAAAfIAAAmIg5AAIAAAJQAAAIAFAEQAGAEALAAIAMAAIAMgCIAEAsIgUADIgQABQgdAAgRgQgAgCgnQgCADAAAHIAAAMIAMAAIAAgMQAAgHgCgDQgBgDgDAAQgDAAgBADg");
	this.shape_14.setTransform(-44.9759,-8.2258);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AAgBnQgaAAgMgGQgOgGgFgLQgFgLABgQIAAhCIgPAAIAAgsIAPAAIAAgtIAvAAIAAAtIAaAAIAAAsIgaAAIAAA1QAAAKAFAEQAFADAMAAIAFAAIAAAug");
	this.shape_15.setTransform(-56.425,-10.275);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAGBUIAAhxQAAgEgBgCQgCgCgDAAIgDAAIgCAAIAAB5IgxAAIAAicQAQgFAPgDQAPgDALAAQAZAAANAMQAOAMAAAaIAAB1g");
	this.shape_16.setTransform(-68.05,-8.376);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgpBIQgNgNAAgYIAAgCQAAgYANgMQANgNAaAAIADAAIAFAAIAAgGQAAgKgEgDQgEgEgMAAQgHAAgJACIgSAGIANgvIAIgDIAMgCIANgBQAVAAAMAGQANAGAFANQAGAMAAATIAABoIgdAHQgOACgOAAQgaAAgNgNgAgCASQgDADgBAGIAAAEQABAHADADQACADADAAIADAAIAAgdIgDAAQgDAAgCADg");
	this.shape_17.setTransform(-81.225,-8.225);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AgnBUIAAigIAXgFQAPgCAPAAIAaAAIAAAuIgaAAIgFAAIgEAAIAAB5g");
	this.shape_18.setTransform(-91.825,-8.375);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgpBIQgNgNAAgYIAAgCQAAgYANgMQANgNAaAAIADAAIAFAAIAAgGQAAgKgEgDQgEgEgMAAQgHAAgJACIgSAGIANgvIAIgDIAMgCIANgBQAVAAAMAGQANAGAFANQAGAMAAATIAABoIgdAHQgOACgOAAQgaAAgNgNgAgCASQgDADgBAGIAAAEQABAHADADQACADADAAIADAAIAAgdIgDAAQgDAAgCADg");
	this.shape_19.setTransform(-103.275,-8.225);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AgoBGQgOgMAAgbIAAhwIAxAAIAABsQAAAFACACQABACADAAIADAAIACgBIAAh0IAxAAIAACYIgcAHQgOADgPABQgZAAgNgMg");
	this.shape_20.setTransform(-116.2,-7.875);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgrBkQgQgQABgfIAAhpQAAgTAIgOQAJgOAPgIQAPgHASAAQANAAANAEQAOADAMAHIgSAsQgHgDgHgCIgOgCQgLAAgEAGQgEAFAAAMIAABhQAAAFACADQACACADAAIAEAAIACgBIAAhQIAwAAIAABxIgRAJQgIAEgJACQgJABgKAAQgfAAgOgPg");
	this.shape_21.setTransform(-129.0758,-11.225);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_sub_caption_mc, new cjs.Rectangle(-137.3,-29.2,274.6,42.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).wait(1).to({regX:0.2,regY:-8.5,x:157.35,y:417.05,alpha:0.0037},0).wait(1).to({y:416.8,alpha:0.0167},0).wait(1).to({y:416.25,alpha:0.0435},0).wait(1).to({y:415.3,alpha:0.0919},0).wait(1).to({y:413.55,alpha:0.1816},0).wait(1).to({x:157.3,y:410.75,alpha:0.3248},0).wait(1).to({y:407.55,alpha:0.4878},0).wait(1).to({x:157.25,y:404.65,alpha:0.6345},0).wait(1).to({y:402.4,alpha:0.7499},0).wait(1).to({x:157.2,y:400.65,alpha:0.8388},0).wait(1).to({y:399.25,alpha:0.9088},0).wait(1).to({y:398.35,alpha:0.9564},0).wait(1).to({y:397.8,alpha:0.9834},0).wait(1).to({y:397.55,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:157,y:406,alpha:1},0).wait(61).to({x:157.2,y:405.65},0).wait(1).to({regX:0.2,regY:-8.5,x:157.4,y:397.2,alpha:0.9968},0).wait(1).to({y:397.4,alpha:0.9855},0).wait(1).to({y:397.85,alpha:0.9629},0).wait(1).to({y:398.65,alpha:0.923},0).wait(1).to({y:400.05,alpha:0.8533},0).wait(1).to({y:402.45,alpha:0.7328},0).wait(1).to({y:405.45,alpha:0.5836},0).wait(1).to({y:408.4,alpha:0.4352},0).wait(1).to({y:410.9,alpha:0.3113},0).wait(1).to({y:412.85,alpha:0.2141},0).wait(1).to({y:414.35,alpha:0.1375},0).wait(1).to({y:415.6,alpha:0.0771},0).wait(1).to({y:416.4,alpha:0.0372},0).wait(1).to({y:416.85,alpha:0.0143},0).wait(1).to({y:417.05,alpha:0.0031},0).wait(1).to({regX:0,regY:0,x:157.2,y:425.65,alpha:0},0).wait(93));
