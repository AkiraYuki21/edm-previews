...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(424.6765,-77.2857);
	...
	this.shape_1.setTransform(358.8,-78.3252);
	...
	this.shape_2.setTransform(304.725,-95.675);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AA0JUIg0rMIgzLMIlgAAIhYynIEhAAIANOTIBQuTIDbAAIBPOTIAOuTIEhAAIhZSng");
	this.shape_3.setTransform(233.7,-93.175);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AjWG/IAAtZQAygNBMgMQBMgKBVgBICOAAIAAD0IiOAAIgYAAIgUABIAAKIg");
	this.shape_4.setTransform(139.45,-78.325);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AjCF0QhYhUgCivIAAjyQgBinBJhPQBIhPCXAAQCNAABDBPQBCBOAACmIAADRIk3AAIAAAuQAAAoAeAXQAfAXA+ABQAaAAAjgEQAkgEAcgHIAWDrQg4AMgyAGQgzAGgjAAIgDAAQicAAhXhTgAgRjVQgHAQAAAmIAABEIBBAAIAAhEQABgmgIgQQgHgRgSABIgBAAQgRAAgIAQg");
	this.shape_5.setTransform(80.6245,-77.5746);
	...
	this.shape_6.setTransform(12.4002,-61.7246);
	...
	this.shape_7.setTransform(-56.6498,-61.7246);
	...
	this.shape_8.setTransform(-109.225,-95.675);
	...
	this.shape_9.setTransform(-163.7,-93.175);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:127,regY:-171.5,x:162.9,y:26.4,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:26.35,alpha:0.0435},0).wait(1).to({y:26.25,alpha:0.0919},0).wait(1).to({y:26.05,alpha:0.1816},0).wait(1).to({y:25.75,alpha:0.3248},0).wait(1).to({y:25.4,alpha:0.4878},0).wait(1).to({y:25.1,alpha:0.6345},0).wait(1).to({y:24.85,alpha:0.7499},0).wait(1).to({y:24.65,alpha:0.8388},0).wait(1).to({y:24.5,alpha:0.9088},0).wait(1).to({y:24.4,alpha:0.9564},0).wait(1).to({y:24.35,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(128).to({regX:127,regY:-171.5,x:162.9,y:24.35,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:24.4,alpha:0.9565},0).wait(1).to({y:24.5,alpha:0.9081},0).wait(1).to({y:24.7,alpha:0.8184},0).wait(1).to({y:25,alpha:0.6752},0).wait(1).to({y:25.35,alpha:0.5122},0).wait(1).to({y:25.65,alpha:0.3655},0).wait(1).to({y:25.9,alpha:0.2501},0).wait(1).to({y:26.1,alpha:0.1612},0).wait(1).to({y:26.25,alpha:0.0912},0).wait(1).to({y:26.35,alpha:0.0436},0).wait(1).to({y:26.4,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).to({_off:true},2).wait(109));
