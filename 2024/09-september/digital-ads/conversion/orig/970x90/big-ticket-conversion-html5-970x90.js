

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFE400").s().p("AqOVXMAAAgo8QCXgqDogkQDpggEGgDIGvAAIAALpImvAAIhJAAIg9AFIAAe/g");
	this.shape_14.setTransform(953.475,-161.95);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFE400").s().p("Au+ccMAAAg43IN1AAQGVACDiB9QDhB9BaDiQBaDhgEEzIAAExQgDGGiDDWQiEDXjoBTQjoBVkugEIgyAAIAAU9gAh7jBIAfAAQBqACAugyQAwgwgCh9IAAmLQACh2gug1Qgsg0huACIgfAAg");
	this.shape_15.setTransform(764.7607,-207.325);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFE400").s().p("AqOVXMAAAgo8QCXgqDogkQDpggEGgDIGvAAIAALpImvAAIhJAAIg9AFIAAe/g");
	this.shape_16.setTransform(527.075,-161.95);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFE400").s().p("ApTRwQkNj/gFoXIAAroQgCn8DdjzQDejxHPABQGugBDMDxQDLDxgCH6IAAKBIu2AAIAACMQAAB7BdBGQBfBGC8ACQBRAABsgNQBrgLBVgWIBELPQirAliZASQiZAShsAAIgIAAQngAAkLj+gAg2qOQgVAyAAB0IAADOIDIAAIAAjOQACh0gWgyQgWgzg4ACIgFAAQg0AAgYAxg");
	this.shape_17.setTransform(347.3496,-159.65);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFE400").s().p("");
	this.shape_18.setTransform(138.9259,-111.2246);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFE400").s().p("");
	this.shape_19.setTransform(-72.0741,-111.2246);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFE400").s().p("AmMdpMAAAgo4IMZAAMAAAAo4gAkTyZQhehuAAjJQAAi9BehtQBehsCwgCQCuACBeBsQBeBtAAC9QAADJheBuQheBtiuADQiwgDhehtg");
	this.shape_20.setTransform(-232.975,-214.975);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFE400").s().p("AvNccMAAAg43IOUAAQEgAADgBaQDfBcCADFQB/DFACE8IAABaQACEQhaCzQhaCyjQBaQDZBKBpC3QBnC4AAE4IAADdQgCE8h2DWQh3DXjUBuQjXBtkhAAgAiKQHIAyAAQBrAAAlg0QAlgzgCheIAAlqQAChkgjg1Qgjg1hvAAIgyAAgAiKmVIBAAAQBqAAAlg1QAlgygChfIAAjdQAChlgjg0Qgjg1huAAIhAAAg");
	this.shape_21.setTransform(-399.275,-207.325);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-1694,-485.5,6598.7,659.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:1608.4,regY:-164.2,x:635.4,y:46.9,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:46.85,alpha:0.0435},0).wait(1).to({y:46.75,alpha:0.0919},0).wait(1).to({y:46.6,alpha:0.1816},0).wait(1).to({y:46.3,alpha:0.3248},0).wait(1).to({y:46,alpha:0.4878},0).wait(1).to({y:45.7,alpha:0.6345},0).wait(1).to({y:45.5,alpha:0.7499},0).wait(1).to({y:45.35,alpha:0.8388},0).wait(1).to({y:45.2,alpha:0.9088},0).wait(1).to({y:45.1,alpha:0.9564},0).wait(1).to({y:45.05,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:1.1,regY:0.6,x:484.75,y:60.5,alpha:1},0).wait(144).to({regX:1608.4,regY:-164.2,x:635.4,y:45.05,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:45.1,alpha:0.9565},0).wait(1).to({y:45.2,alpha:0.9081},0).wait(1).to({y:45.35,alpha:0.8184},0).wait(1).to({y:45.65,alpha:0.6752},0).wait(1).to({y:45.95,alpha:0.5122},0).wait(1).to({y:46.25,alpha:0.3655},0).wait(1).to({y:46.45,alpha:0.2501},0).wait(1).to({y:46.6,alpha:0.1612},0).wait(1).to({y:46.75,alpha:0.0912},0).wait(1).to({y:46.85,alpha:0.0436},0).wait(1).to({y:46.9,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:1.1,regY:0.6,x:484.75,y:62.4,alpha:0},0).to({_off:true},2).wait(93));
