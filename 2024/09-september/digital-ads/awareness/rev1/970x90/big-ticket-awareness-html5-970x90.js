...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(2793.0514,-86.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("EgIZAoOMAAAg3eIQzAAMAAAA3egAl24+QiAiVAAkRQAAkACAiVQCAiRDugDQDtADCACRQCACVAAEAQAAERiACVQiACVjtADQjugDiAiVg");
	this.shape_1.setTransform(2574.725,-227.425);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("EgUpAmmMAAAhNLITbAAQGIAAEvB6QEwB9CsELQCsEMADGsIAAB6QAEFxh7D0Qh6DxkaB6QEmBlCQD5QCLD6AAGmIAAEtQgDGsihEjQigEkkhCVQkjCUmJAAgAi8V3IBEAAQCSAAAyhHQAyhEgDiAIAAnrQADiJgvhHQgwhIiXAAIhEAAgAi8onIBWAAQCRAAAzhHQAyhFgDh/IAAktQADiJgwhHQgvhHiXAAIhWAAg");
	this.shape_2.setTransform(2349,-217.025);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("ACNc/MAAAgnOQAAhfgngsQgmgwhSAAQgbAAgkADQgkADgYAGMAAAAp9Iw0AAMAAAg2UQFlhuFKg8QFNg+D8AAQIsgDEsEIQEwEJADJHMAAAAong");
	this.shape_3.setTransform(1973.45,-155.4517);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("EgIZAoOMAAAg3eIQzAAMAAAA3egAl24+QiAiVAAkRQAAkACAiVQCAiRDugDQDtADCACRQCACVAAEAQAAERiACVQiACVjtADQjugDiAiVg");
	this.shape_4.setTransform(1748.825,-227.425);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("EADWAmmMgDWguaMgDWAuaI2zAAMgFvhNLISvAAMAA5A7SMAFHg7SIOTAAMAFHA7SMAA4g7SISwAAMgFvBNLg");
	this.shape_5.setTransform(1454.35,-217.025);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("EgS+AndMAAAhNvQC1gYDogPQDogRDZgJQDWgJCGAAQKOgDEdFEQEeFHgGLBIAAQpQAGLAkeFHQkgFEqRgDIiAAAIAAT/gAiKDrIA/AAQB8AGAyhIQAwhKgDjVIAAwLQADjcgwhIQgyhKh8AGIg/AAg");
	this.shape_6.setTransform(1019.3062,-88.3764);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("EgKkAk5QkpiLiqkkQimkggDm8MAAAg5yISFAAMAAAA6QQAABuAmAzQAnAvBSAAQBRAAAjgyQAkgyAAhsMAAAg6QISFAAMAAAA5yQAAGJiSEkQiOEjkkCkQkgChmzADQmHAAkniNg");
	this.shape_7.setTransform(718.025,-213.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFE400").s().p("EgS+AndMAAAhNvQC1gYDogPQDogRDZgJQDWgJCGAAQKOgDEdFEQEeFHgGLBIAAQpQAGLAkeFHQkgFEqRgDIiAAAIAAT/gAiKDrIA/AAQB8AGAyhIQAwhKgDjVIAAwLQADjcgwhIQgyhKh8AGIg/AAg");
	this.shape_8.setTransform(343.5062,-88.3764);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFE400").s().p("AsoYFQlulZgGrWIAAvyQgDqyEtlLQEslHJ2ADQJHgDEUFHQEVFIgDKvIAANmI0KAAIAAC/QAACmB/BfQCABfEAADQBuAACRgRQCSgPB0geIBcPQQjoAyjQAYQjQAYiSAAIgLAAQqLAAlrlZgAhJt4QgeBEAACeIAAEXIERAAIAAkXQADiegehEQgehFhNADIgHAAQhHAAgfBCg");
	this.shape_9.setTransform(61.2751,-152.3251);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFE400").s().p("EAK5AjjQopABkoiBQksiDhuj2Qhxj3AFllIAA26IlBAAIAAvPIFBAAIAAvnIQ0AAIAAPnIJBAAIAAPPIpBAAIAASiQgDDgBoBQQBrBQEGgGIB0AAIAAPzg");
	this.shape_10.setTransform(-192.6,-197.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFE400").s().p("");
	this.shape_11.setTransform(-432.5,-218.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-2110.3,-592.2,6598.8,890.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:1179.9,regY:-158.6,x:595.25,y:47.45,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:47.4,alpha:0.0435},0).wait(1).to({y:47.3,alpha:0.0919},0).wait(1).to({y:47.15,alpha:0.1816},0).wait(1).to({y:46.85,alpha:0.3248},0).wait(1).to({y:46.55,alpha:0.4878},0).wait(1).to({y:46.25,alpha:0.6345},0).wait(1).to({y:46.05,alpha:0.7499},0).wait(1).to({y:45.9,alpha:0.8388},0).wait(1).to({y:45.75,alpha:0.9088},0).wait(1).to({y:45.65,alpha:0.9564},0).wait(1).to({y:45.6,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:1.1,regY:0.6,x:484.75,y:60.5,alpha:1},0).wait(69).to({regX:1179.9,regY:-158.6,x:595.25,y:45.6,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:45.65,alpha:0.9565},0).wait(1).to({y:45.75,alpha:0.9081},0).wait(1).to({y:45.9,alpha:0.8184},0).wait(1).to({y:46.2,alpha:0.6752},0).wait(1).to({y:46.5,alpha:0.5122},0).wait(1).to({y:46.8,alpha:0.3655},0).wait(1).to({y:47,alpha:0.2501},0).wait(1).to({y:47.15,alpha:0.1612},0).wait(1).to({y:47.3,alpha:0.0912},0).wait(1).to({y:47.4,alpha:0.0436},0).wait(1).to({y:47.45,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:1.1,regY:0.6,x:484.75,y:62.4,alpha:0},0).to({_off:true},1).wait(169));
