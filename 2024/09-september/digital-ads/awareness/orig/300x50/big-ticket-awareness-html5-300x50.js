...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(297.1502,-61.7246);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiBJtIAAtYIEDAAIAANYgAhZmAQgfgkAAhCQAAg+AfgkQAegjA6gBQA4ABAfAjQAfAkAAA+QAABCgfAkQgfAjg4ABQg6gBgegjg");
	this.shape_1.setTransform(244.525,-95.675);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ak+JUIAAynIEsAAQBdAABKAeQBJAeApBBQAqBAABBnIAAAeQAABZgdA7QgdA6hEAdQBGAYAjA8QAiA8AABmIAABIQgBBngmBHQgoBGhFAkQhGAkhfAAgAgsFSIAQAAQAiAAANgSQAMgQgBgfIAAh2QABghgMgSQgMgRgjAAIgQAAgAgsiEIAUAAQAjAAALgRQANgRgBgeIAAhJQABghgMgRQgLgRgkAAIgUAAg");
	this.shape_2.setTransform(190.1,-93.175);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAiG/IAApcQAAgXgJgLQgKgLgSAAIgPAAIgPADIAAKGIkEAAIAAtFQBWgbBQgOQBQgPA9AAQCFgBBJBAQBJBAABCMIAAJyg");
	this.shape_3.setTransform(99.5,-78.3252);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AiBJtIAAtYIEDAAIAANYgAhZmAQgfgkAAhCQAAg+AfgkQAegjA6gBQA4ABAfAjQAfAkAAA+QAABCgfAkQgfAjg4ABQg6gBgegjg");
	this.shape_4.setTransform(45.375,-95.675);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAzJUIgzrMIgyLMIlhAAIhYynIEhAAIANOTIBPuTIDdAAIBOOTIAOuTIEhAAIhZSng");
	this.shape_5.setTransform(-25.65,-93.175);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("AkkJhIAAyvQArgGA4gDQA4gFA1gBQAzgDAgAAQCdAABFBOQBFBPgBCqIAAEAQABCphFBPQhFBOiegBIgfAAIAAE1gAghA4IAPAAQAdACANgRQALgSgBgyIAAj6QABg1gLgSQgNgRgdABIgPAAg");
	this.shape_6.setTransform(301.1507,-247.1002);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("AiiI6QhIgigphGQgohGAAhrIAAt7IEXAAIAAOCQAAAbAJAMQAJAMATAAQAUAAAIgNQAIgMAAgaIAAuCIEYAAIAAN7QAABfgkBGQgiBGhHAoQhFAnhpAAQhdAAhHghg");
	this.shape_7.setTransform(228.45,-277.375);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFE400").s().p("AkkJhIAAyvQArgGA4gDQA4gFA1gBQAzgDAgAAQCdAABFBOQBFBPgBCqIAAEAQABCphFBPQhFBOiegBIgfAAIAAE1gAghA4IAPAAQAdACANgRQALgSgBgyIAAj6QABg1gLgSQgNgRgdABIgPAAg");
	this.shape_8.setTransform(138.1007,-247.1002);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFE400").s().p("AjCF0QhYhUgCivIAAjyQgBinBJhPQBIhPCXAAQCNAABDBPQBCBOAACmIAADRIk3AAIAAAuQAAAoAeAXQAfAXA+ABQAaAAAjgEQAkgEAcgHIAWDrQg4AMgyAGQgzAGgjAAIgDAAQicAAhXhTgAgRjVQgHAQAAAmIAABEIBBAAIAAhEQABgmgIgQQgHgRgSABIgBAAQgRAAgIAQg");
	this.shape_9.setTransform(69.9745,-262.5246);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFE400").s().p("ACoIlQiFAAhHgfQhIgggbg7Qgbg8ABhWIAAlgIhNAAIAAjsIBNAAIAAjxIEDAAIAADxICLAAIAADsIiLAAIAAEdQgBA2AZATQAaATA/gBIAcAAIAAD0g");
	this.shape_10.setTransform(8.775,-273.425);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFE400").s().p("");
	this.shape_11.setTransform(-49.125,-278.375);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:125.9,regY:-170,x:162.75,y:26.55,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:26.5,alpha:0.0435},0).wait(1).to({y:26.4,alpha:0.0919},0).wait(1).to({y:26.2,alpha:0.1816},0).wait(1).to({y:25.9,alpha:0.3248},0).wait(1).to({y:25.55,alpha:0.4878},0).wait(1).to({y:25.25,alpha:0.6345},0).wait(1).to({y:25,alpha:0.7499},0).wait(1).to({y:24.8,alpha:0.8388},0).wait(1).to({y:24.65,alpha:0.9088},0).wait(1).to({y:24.55,alpha:0.9564},0).wait(1).to({y:24.5,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(128).to({regX:125.9,regY:-170,x:162.75,y:24.5,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:24.55,alpha:0.9565},0).wait(1).to({y:24.65,alpha:0.9081},0).wait(1).to({y:24.85,alpha:0.8184},0).wait(1).to({y:25.15,alpha:0.6752},0).wait(1).to({y:25.5,alpha:0.5122},0).wait(1).to({y:25.8,alpha:0.3655},0).wait(1).to({y:26.05,alpha:0.2501},0).wait(1).to({y:26.25,alpha:0.1612},0).wait(1).to({y:26.4,alpha:0.0912},0).wait(1).to({y:26.5,alpha:0.0436},0).wait(1).to({y:26.55,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).to({_off:true},2).wait(109));
