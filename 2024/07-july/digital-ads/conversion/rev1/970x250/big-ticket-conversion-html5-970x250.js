...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("Ag2GpQgZgLgPgVQgQgWAAgiQABguAfgZQAfgaAvgBQAwABAfAaQAfAZABAuQAAAigQAWQgPAVgZALQgZALgeAAQgcAAgagLgAhhCUIAApHIDEAAIAAJHg");
	this.shape.setTransform(605.375,-25.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(562.55,-26.525);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ai9GtIAAtaIF5AAIAAC3Ii1AAIAACTICTAAIAAC3IiTAAIAACiIC3AAIAAC3g");
	this.shape_2.setTransform(520,-26.35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AjfGtIAAisIDun0IjSAAIAAi6IGjAAIAACsIjyH2IDxAAIAAC4g");
	this.shape_3.setTransform(473.35,-26.35);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhiGtIAAtaIDEAAIAANag");
	this.shape_4.setTransform(435.85,-26.35);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAkGtIhElHIgOAAIAAFHIjFAAIAAtaIDTAAQBfABA1AdQA1AeAVA1QAVA2gBBHIAAA+QAABDgQAsQgRAsgeAZIBhF6gAgug4IAJAAQAaABAKgMQALgLgBgdIAAhUQABgbgKgNQgKgMgbABIgJAAg");
	this.shape_5.setTransform(395.225,-26.35);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AjhGtIAAtaIDRAAQBeABA2AdQA1AeAVA1QAVA2gBBIIAABHQAABdgfAxQgfAzg3AUQg3AUhGgBIgMAAIAAE8gAgcgtIAHAAQAYABALgMQAMgLgBgeIAAhdQABgcgLgNQgLgMgZABIgHAAg");
	this.shape_6.setTransform(341.8773,-26.35);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAbGtIAAlSIg1AAIAAFSIjFAAIAAtaIDFAAIAAFEIA1AAIAAlEIDFAAIAANag");
	this.shape_7.setTransform(276.7,-26.35);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(229.8,-26.525);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABAGtIgQinIhfAAIgPCnIjCAAIBytaIEdAAIBxNagAAdBPIgZjmIgEhHIgEBHIgYDmIA5AAg");
	this.shape_9.setTransform(179.65,-26.35);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAdG7Qh6gBg+hBQg+hCAAh/IAAlvQAAh/A+hCQA+hCB6AAIABAAQAyAAAqAJQAqAJAmARIhHCfQgQgFgTgCQgSgDgPAAIgBAAQgnAAgUAZQgSAXAAAuIAAFIQAAAuAXAYQAZAZAnAAIACAAQASAAARgEQASgEAUgJIBHCeQgsAVgsALQgtALg3AAg");
	this.shape_10.setTransform(131.225,-26.475);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AjiGtIAAtZIDTAAQBFAAA2AeQA3AfAgA4QAgA4AABPIAAFcQAABPggA6QggA6g2AfQg3AfhEAAgAgdD0IAHAAQAeAAAIgOQAJgOgBgjIAAlzQAAghgLgKQgMgLgXACIgHAAg");
	this.shape_11.setTransform(644.025,-159.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("Ai9GtIAAtZIF5AAIAAC2Ii1AAIAACTICTAAIAAC3IiTAAIAACiIC3AAIAAC3g");
	this.shape_12.setTransform(598,-159.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("Ai9GtIAAtZIF5AAIAAC2Ii1AAIAACTICUAAIAAC3IiUAAIAACiIC3AAIAAC3g");
	this.shape_13.setTransform(555.75,-159.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhiGtIAAqYIh4AAIAAjBIG1AAIAADBIh4AAIAAKYg");
	this.shape_14.setTransform(511.175,-159.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgCGtIg3ofIAAIfIjFAAIAAtZIEDAAIA0ISIAAoSIDFAAIAANZg");
	this.shape_15.setTransform(460.1,-159.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AA/GtIgPinIhfAAIgPCnIjBAAIBxtZIEdAAIByNZgAAcBPIgXjmIgFhHIgDBHIgYDmIA3AAg");
	this.shape_16.setTransform(403.7,-159.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAkGtIhElHIgOAAIAAFHIjFAAIAAtZIDTAAQBfAAA1AdQA1AeAVA1QAVA2gBBHIAAA+QAABDgQAsQgRArgeAaIBhF6gAgug4IAJAAQAaABAKgMQALgLgBgdIAAhUQABgbgKgMQgKgNgbABIgJAAg");
	this.shape_17.setTransform(348.375,-159.2);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AA/GtIgPinIhfAAIgQCnIjAAAIBxtZIEdAAIByNZgAAcBPIgXjmIgFhHIgDBHIgYDmIA3AAg");
	this.shape_18.setTransform(293,-159.2);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("Ah1GaQgzgYgegzQgdgxAAhNIAAqDIDJAAIAAKHQAAAUAHAJQAGAHAOAAQAOABAGgJQAGgJAAgTIAAqHIDJAAIAAKDQAABDgZAzQgZAzgyAdQgzAchLAAQhDAAg0gZg");
	this.shape_19.setTransform(238.275,-158.65);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AiqF/Qg6g8ABh3IAAmXQAAhLAhg2QAhg1A5gdQA5gcBJAAQAyAAA0AOQA1AOAvAZIhHCqQgYgNgcgHQgcgGgcAAQgnAAgSAUQgTAVABAtIAAF4QAAAWAHAJQAIAJAPAAQAJAAAGgCIAHgDIAAk2IC6AAIAAG3QgjAUgfAOQgfAOgiAHQghAHgpAAQh3AAg6g8g");
	this.shape_20.setTransform(187.0748,-159.325);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AjVG1IAAiuQA8hCA4hMQA3hLAlhIQAjhIABg5IAAgIQAAghgMgUQgNgSgSgHQgTgHgSABQghAAgdAJIgwAOIg+ikQAlgTA4gOQA5gPBCAAQBKABAyAkQAyAkAaA7QAaA8AABHIAAAEQAABBgUA6QgVA7ggA1QghA1gmAwQgkAugkApIDCAAIAAC3g");
	this.shape_21.setTransform(123.05,-159.95);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("Ag2G0IAAqCIhZAUIAAi4IEfhBIAANng");
	this.shape_22.setTransform(78.625,-159.85);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFE400").s().p("Ag2E+QgZgLgPgWQgQgVAAgjQABgtAfgaQAfgZAvgBQAwABAfAZQAfAaABAtQAAAjgQAVQgPAWgZALQgaAKgdAAQgdAAgZgKgAg2iNQgZgKgPgXQgQgVAAgjQABgsAfgbQAfgaAvAAQAwAAAfAaQAfAbABAsQAAAjgQAVQgPAXgZAKQgaAKgdAAQgdAAgZgKg");
	this.shape_23.setTransform(717.475,-280.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFE400").s().p("");
	this.shape_24.setTransform(679.7,-292.225);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFE400").s().p("AAkGtIhElHIgOAAIAAFHIjFAAIAAtZIDTAAQBfAAA1AdQA1AeAVA1QAVA2gBBHIAAA+QAABCgQAtQgRArgeAaIBhF6gAgug4IAJAAQAaABAKgMQALgLgBgeIAAhTQABgbgKgMQgKgNgbAAIgJAAg");
	this.shape_25.setTransform(629.675,-292.05);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFE400").s().p("Ai9GtIAAtZIF5AAIAAC2Ii1AAIAACTICTAAIAAC3IiTAAIAACjIC3AAIAAC2g");
	this.shape_26.setTransform(582,-292.05);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFE400").s().p("AgCGtIg2ofIAAIfIjGAAIAAtZIEDAAIA1ISIAAoSIDFAAIAANZg");
	this.shape_27.setTransform(531.25,-292.05);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFE400").s().p("AgCGtIg2ofIAAIfIjFAAIAAtZIECAAIA1ISIAAoSIDEAAIAANZg");
	this.shape_28.setTransform(474,-292.05);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFE400").s().p("AhiGtIAAtZIDEAAIAANZg");
	this.shape_29.setTransform(432.35,-292.05);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFE400").s().p("AAlGtIgloDIgkIDIj+AAIhAtZIDRAAIAKKSIA4qSICeAAIA5KSIAKqSIDRAAIhANZg");
	this.shape_30.setTransform(381.75,-292.05);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFE400").s().p("Ai9GtIAAtZIF5AAIAAC2Ii1AAIAACTICUAAIAAC3IiUAAIAACjIC3AAIAAC2g");
	this.shape_31.setTransform(310.25,-292.05);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFE400").s().p("AAbGtIAAlSIg1AAIAAFSIjFAAIAAtZIDFAAIAAFEIA1AAIAAlEIDFAAIAANZg");
	this.shape_32.setTransform(262.5,-292.05);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFE400").s().p("AhiGtIAAqYIh4AAIAAjBIG1AAIAADBIh4AAIAAKYg");
	this.shape_33.setTransform(215.575,-292.05);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#FFE400").s().p("AgCGtIg2ofIAAIfIjFAAIAAtZIECAAIA0ISIAAoSIDFAAIAANZg");
	this.shape_34.setTransform(150.7,-292.05);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFE400").s().p("AhiGtIAAtZIDEAAIAANZg");
	this.shape_35.setTransform(109.05,-292.05);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFE400").s().p("AAAG6QhxAAg5g9Qg5g+AAhyIAAmYQABh5A7g7QA8g7BrABIABAAQBxAAA5A+QA5A9AABzIAAGYQgBB4g7A7Qg7A6hqAAgAgUj3QgGAJAAATIAAG4QAAATAGAJQAHAIANAAIAAAAQAOAAAHgJQAGgJAAgSIAAm4QAAgUgHgIQgHgJgNAAIgBAAQgOAAgFAJg");
	this.shape_36.setTransform(70.075,-292.2252);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFE400").s().p("AhpGnQgxgOg0gbIBIiqQAZAOAVAGQAVAHAUAAQAdAAANgSQALgTAAgmIAApXIDJAAIAAJ4QgBBxg8A/Qg7A+hnABQgoAAgxgNg");
	this.shape_37.setTransform(19.125,-291.4);
...
}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-2.2,-357.6,736.5,421.20000000000005), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:363.5,regY:-159.3,x:672.6,y:138.65,alpha:0.0037},0).wait(1).to({y:138.5,alpha:0.0167},0).wait(1).to({y:138.2,alpha:0.0435},0).wait(1).to({y:137.7,alpha:0.0919},0).wait(1).to({x:672.55,y:136.75,alpha:0.1816},0).wait(1).to({x:672.5,y:135.2,alpha:0.3248},0).wait(1).to({x:672.45,y:133.5,alpha:0.4878},0).wait(1).to({x:672.4,y:131.9,alpha:0.6345},0).wait(1).to({x:672.35,y:130.7,alpha:0.7499},0).wait(1).to({y:129.75,alpha:0.8388},0).wait(1).to({x:672.3,y:129,alpha:0.9088},0).wait(1).to({y:128.5,alpha:0.9564},0).wait(1).to({y:128.2,alpha:0.9834},0).wait(1).to({y:128.05,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0.1,x:483.05,y:211.05,alpha:1},0).wait(59).to({x:483.4,y:211.25},0).wait(1).to({regX:363.5,regY:-159.3,x:672.65,y:128.25,alpha:0.9963},0).wait(1).to({y:128.4,alpha:0.9833},0).wait(1).to({y:128.7,alpha:0.9565},0).wait(1).to({y:129.2,alpha:0.9081},0).wait(1).to({y:130.1,alpha:0.8184},0).wait(1).to({y:131.6,alpha:0.6752},0).wait(1).to({y:133.3,alpha:0.5122},0).wait(1).to({y:134.85,alpha:0.3655},0).wait(1).to({y:136.05,alpha:0.2501},0).wait(1).to({y:137,alpha:0.1612},0).wait(1).to({y:137.7,alpha:0.0912},0).wait(1).to({y:138.2,alpha:0.0436},0).wait(1).to({y:138.5,alpha:0.0166},0).wait(1).to({y:138.65,alpha:0.0036},0).wait(1).to({regX:0.1,regY:0.1,x:483.4,y:221.7,alpha:0},0).wait(108));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({regX:-406,regY:16.1,x:453.95,y:123.65,alpha:0.0037},0).wait(1).to({x:452.05,alpha:0.0167},0).wait(1).to({x:448.15,alpha:0.0435},0).wait(1).to({x:441.1,alpha:0.0919},0).wait(1).to({x:428,alpha:0.1816},0).wait(1).to({x:407.1,alpha:0.3248},0).wait(1).to({x:383.35,alpha:0.4878},0).wait(1).to({x:361.95,alpha:0.6345},0).wait(1).to({x:345.15,alpha:0.7499},0).wait(1).to({x:332.2,alpha:0.8388},0).wait(1).to({x:322,alpha:0.9088},0).wait(1).to({x:315.05,alpha:0.9564},0).wait(1).to({x:311.1,alpha:0.9834},0).wait(1).to({x:309.2,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0,x:484.85,y:116.65,alpha:1},0).wait(82).to({alpha:0},15).to({_off:true},53).wait(47));
