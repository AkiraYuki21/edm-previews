...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(121.375,-264.975);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(100.375,-265.35);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhcDTIAAmlIC4AAIAABaIhZAAIAABIIBJAAIAABZIhJAAIAABQIBaAAIAABag");
	this.shape_2.setTransform(79.525,-265.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhsDTIAAhVIB0j1IhnAAIAAhbIDMAAIAABVIh1D1IB1AAIAABbg");
	this.shape_3.setTransform(56.65,-265.275);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgvDTIAAmlIBfAAIAAGlg");
	this.shape_4.setTransform(38.225,-265.275);
	...
	this.shape_5.setTransform(18.325,-265.275);
	...
	this.shape_6.setTransform(-7.8989,-265.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AANDTIAAimIgZAAIAACmIhhAAIAAmlIBhAAIAACfIAZAAIAAifIBhAAIAAGlg");
	this.shape_7.setTransform(-39.825,-265.275);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(-62.875,-265.35);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAfDTIgIhSIguAAIgHBSIhfAAIA4mlICLAAIA4GlgAAOAnIgMhwIgCgjIgBAjIgMBwIAbAAg");
	this.shape_9.setTransform(-87.425,-265.275);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAPDZQg8AAgfggQgeggAAg/IAAizQAAg/AeggQAfggA8AAIAAAAQAYAAAVAEQAUAEATAJIgjBOQgIgDgJgBIgQgBIgBAAQgTAAgKAMQgIAMAAAWIAAChQAAAWALAMQAMAMAUAAIAAAAQAJAAAJgCQAIgCAKgEIAjBNQgVALgXAFQgWAFgaAAg");
	this.shape_10.setTransform(-111.2,-265.325);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhuDTIAAmlIBnAAQAhABAbAPQAbAOAQAcQAPAcAAAmIAACqQAAAngPAdQgQAcgaAPQgbAPgiABgAgOB3IAEAAQAOABAEgHQAFgHgBgRIAAi1QAAgRgGgFQgFgFgLABIgEAAg");
	this.shape_11.setTransform(140.35,-325.025);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhcDTIAAmlIC4AAIAABaIhZAAIAABIIBJAAIAABZIhJAAIAABQIBaAAIAABag");
	this.shape_12.setTransform(117.775,-325.025);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhcDTIAAmlIC4AAIAABaIhZAAIAABIIBJAAIAABZIhJAAIAABQIBaAAIAABag");
	this.shape_13.setTransform(97.075,-325.025);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgvDTIAAlGIg7AAIAAhfIDVAAIAABfIg7AAIAAFGg");
	this.shape_14.setTransform(75.175,-325.025);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AAADTIgbkKIAAEKIhhAAIAAmlIB/AAIAZEEIAAkEIBhAAIAAGlg");
	this.shape_15.setTransform(50.125,-325.025);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAfDTIgIhSIguAAIgHBSIhfAAIA4mlICLAAIA4GlgAAOAnIgMhwIgCgjIgBAjIgMBwIAbAAg");
	this.shape_16.setTransform(22.525,-325.025);
	...
	this.shape_17.setTransform(-4.675,-325.025);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAfDTIgIhSIguAAIgHBSIhfAAIA4mlICLAAIA4GlgAAOAnIgMhwIgCgjIgBAjIgMBwIAbAAg");
	this.shape_18.setTransform(-31.775,-325.025);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("Ag5DKQgagNgOgZQgOgYAAgmIAAk7IBiAAIAAE+QAAAJAEAEQADAFAGAAQAHgBADgEQADgEAAgJIAAk+IBjAAIAAE7QAAAhgMAZQgNAZgYAOQgZAOglABQghgBgZgLg");
	this.shape_19.setTransform(-58.65,-324.75);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AhSC8QgdgeAAg6IAAjHQAAglAQgaQARgaAbgOQAdgOAjgBQAZABAZAHQAaAHAXAMIgiBTQgMgGgOgEQgOgCgOAAQgTgBgJAKQgIALAAAWIAAC3QAAAMAEAEQADAFAHgBIAHgBIAEgCIAAiXIBbAAIAADXQgRAKgPAHQgPAGgRAEQgQADgVAAQg5AAgcgdg");
	this.shape_20.setTransform(-83.75,-325.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AhoDXIAAhWQAdghAcgkQAbglASgjQARgjABgdIAAgDQgBgRgGgJQgGgJgJgDQgIgEgKAAQgPABgPAEIgYAHIgehQQASgKAcgHQAcgHAggBQAkABAZASQAYARANAdQANAegBAiIAAADQABAfgLAdQgKAdgQAaQgQAagSAXQgSAXgSAUIBgAAIAABag");
	this.shape_21.setTransform(-115.15,-325.4);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgaDWIAAk7IgrAKIAAhaICLggIAAGrg");
	this.shape_22.setTransform(-136.975,-325.35);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFE400").s().p("AgaCcQgMgFgIgLQgHgLAAgQQAAgWAPgNQAPgNAXgBQAXABAPANQAQANAAAWQAAAQgIALQgHALgMAFQgMAFgPAAQgOAAgMgFgAgahFQgMgFgIgKQgHgLAAgRQAAgXAPgMQAPgNAXAAQAXAAAPANQAQAMAAAXQAAARgIALQgHAKgMAFQgMAFgPAAQgOAAgMgFg");
	this.shape_23.setTransform(91.85,-379.2);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFE400").s().p("");
	this.shape_24.setTransform(73.275,-384.85);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFE400").s().p("AARDTIggihIgHAAIAAChIhhAAIAAmlIBoAAQAuABAaAOQAaAOAKAbQALAagBAjIAAAeQAAAhgIAWQgIAVgPAMIAwC6gAgWgbIAEAAQANAAAFgFQAFgGAAgOIAAgpQAAgNgFgHQgFgGgNABIgEAAg");
	this.shape_25.setTransform(48.775,-384.775);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFE400").s().p("AhcDTIAAmlIC4AAIAABaIhZAAIAABIIBJAAIAABZIhJAAIAABQIBaAAIAABag");
	this.shape_26.setTransform(25.375,-384.775);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFE400").s().p("AAADTIgbkKIAAEKIhhAAIAAmlIB/AAIAZEEIAAkEIBhAAIAAGlg");
	this.shape_27.setTransform(0.475,-384.775);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFE400").s().p("AAADTIgbkKIAAEKIhhAAIAAmlIB/AAIAZEEIAAkEIBhAAIAAGlg");
	this.shape_28.setTransform(-27.575,-384.775);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFE400").s().p("AgvDTIAAmlIBfAAIAAGlg");
	this.shape_29.setTransform(-48.025,-384.775);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFE400").s().p("AASDTIgSj9IgSD9Ih8AAIgfmlIBmAAIAFFDIAclDIBNAAIAcFDIAFlDIBmAAIgfGlg");
	this.shape_30.setTransform(-72.85,-384.775);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFE400").s().p("AhcDTIAAmlIC4AAIAABaIhZAAIAABIIBJAAIAABZIhJAAIAABQIBaAAIAABag");
	this.shape_31.setTransform(75.375,-444.525);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFE400").s().p("AANDTIAAimIgZAAIAACmIhhAAIAAmlIBhAAIAACfIAZAAIAAifIBhAAIAAGlg");
	this.shape_32.setTransform(51.975,-444.525);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFE400").s().p("AgvDTIAAlGIg7AAIAAhfIDVAAIAABfIg7AAIAAFGg");
	this.shape_33.setTransform(28.925,-444.525);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#FFE400").s().p("AAADTIgbkKIAAEKIhhAAIAAmlIB/AAIAZEEIAAkEIBhAAIAAGlg");
	this.shape_34.setTransform(-2.875,-444.525);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFE400").s().p("AgvDTIAAmlIBfAAIAAGlg");
	this.shape_35.setTransform(-23.325,-444.525);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFE400").s().p("AABDZQg3AAgcgeQgdgeAAg4IAAjIQABg7AdgdQAdgdA0AAIABAAQA3AAAcAfQAcAeAAA4IAADIQAAA7geAcQgcAdg1AAgAgJh5QgDAFAAAJIAADXQAAAKADAEQADAEAGAAIABAAQAGAAADgEQADgEAAgKIAAjXQABgJgEgFQgDgEgHAAIAAAAQgHAAgCAEg");
	this.shape_36.setTransform(-42.45,-444.6004);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFE400").s().p("AgzDPQgYgGgZgNIAjhUQAMAGAKAEQALADAJAAQAPAAAGgJQAFgJgBgSIAAkmIBjAAIAAE2QAAA3geAfQgdAegxABQgUAAgYgHg");
	this.shape_37.setTransform(-67.45,-444.2);
...
}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-147,-477.9,302.1,258), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(15).to({_off:false},0).wait(1).to({regX:3.8,regY:-355,x:80.5,y:395.25,alpha:0.0037},0).wait(1).to({y:395.1,alpha:0.0167},0).wait(1).to({y:394.85,alpha:0.0435},0).wait(1).to({y:394.35,alpha:0.0919},0).wait(1).to({y:393.45,alpha:0.1816},0).wait(1).to({y:392.05,alpha:0.3248},0).wait(1).to({y:390.4,alpha:0.4878},0).wait(1).to({y:388.95,alpha:0.6345},0).wait(1).to({y:387.8,alpha:0.7499},0).wait(1).to({y:386.9,alpha:0.8388},0).wait(1).to({y:386.2,alpha:0.9088},0).wait(1).to({y:385.7,alpha:0.9564},0).wait(1).to({y:385.45,alpha:0.9834},0).wait(1).to({y:385.3,alpha:0.9964},0).wait(1).to({regX:0,regY:0.1,x:78.6,y:562.85,alpha:1},0).wait(28).to({regX:3.8,regY:-355,x:80.5,y:385.35},0).wait(1).to({y:385.6},0).wait(1).to({y:386},0).wait(1).to({y:386.65},0).wait(1).to({y:387.6},0).wait(1).to({y:388.85},0).wait(1).to({y:390.6},0).wait(1).to({y:392.95},0).wait(1).to({y:396.2},0).wait(1).to({y:400.75},0).wait(1).to({y:406.3},0).wait(1).to({y:412.5},0).wait(1).to({y:418.95},0).wait(1).to({y:425.25},0).wait(1).to({y:431},0).wait(1).to({y:436.15},0).wait(1).to({y:440.65},0).wait(1).to({y:444.55},0).wait(1).to({y:448},0).wait(1).to({y:451},0).wait(1).to({y:453.7},0).wait(1).to({y:455.95},0).wait(1).to({y:457.65},0).wait(1).to({y:458.95},0).wait(1).to({y:459.9},0).wait(1).to({y:460.55},0).wait(1).to({y:461},0).wait(1).to({y:461.2},0).wait(1).to({regX:0,regY:0.1,x:78.6,y:638.85},0).wait(23).to({regX:3.8,regY:-355,x:81,y:461.3},0).wait(1).to({x:82.9},0).wait(1).to({x:86.65},0).wait(1).to({x:93.3},0).wait(1).to({x:104.9},0).wait(1).to({x:125},0).wait(1).to({x:149.85},0).wait(1).to({x:174.55},0).wait(1).to({x:195.2},0).wait(1).to({x:211.4},0).wait(1).to({x:224.15},0).wait(1).to({x:234.25},0).wait(1).to({x:240.9},0).wait(1).to({x:244.7},0).wait(1).to({x:246.55},0).wait(1).to({regX:0,regY:0.1,x:245.2,y:638.85},0).wait(17));
...
p.nominalBounds = new cjs.Rectangle(-154.3,299.1,477.1,301);
// library properties:
lib.properties = {
