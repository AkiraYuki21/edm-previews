...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(271.325,-8.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(255.675,-8.725);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhFCeIAAk6ICKAAIAABCIhCAAIAAA2IA2AAIAABDIg2AAIAAA7IBDAAIAABEg");
	this.shape_2.setTransform(240.075,-8.65);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhRCeIAAg/IBWi4IhMAAIAAhDICZAAIAAA/IhYC2IBYAAIAABFg");
	this.shape_3.setTransform(222.975,-8.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgjCeIAAk6IBHAAIAAE6g");
	this.shape_4.setTransform(209.225,-8.65);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AANCeIgYh4IgFAAIAAB4IhJAAIAAk6IBOAAQAigBATALQAUAMAIATQAHATABAbIAAAWQgBAZgGAQQgGAPgLAKIAjCLgAgQgUIADAAQAKAAADgEQAEgEAAgLIAAgeQAAgKgEgFQgDgEgKAAIgDAAg");
	this.shape_5.setTransform(194.3,-8.65);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhSCeIAAk6IBMAAQAjgBATALQAUAMAHATQAIATAAAbIAAAbQAAAhgMARQgLATgUAHQgUAIgagBIgEAAIAAB1gAgKgQIADAAQAIAAAEgEQAEgEAAgLIAAgiQAAgKgEgFQgEgEgIAAIgDAAg");
	this.shape_6.setTransform(174.7515,-8.65);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAKCeIAAh9IgTAAIAAB9IhIAAIAAk6IBIAAIAAB2IATAAIAAh2IBIAAIAAE6g");
	this.shape_7.setTransform(150.85,-8.65);
	...
	this.shape_8.setTransform(133.675,-8.725);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAXCeIgFg+IgjAAIgFA+IhHAAIAqk6IBnAAIAqE6gAALAdIgJhUIgCgaIgBAaIgJBUIAVAAg");
	this.shape_9.setTransform(115.275,-8.65);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAKCjQgrgBgXgYQgXgYAAgvIAAiGQAAguAXgYQAXgZArABIABAAQASgBAPAEQAQADAOAGIgaA7IgNgDIgMgBIgBAAQgOAAgHAJQgGAJAAAQIAAB5QAAAQAIAJQAJAJAOAAIABAAIANgCIAOgEIAaA6QgQAHgRAEQgQAFgUAAg");
	this.shape_10.setTransform(97.575,-8.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhSCeIAAk6IBNAAQAZAAATALQAVALAMAVQALAUAAAdIAAB/QAAAdgLAWQgMAVgUALQgVAMgYAAgAgKBZIACAAQALAAADgEQADgGgBgMIAAiIQAAgMgDgEQgFgDgIAAIgCAAg");
	this.shape_11.setTransform(73.85,-8.65);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhFCeIAAk6ICKAAIAABCIhCAAIAAA2IA2AAIAABDIg2AAIAAA7IBDAAIAABEg");
	this.shape_12.setTransform(56.975,-8.65);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhFCeIAAk6ICKAAIAABCIhCAAIAAA2IA2AAIAABDIg2AAIAAA7IBDAAIAABEg");
	this.shape_13.setTransform(41.475,-8.65);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgjCeIAAjzIgsAAIAAhHICfAAIAABHIgsAAIAADzg");
	this.shape_14.setTransform(25.125,-8.65);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AAACeIgUjHIAADHIhIAAIAAk6IBeAAIATDCIAAjCIBIAAIAAE6g");
	this.shape_15.setTransform(6.375,-8.65);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAXCeIgFg+IgjAAIgFA+IhHAAIAqk6IBnAAIAqE6gAALAdIgJhUIgCgaIgBAaIgJBUIAVAAg");
	this.shape_16.setTransform(-14.275,-8.65);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AANCeIgYh4IgFAAIAAB4IhIAAIAAk6IBNAAQAigBATALQAUAMAIATQAHATAAAbIAAAWQAAAZgGAQQgGAPgLAKIAkCLgAgQgUIADAAQAJAAAEgEQADgEAAgLIAAgeQAAgKgDgFQgDgEgKAAIgDAAg");
	this.shape_17.setTransform(-34.55,-8.65);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAXCeIgFg+IgjAAIgFA+IhHAAIAqk6IBnAAIAqE6gAALAdIgJhUIgCgaIgBAaIgJBUIAVAAg");
	this.shape_18.setTransform(-54.825,-8.65);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgqCWQgTgIgLgTQgLgTAAgcIAAjqIBKAAIAADsQAAAIADACQACAEAEAAQAFAAADgEQACgDAAgHIAAjsIBKAAIAADqQAAAagKASQgJATgSAKQgTAKgbAAQgYAAgTgJg");
	this.shape_19.setTransform(-74.925,-8.45);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("Ag9CMQgWgVABgsIAAiUQAAgdAMgTQAMgUAVgKQAVgKAaAAQASgBATAGQAUAFARAJIgaA/QgJgFgKgDQgLgDgKABQgOgBgGAJQgHAHAAAQIAACKQAAAHADAEQADAEAEgBIAGgBIADgBIAAhxIBEAAIAACgQgNAIgLAFQgMAFgMADQgMACgPABQgrAAgVgXg");
	this.shape_20.setTransform(-93.6506,-8.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AhOCgIAAg/QAXgZAUgcQAVgbANgaQAMgaAAgVIAAgDQAAgMgEgHQgFgHgGgDQgHgCgGAAQgMAAgLADIgSAFIgWg7QANgIAVgFQAUgFAZAAQAaAAATANQASANAKAWQAJAWAAAaIAAACQAAAXgIAWQgHAVgMATQgMAUgOARIgaAgIBHAAIAABDg");
	this.shape_21.setTransform(-117.15,-8.925);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgTCgIAAjrIggAHIAAhCIBogZIAAE/g");
	this.shape_22.setTransform(-133.45,-8.9);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFE400").s().p("AgjCeIAAhaIg8jgIBKAAIAVBpIAWhpIBKAAIg8DgIAABag");
	this.shape_23.setTransform(-154.575,-8.65);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFE400").s().p("AAACiQgpAAgUgWQgWgXAAgqIAAiVQAAgsAXgWQAWgVAmAAIABAAQApAAAUAXQAWAWAAAqIAACVQgBAsgWAWQgVAVgnAAgAgHhaQgCADAAAHIAAChQAAAHADADQACADAEAAIAAAAQAFAAACgDQADgDAAgHIAAihQAAgHgDgDQgCgDgFAAQgFAAgCADg");
	this.shape_24.setTransform(-174.15,-8.725);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFE400").s().p("AgmCbQgSgFgTgKIAbg+QAJAFAHACQAIADAHAAQALAAAFgHQADgHAAgOIAAjbIBKAAIAADnQAAAqgWAXQgWAXglAAQgPAAgSgFg");
	this.shape_25.setTransform(-192.825,-8.425);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFE400").s().p("AgjCeIAAhaIg8jgIBKAAIAVBpIAWhpIBKAAIg8DgIAABag");
	this.shape_26.setTransform(-215.175,-8.65);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFE400").s().p("AhICeIAAk6IBIAAIAADyIBJAAIAABIg");
	this.shape_27.setTransform(-234.15,-8.65);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFE400").s().p("AgqCWQgTgIgLgTQgLgTAAgcIAAjqIBKAAIAADsQAAAIADACQACAEAEAAQAFAAADgEQACgDAAgHIAAjsIBKAAIAADqQAAAagKASQgJATgSAKQgTAKgbAAQgYAAgTgJg");
	this.shape_28.setTransform(-252.575,-8.45);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFE400").s().p("AgmCbQgSgFgTgKIAbg+QAJAFAHACQAIADAHAAQALAAAFgHQADgHAAgOIAAjbIBKAAIAADnQAAAqgWAXQgWAXglAAQgPAAgSgFg");
	this.shape_29.setTransform(-271.625,-8.425);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-280.3,-33.5,560.7,58.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(195).to({_off:false},0).wait(1).to({regX:-0.3,regY:87.2,x:149.7,y:224.35,alpha:0.0032},0).wait(1).to({y:224.15,alpha:0.0145},0).wait(1).to({y:223.75,alpha:0.0371},0).wait(1).to({y:223,alpha:0.077},0).wait(1).to({y:221.7,alpha:0.1467},0).wait(1).to({y:219.5,alpha:0.2672},0).wait(1).to({y:216.75,alpha:0.4164},0).wait(1).to({y:214,alpha:0.5648},0).wait(1).to({y:211.7,alpha:0.6887},0).wait(1).to({y:209.9,alpha:0.7859},0).wait(1).to({y:208.5,alpha:0.8625},0).wait(1).to({y:207.4,alpha:0.9229},0).wait(1).to({y:206.65,alpha:0.9628},0).wait(1).to({y:206.25,alpha:0.9857},0).wait(1).to({y:206.05,alpha:0.9969},0).wait(1).to({regX:0.1,regY:0.1,x:149.85,y:179.95,alpha:1},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(179).to({_off:false},0).wait(1).to({regX:-0.4,regY:0.3,x:-130.35,y:112.65},0).wait(1).to({x:-127.2},0).wait(1).to({x:-120.85,y:112.7},0).wait(1).to({x:-109.65,y:112.8},0).wait(1).to({x:-90.05,y:112.9},0).wait(1).to({x:-56.2,y:113.15},0).wait(1).to({x:-14.25,y:113.45},0).wait(1).to({x:27.4,y:113.75},0).wait(1).to({x:62.25,y:114},0).wait(1).to({x:89.55,y:114.2},0).wait(1).to({x:111.05,y:114.35},0).wait(1).to({x:128.05,y:114.45},0).wait(1).to({x:139.25,y:114.55},0).wait(1).to({x:145.7,y:114.6},0).wait(1).to({x:148.85},0).wait(1).to({regX:0.1,regY:0.1,x:149.85},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({_off:false},0).wait(1).to({regX:-1.9,regY:-8.7,x:147.3,y:217.05,alpha:0.0037},0).wait(1).to({y:216.9,alpha:0.0167},0).wait(1).to({y:216.6,alpha:0.0435},0).wait(1).to({y:216.1,alpha:0.0919},0).wait(1).to({x:147.25,y:215.15,alpha:0.1816},0).wait(1).to({x:147.2,y:213.6,alpha:0.3248},0).wait(1).to({x:147.15,y:211.9,alpha:0.4878},0).wait(1).to({x:147.1,y:210.3,alpha:0.6345},0).wait(1).to({x:147.05,y:209.1,alpha:0.7499},0).wait(1).to({y:208.15,alpha:0.8388},0).wait(1).to({x:147,y:207.4,alpha:0.9088},0).wait(1).to({y:206.9,alpha:0.9564},0).wait(1).to({y:206.6,alpha:0.9834},0).wait(1).to({y:206.45,alpha:0.9964},0).wait(1).to({regX:0.1,regY:0.1,x:148.05,y:211.05,alpha:1},0).wait(60).to({x:148.4,y:211.25},0).wait(1).to({regX:-1.9,regY:-8.7,x:147.35,y:206.65,alpha:0.9963},0).wait(1).to({y:206.8,alpha:0.9833},0).wait(1).to({y:207.1,alpha:0.9565},0).wait(1).to({y:207.6,alpha:0.9081},0).wait(1).to({y:208.5,alpha:0.8184},0).wait(1).to({y:210,alpha:0.6752},0).wait(1).to({y:211.7,alpha:0.5122},0).wait(1).to({y:213.25,alpha:0.3655},0).wait(1).to({y:214.45,alpha:0.2501},0).wait(1).to({y:215.4,alpha:0.1612},0).wait(1).to({y:216.1,alpha:0.0912},0).wait(1).to({y:216.6,alpha:0.0436},0).wait(1).to({y:216.9,alpha:0.0166},0).wait(1).to({y:217.05,alpha:0.0036},0).wait(1).to({regX:0.1,regY:0.1,x:148.4,y:221.7,alpha:0},0).wait(107));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({regX:0,x:295.0622,alpha:0.0037},0).wait(1).to({x:293.1593,alpha:0.0167},0).wait(1).to({x:289.2635,alpha:0.0435},0).wait(1).to({x:282.207,alpha:0.0919},0).wait(1).to({x:269.1282,alpha:0.1816},0).wait(1).to({x:248.2446,alpha:0.3248},0).wait(1).to({x:224.4825,alpha:0.4878},0).wait(1).to({x:203.0965,alpha:0.6345},0).wait(1).to({x:186.263,alpha:0.7499},0).wait(1).to({x:173.3039,alpha:0.8388},0).wait(1).to({x:163.102,alpha:0.9088},0).wait(1).to({x:156.1575,alpha:0.9564},0).wait(1).to({x:152.2151,alpha:0.9834},0).wait(1).to({x:150.3252,alpha:0.9964},0).wait(1).to({regX:0.1,x:149.85,alpha:1},0).to({_off:true},149).wait(48));
