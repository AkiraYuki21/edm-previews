...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(122.975,576.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgQAlIAAhJIAQAAIAAA4IASAAIAAARg");
	this.shape_1.setTransform(118.45,576.5);
	...
	this.shape_2.setTransform(114.125,576.5);
	...
	this.shape_3.setTransform(109.625,576.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAFAlIgBgOIgHAAIgCAOIgQAAIAJhJIAYAAIAKBJgAACAHIgCgTIAAgGIAAAGIgCATIAEAAg");
	this.shape_4.setTransform(105.025,576.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(99.45,576.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgEAQIgDgfIAPAAIgDAfg");
	this.shape_6.setTransform(96.275,574.375);
	...
	this.shape_7.setTransform(93.325,576.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(88.2,576.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgHAlIAAg4IgLAAIAAgRIAlAAIAAARIgKAAIAAA4g");
	this.shape_9.setTransform(83.35,576.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgGAwIAAhfIANAAIAABfg");
	this.shape_10.setTransform(76.4,577.525);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgJAlIgJgEIAHgNIADACIAGABQAAAAABAAQAAAAABgBQAAAAAAAAQAAgBAAAAIABgFIAAgGIAAgEQAAAAAAgBQgBAAAAgBQAAAAAAAAQAAgBgBAAQgCgCgDABIgEABIgFABIAFgpIAbAAIAAAQIgKAAIgBAJQAGABAEAGQADAEAAAJIAAAKQAAAJgFAFQgGAGgIAAIgJgBgAABgLIgBAAg");
	this.shape_11.setTransform(69,576.55);
	...
	this.shape_12.setTransform(64.575,576.5);
	...
	this.shape_13.setTransform(60.225,576.45);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("");
	this.shape_14.setTransform(54.95,576.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgQAlIAAhJIAgAAIAAAQIgPAAIAAAMIAMAAIAAAQIgMAAIAAANIAQAAIAAAQg");
	this.shape_15.setTransform(51.225,576.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgIAlIAAhJIARAAIAABJg");
	this.shape_16.setTransform(48.175,576.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AADAlIgFgcIgBAAIAAAcIgSAAIAAhJIATAAQAHAAAFACQAFADABAEQADAFAAAGIAAAGQAAAGgCAEQgBACgDADIAIAggAgDgEIAAAAIADgBIABgEIAAgHIgBgDIgDgBIAAAAg");
	this.shape_17.setTransform(44.65,576.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AgQAlIAAhJIAgAAIAAAQIgPAAIAAAMIAMAAIAAAQIgMAAIAAANIAQAAIAAAQg");
	this.shape_18.setTransform(40.475,576.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("");
	this.shape_19.setTransform(36.6,576.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance_1},{t:this.instance}]}).wait(212));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_20).wait(212));

	// logo
	this.instance_2 = new lib.bt_logo();
	this.instance_2.setTransform(80,378.25,0.4091,0.4091);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(179).to({alpha:0},16).to({_off:true},1).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(195).to({_off:false},0).wait(1).to({regX:0.1,regY:-717.2,x:80.05,y:344.35,alpha:0.0032},0).wait(1).to({y:344.15,alpha:0.0145},0).wait(1).to({y:343.75,alpha:0.0371},0).wait(1).to({y:343.05,alpha:0.077},0).wait(1).to({y:341.85,alpha:0.1467},0).wait(1).to({y:339.7,alpha:0.2672},0).wait(1).to({y:337.05,alpha:0.4164},0).wait(1).to({y:334.45,alpha:0.5648},0).wait(1).to({y:332.25,alpha:0.6887},0).wait(1).to({y:330.5,alpha:0.7859},0).wait(1).to({y:329.15,alpha:0.8625},0).wait(1).to({y:328.1,alpha:0.9229},0).wait(1).to({y:327.4,alpha:0.9628},0).wait(1).to({y:327,alpha:0.9857},0).wait(1).to({y:326.8,alpha:0.9969},0).wait(1).to({regX:0,regY:0.1,x:80,y:532.8,alpha:1},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(179).to({_off:false},0).wait(1).to({regX:0.3,regY:-714.6,x:-118.7,y:184.85},0).wait(1).to({x:-116.45},0).wait(1).to({x:-111.9},0).wait(1).to({x:-103.95},0).wait(1).to({x:-90.05},0).wait(1).to({x:-66.05},0).wait(1).to({x:-36.25},0).wait(1).to({x:-6.65},0).wait(1).to({x:18.05},0).wait(1).to({x:37.45},0).wait(1).to({x:52.7},0).wait(1).to({x:64.75},0).wait(1).to({x:72.7},0).wait(1).to({x:77.3},0).wait(1).to({x:79.5},0).wait(1).to({regX:0.1,regY:0,x:80.05,y:470},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(15).to({_off:false},0).wait(1).to({regX:-0.2,regY:-367.8,x:78.5,y:388.85,alpha:0.0037},0).wait(1).to({y:388.7,alpha:0.0167},0).wait(1).to({y:388.45,alpha:0.0435},0).wait(1).to({y:387.95,alpha:0.0919},0).wait(1).to({y:387.05,alpha:0.1816},0).wait(1).to({y:385.65,alpha:0.3248},0).wait(1).to({y:384,alpha:0.4878},0).wait(1).to({y:382.55,alpha:0.6345},0).wait(1).to({y:381.4,alpha:0.7499},0).wait(1).to({y:380.5,alpha:0.8388},0).wait(1).to({y:379.8,alpha:0.9088},0).wait(1).to({y:379.3,alpha:0.9564},0).wait(1).to({y:379.05,alpha:0.9834},0).wait(1).to({y:378.9,alpha:0.9964},0).wait(1).to({regX:0,regY:0.1,x:78.6,y:562.85,alpha:1},0).wait(61).to({regX:-0.2,regY:-367.8,x:78.5,y:378.95},0).wait(1).to({y:379.2},0).wait(1).to({y:379.6},0).wait(1).to({y:380.25},0).wait(1).to({y:381.2},0).wait(1).to({y:382.45},0).wait(1).to({y:384.2},0).wait(1).to({y:386.55},0).wait(1).to({y:389.8},0).wait(1).to({y:394.35},0).wait(1).to({y:399.9},0).wait(1).to({y:406.1},0).wait(1).to({y:412.55},0).wait(1).to({y:418.85},0).wait(1).to({y:424.6},0).wait(1).to({y:429.75},0).wait(1).to({y:434.25},0).wait(1).to({y:438.15},0).wait(1).to({y:441.6},0).wait(1).to({y:444.6},0).wait(1).to({y:447.3},0).wait(1).to({y:449.55},0).wait(1).to({y:451.25},0).wait(1).to({y:452.55},0).wait(1).to({y:453.5},0).wait(1).to({y:454.15},0).wait(1).to({y:454.6},0).wait(1).to({y:454.8},0).wait(1).to({regX:0,regY:0.1,x:78.6,y:638.85},0).wait(61).to({regX:-0.2,regY:-367.8,x:79,y:454.9},0).wait(1).to({x:80.9},0).wait(1).to({x:84.65},0).wait(1).to({x:91.3},0).wait(1).to({x:102.9},0).wait(1).to({x:123},0).wait(1).to({x:147.85},0).wait(1).to({x:172.55},0).wait(1).to({x:193.2},0).wait(1).to({x:209.4},0).wait(1).to({x:222.15},0).wait(1).to({x:232.25},0).wait(1).to({x:238.9},0).wait(1).to({x:242.7},0).wait(1).to({x:244.55},0).wait(1).to({regX:0,regY:0.1,x:245.2,y:638.85},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90).to({_off:false},0).wait(1).to({regX:0.4,regY:-611.5,x:80.15,y:347.5,alpha:0.0037},0).wait(1).to({y:347.35,alpha:0.0167},0).wait(1).to({y:347.05,alpha:0.0435},0).wait(1).to({y:346.5,alpha:0.0919},0).wait(1).to({y:345.55,alpha:0.1816},0).wait(1).to({y:343.95,alpha:0.3248},0).wait(1).to({y:342.15,alpha:0.4878},0).wait(1).to({y:340.55,alpha:0.6345},0).wait(1).to({y:339.3,alpha:0.7499},0).wait(1).to({y:338.3,alpha:0.8388},0).wait(1).to({y:337.55,alpha:0.9088},0).wait(1).to({y:337,alpha:0.9564},0).wait(1).to({y:336.7,alpha:0.9834},0).wait(1).to({y:336.55,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:80,y:561.25,alpha:1},0).wait(75).to({regX:0.4,regY:-611.5,x:80.65,y:336.55},0).wait(1).to({x:82.4},0).wait(1).to({x:86},0).wait(1).to({x:92.3},0).wait(1).to({x:103.35},0).wait(1).to({x:122.45},0).wait(1).to({x:146.1},0).wait(1).to({x:169.6},0).wait(1).to({x:189.2},0).wait(1).to({x:204.6},0).wait(1).to({x:216.75},0).wait(1).to({x:226.3},0).wait(1).to({x:232.65},0).wait(1).to({x:236.25},0).wait(1).to({x:238.05},0).wait(1).to({regX:0,regY:0,x:238.4,y:561.25},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_21).wait(212));
