...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhBIDQgegNgTgaQgTgagBgrQACg2AlggQAmgfA5AAQA6AAAmAfQAlAgACA2QgBArgTAaQgTAageANQgeAMgkAAQgjAAgegMgAh2CzIAArBIDuAAIAALBg");
	this.shape.setTransform(416.825,-18.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(365,-19.65);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AjlIIIAAwPIHJAAIAADeIjcAAIAACxICzAAIAADeIizAAIAADEIDeAAIAADeg");
	this.shape_2.setTransform(313.55,-19.425);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AkNIIIAAjRIEfpeIj+AAIAAjgIH7AAIAADRIklJeIEjAAIAADgg");
	this.shape_3.setTransform(257.15,-19.425);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("Ah2IIIAAwPIDtAAIAAQPg");
	this.shape_4.setTransform(211.775,-19.425);
	...
	this.shape_5.setTransform(162.7,-19.425);
	...
	this.shape_6.setTransform(98.1019,-19.425);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAhIIIAAmaIhBAAIAAGaIjuAAIAAwPIDuAAIAAGJIBBAAIAAmJIDuAAIAAQPg");
	this.shape_7.setTransform(19.3,-19.425);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(-37.45,-19.65);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABNIIIgTjLIhzAAIgTDLIjpAAICJwPIFZAAICJQPgAAjBfIgekWIgFhWIgEBWIgeEWIBFAAg");
	this.shape_9.setTransform(-98.125,-19.425);
	...
	this.shape_10.setTransform(-156.75,-19.575);
	...
	this.shape_19.setTransform(-27.325,-167.375);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AjNHPQhHhIABiQIAAntQABhbAohAQAnhBBFgjQBGghBXgCQA9AAA/ASQBAARA5AfIhWDNQgdgQgigIQgigIghAAQgwAAgWAZQgXAZACA2IAAHIQAAAaAIALQAKAMARgBQAMAAAHgCQAGgCACgCIAAl2IDiAAIAAISQgrAYglARQgmARgpAJQgoAIgyAAQiQABhFhKg");
	this.shape_20.setTransform(-89.2007,-168.2);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AkCIRIAAjSQBIhRBEhbQBEhcArhWQAshXABhGIAAgJQgBgpgPgXQgPgWgWgIQgWgJgXABQgnAAgjAKIg7ASIhKjGQAsgYBEgQQBFgSBQgBQBZABA9AtQA8ArAgBHQAfBJABBVIAAAFQgBBOgYBIQgYBGgoBBQgoBAgtA6QgtA5gqAwIDqAAIAADeg");
	this.shape_21.setTransform(-166.65,-168.95);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AhBIQIAAsJIhsAYIAAjeIFbhQIAAQfg");
	this.shape_22.setTransform(-220.425,-168.825);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFE400").s().p("Ah2IIIAAknIjHroID2AAIBJFbIBGlbID2AAIjHLoIAAEng");
	this.shape_23.setTransform(315.925,-316.725);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFE400").s().p("AAAIXQiJAAhFhKQhFhLAAiJIAAnvQABiSBIhHQBJhICBABIABAAQCJABBFBKQBFBKAACLIAAHvQgCCRhGBHQhIBGiBAAgAgZkrQgHALABAXIAAIUQgBAYAIAKQAIAKAQAAIAAAAQASAAAHgKQAHgLABgXIAAoUQAAgYgIgKQgKgLgPAAIgBAAQgRAAgHALg");
	this.shape_24.setTransform(251.35,-316.9507);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFE400").s().p("Ah/IAQg8gRg+ghIBWjOQAeARAaAIQAaAIAYAAQAjAAAPgVQAPgXgCgvIAArVID0AAIAAL9QgBCJhIBMQhIBLh8ACQgxAAg7gQg");
	this.shape_25.setTransform(189.7,-315.95);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFE400").s().p("Ah2IIIAAknIjHroID2AAIBJFbIBGlbID2AAIjHLoIAAEng");
	this.shape_26.setTransform(115.925,-316.725);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFE400").s().p("AjyIIIAAwPIDuAAIAAMkID3AAIAADrg");
	this.shape_27.setTransform(53.4,-316.725);
	...
	this.shape_28.setTransform(-7.425,-316.075);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFE400").s().p("Ah/IAQg8gRg+ghIBXjOQAdARAaAIQAaAIAXAAQAlAAAOgVQAPgXgBgvIAArVIDzAAIAAL9QgBCJhIBMQhIBLh8ACQgwAAg8gQg");
	this.shape_29.setTransform(-70.35,-315.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sub_caption_mc, new cjs.Rectangle(-596,-397,1446.7,487.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(124).to({_off:false},0).to({y:24.4,alpha:1},16).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(57).to({_off:false},0).wait(1).to({regX:-4.8,regY:0.2,x:88.15,y:32.35,alpha:0.0037},0).wait(1).to({y:32.25,alpha:0.0167},0).wait(1).to({y:32.05,alpha:0.0435},0).wait(1).to({y:31.75,alpha:0.0919},0).wait(1).to({y:31.1,alpha:0.1816},0).wait(1).to({x:88.2,y:30.1,alpha:0.3248},0).wait(1).to({x:88.25,y:28.95,alpha:0.4878},0).wait(1).to({x:88.3,y:27.95,alpha:0.6345},0).wait(1).to({y:27.15,alpha:0.7499},0).wait(1).to({x:88.35,y:26.5,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.7,alpha:0.9564},0).wait(1).to({y:25.5,alpha:0.9834},0).wait(1).to({y:25.4,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:93.2,y:25.2,alpha:1},0).wait(37).to({regX:-4.8,regY:0.2,x:88.5,y:25.4,alpha:0.9968},0).wait(1).to({x:88.9,alpha:0.9855},0).wait(1).to({x:89.65,alpha:0.9629},0).wait(1).to({x:91.05,alpha:0.923},0).wait(1).to({x:93.5,y:25.45,alpha:0.8533},0).wait(1).to({x:97.75,y:25.5,alpha:0.7328},0).wait(1).to({x:102.95,y:25.55,alpha:0.5836},0).wait(1).to({x:108.15,y:25.6,alpha:0.4352},0).wait(1).to({x:112.5,y:25.65,alpha:0.3113},0).wait(1).to({x:115.9,y:25.7,alpha:0.2141},0).wait(1).to({x:118.55,alpha:0.1375},0).wait(1).to({x:120.7,y:25.75,alpha:0.0771},0).wait(1).to({x:122.05,alpha:0.0372},0).wait(1).to({x:122.85,alpha:0.0143},0).wait(1).to({x:123.25,alpha:0.0031},0).wait(1).to({regX:0,regY:0,x:128.2,y:25.6,alpha:0},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(15).to({_off:false},0).wait(1).to({regX:126.7,regY:-168.2,x:162.85,y:26.75,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:26.7,alpha:0.0435},0).wait(1).to({y:26.6,alpha:0.0919},0).wait(1).to({y:26.4,alpha:0.1816},0).wait(1).to({y:26.1,alpha:0.3248},0).wait(1).to({y:25.75,alpha:0.4878},0).wait(1).to({y:25.45,alpha:0.6345},0).wait(1).to({y:25.2,alpha:0.7499},0).wait(1).to({y:25,alpha:0.8388},0).wait(1).to({y:24.85,alpha:0.9088},0).wait(1).to({y:24.75,alpha:0.9564},0).wait(1).to({y:24.7,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:42.25,alpha:1},0).wait(20).to({regX:126.7,regY:-168.2,x:162.85,y:24.7,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:24.75,alpha:0.9565},0).wait(1).to({y:24.85,alpha:0.9081},0).wait(1).to({y:25.05,alpha:0.8184},0).wait(1).to({y:25.35,alpha:0.6752},0).wait(1).to({y:25.7,alpha:0.5122},0).wait(1).to({y:26,alpha:0.3655},0).wait(1).to({y:26.25,alpha:0.2501},0).wait(1).to({y:26.45,alpha:0.1612},0).wait(1).to({y:26.6,alpha:0.0912},0).wait(1).to({y:26.7,alpha:0.0436},0).wait(1).to({y:26.75,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:149.7,y:44.35,alpha:0},0).wait(77));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(57).to({_off:false},0).wait(1).to({regX:172,regY:-211,x:163.1,y:28,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.95,alpha:0.0435},0).wait(1).to({y:27.8,alpha:0.0919},0).wait(1).to({y:27.6,alpha:0.1816},0).wait(1).to({y:27.3,alpha:0.3248},0).wait(1).to({y:26.95,alpha:0.4878},0).wait(1).to({y:26.6,alpha:0.6345},0).wait(1).to({y:26.35,alpha:0.7499},0).wait(1).to({y:26.15,alpha:0.8388},0).wait(1).to({y:26,alpha:0.9088},0).wait(1).to({y:25.85,alpha:0.9564},0).wait(1).to({y:25.8,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0,regY:0.7,x:149.95,y:41.95,alpha:1},0).wait(37).to({regX:172,regY:-211,x:163.2,y:25.7,alpha:0.9968},0).wait(1).to({x:163.7,alpha:0.9855},0).wait(1).to({x:164.65,alpha:0.9629},0).wait(1).to({x:166.3,alpha:0.923},0).wait(1).to({x:169.2,y:25.65,alpha:0.8533},0).wait(1).to({x:174.25,y:25.6,alpha:0.7328},0).wait(1).to({x:180.5,y:25.5,alpha:0.5836},0).wait(1).to({x:186.7,y:25.45,alpha:0.4352},0).wait(1).to({x:191.9,y:25.4,alpha:0.3113},0).wait(1).to({x:195.95,y:25.35,alpha:0.2141},0).wait(1).to({x:199.15,y:25.3,alpha:0.1375},0).wait(1).to({x:201.7,y:25.25,alpha:0.0771},0).wait(1).to({x:203.35,alpha:0.0372},0).wait(1).to({x:204.35,alpha:0.0143},0).wait(1).to({x:204.8,alpha:0.0031},0).wait(1).to({regX:0,regY:0.7,x:191.8,y:41.45,alpha:0},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({regX:-666.6,regY:20.2,x:121.15,y:25.05,alpha:0.0037},0).wait(1).to({x:120.8,alpha:0.0167},0).wait(1).to({x:120,alpha:0.0435},0).wait(1).to({x:118.6,alpha:0.0919},0).wait(1).to({x:115.95,alpha:0.1816},0).wait(1).to({x:111.8,alpha:0.3248},0).wait(1).to({x:107.05,alpha:0.4878},0).wait(1).to({x:102.75,alpha:0.6345},0).wait(1).to({x:99.4,alpha:0.7499},0).wait(1).to({x:96.8,alpha:0.8388},0).wait(1).to({x:94.75,alpha:0.9088},0).wait(1).to({x:93.35,alpha:0.9564},0).wait(1).to({x:92.55,alpha:0.9834},0).wait(1).to({x:92.2,alpha:0.9964},0).wait(1).to({regX:0,regY:0.6,x:149.95,y:23.35,alpha:1},0).wait(43).to({regX:-666.6,regY:20.2,x:92.15,y:25,alpha:0.9963},0).wait(1).to({y:24.9,alpha:0.9833},0).wait(1).to({y:24.7,alpha:0.9565},0).wait(1).to({y:24.3,alpha:0.9081},0).wait(1).to({y:23.6,alpha:0.8184},0).wait(1).to({y:22.5,alpha:0.6752},0).wait(1).to({y:21.2,alpha:0.5122},0).wait(1).to({y:20.05,alpha:0.3655},0).wait(1).to({y:19.15,alpha:0.2501},0).wait(1).to({y:18.45,alpha:0.1612},0).wait(1).to({y:17.9,alpha:0.0912},0).wait(1).to({y:17.5,alpha:0.0436},0).wait(1).to({y:17.3,alpha:0.0166},0).wait(1).to({y:17.2,alpha:0.0036},0).wait(1).to({regX:0,regY:0.6,x:149.95,y:15.5,alpha:0},0).to({_off:true},31).wait(38));
