...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("AjjICIAAwDIHEAAIAADbIjZAAIAACvICxAAIAADbIixAAIAADDIDcAAIAADbg");
	this.shape.setTransform(285.325,-18.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("AjjICIAAwDIHEAAIAADbIjZAAIAACvICxAAIAADbIixAAIAADDIDcAAIAADbg");
	this.shape_1.setTransform(234.675,-18.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("AAqICIhRmHIgRAAIAAGHIjrAAIAAwDID8AAQCjgBBABKQBABJgBCLIAABKQABCWhNBCIB2HEgAg4hCIAMAAQAeAAANgPQAMgOAAghIAAhkQAAgigMgOQgNgNgeAAIgMAAg");
	this.shape_2.setTransform(175.05,-18.85);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("AjoICIAAwDIHRAAIAADbIjmAAIAACvIC+AAIAADbIi+AAIAAGeg");
	this.shape_3.setTransform(117.45,-18.85);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("Aj/ILIAAjQQEllKAAirIAAgJQAAg4gdgWQgbgXgoAAQgmAAhfAbIhJjDQBtg6CWAAQB+AABHBbQBIBaABCGIAAAFQAABIgWBHQgXBIgtBFQgvBHggArQghAqg5BCIDpAAIAADbg");
	this.shape_4.setTransform(44.8,-19.75);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFE400").s().p("Ah1ICIAAsbIiRAAIAAjoIINAAIAADoIiRAAIAAMbg");
	this.shape_5.setTransform(-27.575,-18.85);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("AjjICIAAwDIHEAAIAADbIjZAAIAACvICxAAIAADbIixAAIAADDIDcAAIAADbg");
	this.shape_6.setTransform(-78.525,-18.85);
	...
	this.shape_7.setTransform(-133.975,-18.975);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AjHDYICLmuIEEAAIjGGug");
	this.shape_8.setTransform(287.575,-110.6);
	...
	this.shape_9.setTransform(244.575,-161.825);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Ah1IDIAAscIiRAAIAAjpIINAAIAADpIiRAAIAAMcg");
	this.shape_10.setTransform(190.775,-161.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AjjIDIAAwFIHEAAIAADcIjZAAIAACvICxAAIAADcIixAAIAADCIDcAAIAADcg");
	this.shape_11.setTransform(139.875,-161.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAhIDIhcnZIAAHZIjsAAIAAwFIDsAAIAAHWIBbnWID4AAIh/HmICPIfg");
	this.shape_12.setTransform(81.2,-161.55);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAjISQiRABhLhPQhLhOAAiaIAAm2QAAiaBLhPQBLhPCRAAIABAAQBwAABdArIhUC+QglgLgtAAIgBAAQhcAAAABwIAAGJQAAA1AcAeQAdAeAwAAIABAAQAqAAAvgTIBUC9QhnAzh6gBg");
	this.shape_13.setTransform(21.675,-161.75);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("Ah1IDIAAwFIDrAAIAAQFg");
	this.shape_14.setTransform(-23.8,-161.55);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("Ah1IDIAAscIiRAAIAAjpIINAAIAADpIiRAAIAAMcg");
	this.shape_15.setTransform(-66.325,-161.55);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AkAIMIAAjQQEmlLAAirIAAgIQAAg4gdgYQgbgWgpAAQgkAAhfAcIhKjDQBtg7CWgBQB+AABHBcQBIBaABCFIAAAGQAABIgWBIQgWBGgvBHQguBGggArQghAqg5BCIDoAAIAADcg");
	this.shape_16.setTransform(-138.65,-162.45);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("Ah0IDIAAkkIjFrhID0AAIBHFYIBGlYIDzAAIjELhIAAEkg");
	this.shape_17.setTransform(135.55,-304.3);
	...
	this.shape_18.setTransform(70.475,-303.675);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AkSIDIAAwFIECAAQCBABBLA9QBMA/AACAIAAAaQAABPgZAxQgaAxg6AaQB4AqAACpIAAA/QAACEhIBGQhJBGh9ABgAgmEkIAOAAQAcAAAKgOQAMgNAAgeIAAhlQAAgfgLgOQgKgOgdABIgOAAgAgmhyIARAAQAdAAALgNQAKgNAAgeIAAg9QAAgfgKgOQgKgOgeAAIgRAAg");
	this.shape_19.setTransform(7.375,-304.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.daily_caption_mc, new cjs.Rectangle(-293.1,-383.8,730.5,473.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).wait(1).to({regX:71.5,regY:-160.8,x:167.1,y:27.5,alpha:0.0037},0).wait(1).to({alpha:0.0167},0).wait(1).to({y:27.45,alpha:0.0435},0).wait(1).to({y:27.35,alpha:0.0919},0).wait(1).to({y:27.15,alpha:0.1816},0).wait(1).to({y:26.85,alpha:0.3248},0).wait(1).to({y:26.5,alpha:0.4878},0).wait(1).to({y:26.2,alpha:0.6345},0).wait(1).to({y:25.95,alpha:0.7499},0).wait(1).to({y:25.75,alpha:0.8388},0).wait(1).to({y:25.6,alpha:0.9088},0).wait(1).to({y:25.5,alpha:0.9564},0).wait(1).to({y:25.45,alpha:0.9834},0).wait(1).to({alpha:0.9964},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:42.25,alpha:1},0).wait(62).to({regX:71.5,regY:-160.8,x:167.1,y:25.45,alpha:0.9963},0).wait(1).to({alpha:0.9833},0).wait(1).to({y:25.5,alpha:0.9565},0).wait(1).to({y:25.6,alpha:0.9081},0).wait(1).to({y:25.8,alpha:0.8184},0).wait(1).to({y:26.1,alpha:0.6752},0).wait(1).to({y:26.45,alpha:0.5122},0).wait(1).to({y:26.75,alpha:0.3655},0).wait(1).to({y:27,alpha:0.2501},0).wait(1).to({y:27.2,alpha:0.1612},0).wait(1).to({y:27.35,alpha:0.0912},0).wait(1).to({y:27.45,alpha:0.0436},0).wait(1).to({y:27.5,alpha:0.0166},0).wait(1).to({alpha:0.0036},0).wait(1).to({regX:0.5,regY:0.5,x:159.7,y:44.35,alpha:0},0).wait(94));
