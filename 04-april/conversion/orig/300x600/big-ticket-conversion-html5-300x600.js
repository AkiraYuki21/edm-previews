...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFE400").s().p("AhKCqIAAlSICUAAIAABIIhIAAIAAA5IA7AAIAABIIg7AAIAABBIBJAAIAABIg");
	this.shape.setTransform(70.25,-9.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE400").s().p("AhKCqIAAlSICVAAIAABIIhIAAIAAA5IA6AAIAABIIg6AAIAABBIBIAAIAABIg");
	this.shape_1.setTransform(53.55,-9.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE400").s().p("AAOCqIgaiCIgGAAIAACCIhNAAIAAlSIBTAAQA1AAAVAYQAVAYAAAtIAAAZQAAAxgZAVIAmCWgAgSgWIAEAAQAKABAEgFQAEgEAAgMIAAghQAAgKgEgFQgEgEgKgBIgEAAg");
	this.shape_2.setTransform(33.925,-9.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE400").s().p("AhMCqIAAlSICZAAIAABIIhMAAIAAA5IA/AAIAABIIg/AAIAACJg");
	this.shape_3.setTransform(14.95,-9.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFE400").s().p("AhUCtIAAhFQBghsAAg4IAAgEQAAgRgJgJQgIgHgOAAQgMAAgfAKIgYhBQAkgUAxAAQApAAAXAfQAYAeAAAsIAAABQAAAYgHAXQgHAXgQAXQgPAYgKAOIgeAkIBMAAIAABIg");
	this.shape_4.setTransform(-8.975,-10);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFE400").s().p("AgmCqIAAkGIgvAAIAAhMICrAAIAABMIgvAAIAAEGg");
	this.shape_5.setTransform(-32.85,-9.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFE400").s().p("AhKCqIAAlSICVAAIAABIIhIAAIAAA5IA6AAIAABIIg6AAIAABBIBIAAIAABIg");
	this.shape_6.setTransform(-49.6,-9.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFE400").s().p("AhZBQIAAigQAAgrAcgZQAcgaArAAQApAAAnAVIgcBEQgTgLgYAAQgdAAABAiIAACUQgBAPALAAQAGAAADgCIAAh5IBKAAIAACtQgXANgSAFQgRAGgXAAQhcAAAAhfg");
	this.shape_7.setTransform(-67.9,-9.75);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).wait(1).to({regX:-0.1,regY:-33.4,x:147.25,y:517.6,alpha:0.0037},0).wait(1).to({y:517.35,alpha:0.0167},0).wait(1).to({y:516.85,alpha:0.0435},0).wait(1).to({y:515.95,alpha:0.0919},0).wait(1).to({y:514.25,alpha:0.1816},0).wait(1).to({y:511.6,alpha:0.3248},0).wait(1).to({y:508.55,alpha:0.4878},0).wait(1).to({y:505.8,alpha:0.6345},0).wait(1).to({y:503.6,alpha:0.7499},0).wait(1).to({y:501.95,alpha:0.8388},0).wait(1).to({y:500.65,alpha:0.9088},0).wait(1).to({y:499.75,alpha:0.9564},0).wait(1).to({y:499.25,alpha:0.9834},0).wait(1).to({y:499,alpha:0.9964},0).wait(1).to({regX:0,regY:0,x:147.35,y:530.25,alpha:1},0).wait(61).to({regX:-0.1,regY:-33.4,x:147.25,y:499,alpha:0.9963},0).wait(1).to({y:499.25,alpha:0.9833},0).wait(1).to({y:499.75,alpha:0.9565},0).wait(1).to({y:500.65,alpha:0.9081},0).wait(1).to({y:502.35,alpha:0.8184},0).wait(1).to({y:505,alpha:0.6752},0).wait(1).to({y:508.05,alpha:0.5122},0).wait(1).to({y:510.8,alpha:0.3655},0).wait(1).to({y:513,alpha:0.2501},0).wait(1).to({y:514.65,alpha:0.1612},0).wait(1).to({y:515.95,alpha:0.0912},0).wait(1).to({y:516.85,alpha:0.0436},0).wait(1).to({y:517.35,alpha:0.0166},0).wait(1).to({y:517.6,alpha:0.0036},0).wait(1).to({regX:0,regY:0,x:147.35,y:549,alpha:0},0).wait(95));
